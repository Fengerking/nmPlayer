...
//
//    scale1 = sub(scale,4);
//    voAMRWBPDecL_Extract(L_shl(l_temp2,scale1), &hi, &lo);
//    l_temp1 = Mpy_32_16(hi, lo, Bw_inv[Band]);
//    *level_cl = extract_h(L_shl(l_temp1, 2));  /* WB+ level */
//
//    level = extract_h(L_shl(l_temp2, scale)); /* WB result */
//
//    return level;
//}
...
//
//    /* 4800 - 6400 Hz */
//    level[11] = level_calculation(&level_cl[11],11, tmp_buf, &st->sub_level[11],
//                          FRAME_LEN / 4 - 48, FRAME_LEN / 4, 4, 1, 14);   
//    /* 4000 - 4800 Hz */
//    level[10] = level_calculation(&level_cl[10],10, tmp_buf, &st->sub_level[10],
//                          FRAME_LEN / 8 - 24, FRAME_LEN / 8, 8, 7, 15);   
//    /* 3200 - 4000 Hz */
//    level[9] = level_calculation(&level_cl[9],9, tmp_buf, &st->sub_level[9],
//                          FRAME_LEN / 8 - 24, FRAME_LEN / 8, 8, 3, 15);   
//    /* 2400 - 3200 Hz */
//    level[8] = level_calculation(&level_cl[8],8, tmp_buf, &st->sub_level[8],
//                          FRAME_LEN / 8 - 24, FRAME_LEN / 8, 8, 2, 15);   
//    /* 2000 - 2400 Hz */
//    level[7] = level_calculation(&level_cl[7],7, tmp_buf, &st->sub_level[7],
//                          FRAME_LEN / 16 - 12, FRAME_LEN / 16, 16, 14, 16);       
//    /* 1600 - 2000 Hz */
//    level[6] = level_calculation(&level_cl[6],6, tmp_buf, &st->sub_level[6],
//                          FRAME_LEN / 16 - 12, FRAME_LEN / 16, 16, 6, 16);        
//    /* 1200 - 1600 Hz */
//    level[5] = level_calculation(&level_cl[5],5, tmp_buf, &st->sub_level[5],
//                          FRAME_LEN / 16 - 12, FRAME_LEN / 16, 16, 4, 16);        
//    /* 800 - 1200 Hz */
//    level[4] = level_calculation(&level_cl[4],4, tmp_buf, &st->sub_level[4],
//                          FRAME_LEN / 16 - 12, FRAME_LEN / 16, 16, 12, 16);       
//    /* 600 - 800 Hz */
//    level[3] = level_calculation(&level_cl[3],3, tmp_buf, &st->sub_level[3],
//                          FRAME_LEN / 32 - 6, FRAME_LEN / 32, 32, 8, 17); 
//    /* 400 - 600 Hz */
//    level[2] = level_calculation(&level_cl[2],2, tmp_buf, &st->sub_level[2],
//                          FRAME_LEN / 32 - 6, FRAME_LEN / 32, 32, 24, 17);        
//    /* 200 - 400 Hz */
//    level[1] = level_calculation(&level_cl[1],1, tmp_buf, &st->sub_level[1],
//                          FRAME_LEN / 32 - 6, FRAME_LEN / 32, 32, 16, 17);        
//    /* 0 - 200 Hz */
//    level[0] = level_calculation(&level_cl[0],0, tmp_buf, &st->sub_level[0],
...
//    {
//        st->vadreg = (Word16) (st->vadreg | 0x4000);    logic16();
//    }
