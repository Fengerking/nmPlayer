                            ...
                            PerChannelInfo* ppcinfo)
{
    ...
    if (pau->m_fHalfTransform == WMAB_TRUE) {
        prvFixMLLM4HalfTransform(paudec, pau, ppcinfo, rgCoefRecon);
    }
                                                       ...
                                                       I32 iLen)
{
    ...
    voWMAMemcpy(rgiCoefRecon, rgiLPCResidue, sizeof(CBT)*iLen);
...
Void prvFixMLLM4HalfTransform (CAudioObjectDecoder *paudec, CAudioObject * pau, PerChannelInfo* ppcinfo, CoefType * rgfltCoef)
{
    ...
    */
    ...
    {
        voWMAMemcpy (rgfltHtFilter, rgfltHtFilterTable, sizeof(HTFilterType) * (HT_FLTLEN/2));
    ...
    auMemmove(rgfltCoef + iFltLen / 4, rgfltCoef, sizeof(CoefType) * (iDatLen / 2 - iFltLen / 2));
    voWMAMemcpy(rgfltCoef, rgfltCoefHead, sizeof(CoefType) * iFltLen / 4);
    voWMAMemcpy(rgfltCoef + iDatLen / 2 - iFltLen / 4, rgfltCoefTail, sizeof(CoefType) * iFltLen / 4);
