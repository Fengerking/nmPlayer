...
PERFTIMERINFO *PerfTimerNew(CAudioObjectDecoder *paudec, long lSamplesPerSecOutput);
void PerfTimerFree(CAudioObjectDecoder *paudec, PERFTIMERINFO *pInfo);
...
#if 1  //clean up warning enable, if log the result, disable 
