...
)
{
	...
	//for (i = 0; i < order; i++)
		*awght++ = ((weight[0] * *a++) + 0x4000) >> 15;
	    *awght++ = ((weight[1] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[2] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[3] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[4] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[5] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[6] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[7] * *a++) + 0x4000) >> 15;
        *awght++ = ((weight[8] * *a++) + 0x4000) >> 15;
		*awght++ = ((weight[9] * *a++) + 0x4000) >> 15;
}
