...
#define		VOCOMP_EVENT_RESETCROP		1002
...
public:
	...
	virtual OMX_ERRORTYPE		ResetPort(int nIndex){ return OMX_ErrorNone;};
	virtual void				ResetCrop(OMX_PTR ptr = NULL) {};
	...
	virtual OMX_ERRORTYPE				GetParameter(OMX_INDEXTYPE nIndex, OMX_PTR pParam, size_t size = 0);
	virtual OMX_ERRORTYPE				SetParameter(OMX_INDEXTYPE nIndex, OMX_PTR pParam, size_t size = 0);
	virtual OMX_ERRORTYPE				GetConfig(OMX_INDEXTYPE nIndex, OMX_PTR pConfig, size_t size = 0);
	virtual OMX_ERRORTYPE				SetConfig(OMX_INDEXTYPE nIndex, OMX_PTR pConfig, size_t size = 0);
	...
	virtual VO_U32							GetSourceParam(VO_U32 paramID, VO_PTR pData);
...
protected:
	virtual OMX_ERRORTYPE					Load2Idle(void);
	virtual OMX_ERRORTYPE					Load2Executing(void);
	virtual OMX_ERRORTYPE					CreatePorts(void);
	virtual OMX_ERRORTYPE					SetComponentRole();
	virtual OMX_ERRORTYPE					GetState(OMX_STATETYPE *pst = NULL);
