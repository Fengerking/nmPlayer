...
/*
 * VOINT32 Type definition
 *
 * VOINT32 is a signed 32-bit type
 */
#ifndef VOINT32

#if defined(_SYMBIAN)
typedef TInt32  VOINT32;
#elif defined(_UNIX) && defined(_LONG_IS_64)
typedef int VOINT32;
#elif defined(_VXWORKS)
typedef int VOINT32;
#else
typedef long int VOINT32;
#endif

#endif /* #ifndef VOINT32 */

/*
 * VOLONG32 Type definition
 *
 * VOLONG32 is another name for a VOINT32
 */
typedef VOINT32 VOLONG32;

/*
 * VOUINT32 Type definition
 *
 * VOUINT32 is an unsigned 32-bit type
 */
#ifndef VOUINT32

#if defined(_SYMBIAN)
typedef TUint32 VOUINT32;
#elif defined(_UNIX) && defined(_LONG_IS_64)
typedef unsigned int VOUINT32;
#elif defined(_VXWORKS)
typedef unsigned int VOUINT32;
#else
typedef unsigned long int VOUINT32;
#endif

#endif /* #ifndef VOUINT32 */
#else
#include "windows.h"
#endif//WINDOWS
/*
 ...
 *
 * UFIXED32 is another name for a VOUINT32
 */
typedef VOUINT32 UFIXED32;

/*
 * VOULONG32 Type definition
 *
 * VOULONG32 is another name for a VOUINT32
 */
typedef VOUINT32 VOULONG32;

/*
 * HX_MOFTAG Type definition
 *
 * HX_MOFTAG is of type VOUINT32
 */
typedef VOUINT32 HX_MOFTAG;
