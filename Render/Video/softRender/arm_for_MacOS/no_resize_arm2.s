	...
	.text
		  .align 2
		.globl	 _cc_mb_16x16_arm 
	.globl	 _ccClip63 

  .macro cc_mb_16x16_arm_num_count_0
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(0*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	str	r10, [r8, #(0*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_1
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(1*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(1*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_2
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(2*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(2*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	


  .macro cc_mb_16x16_arm_num_count_3
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(3*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(3*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_4
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(4*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(4*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_5
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(5*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(5*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_6
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(6*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(6*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

  .macro cc_mb_16x16_arm_num_count_7
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
@	a3 = (psrc_y[2*num] - 16)*ConstY@
@	a2 = (a0 * ConstU1)@
...
@	*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
		...
		ldr	r12, lab_0x129fbe			@r12 = ConstY		
        	str	r8, [r4, #(7*4 )]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@
        	sub	r10, r10, #16	
		mul	r10, r12, r10			@*********r10 = a3 = (psrc_y[in_stride+2*nu] - 16)*ConstY@		
		add	r9, r10, r6			@*********r9 = (a3 + a2)	
		...
		mov	r12, r12, lsr #1		@r12 = a5  = (ccClip63[((a3 + a1)>>22)])>>1@			
        	...
        	orr     r10, r10, r9, lsl #21           @********r10 = a4  = (a3 << 21)@
        	add	r8, r4, r5			@r8 = out_buf+out_stride
        	str	r10, [r8, #(7*4 )]			@*((int32_t*)(out_buf+(out_stride+4*num))) = (int32_t)a4@
  .endmacro  	

	
_cc_mb_16x16_arm: @PROC
...
@	do{
@		int32_t a0, a1, a2, a3, a4, a5, a7@
	cc_mb_16x16_arm_num_count_0
	cc_mb_16x16_arm_num_count_1
	cc_mb_16x16_arm_num_count_2
	cc_mb_16x16_arm_num_count_3
	cc_mb_16x16_arm_num_count_4
	cc_mb_16x16_arm_num_count_5
	cc_mb_16x16_arm_num_count_6
	cc_mb_16x16_arm_num_count_7
@			psrc_y += (in_stride<<1)@
@			psrc_u += (in_stride>>1)@
@			psrc_v += (in_stride>>1)@
@			out_buf += (out_stride<<1)@
...
@}
 ...
 ccClip63_DATA_d: .word _ccClip63 
