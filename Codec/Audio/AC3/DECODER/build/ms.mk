...
ifeq ($(VOTT), v6)
OBJS+= upk_subs_asm.o crc_calc_asm.o cifft_asm.o window_d_asm.o  #idctsc_asm.o #downmix_asm.o #idctsc_asm.s have align3 issue 
VOSRCDIR+= ../../src/linux_asm/armv6
endif				

ifeq ($(VOTT), v7)
OBJS+= cifft_asm.o crc_calc_asm.o upk_subs_asm.o window_d_asm.o #idctsc_asm.o downmix_asm.o 
VOSRCDIR+= ../../src/linux_asm/armv6
endif			
