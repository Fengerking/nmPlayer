...
*                         sation modules (voAMRNBEnc_Q_plsf_3.c/q_plsf_5.c)
*
********************************************************************************
*/
#ifndef q_plsf_h
...
int voAMRNBEnc_Q_plsf_init (Q_plsfState **st, VO_MEM_OPERATOR *pMemOP);
/* initialize one instance of the state.
   Stores pointer to filter status struct in *st. This pointer has to
   be passed to Q_plsf_5 / voAMRNBEnc_Q_plsf_3 in each call.
   returns 0 on success
 */
 
int voAMRNBEnc_Q_plsf_reset (Q_plsfState *st);
/* reset of state (i.e. set state memory to zero)
   returns 0 on success
 */

void voAMRNBEnc_Q_plsf_exit (Q_plsfState **st, VO_MEM_OPERATOR *pMemOP);
