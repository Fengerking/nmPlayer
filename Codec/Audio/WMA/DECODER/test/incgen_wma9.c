...
void wmain( int argc, char **argv )
{
	...
	char introduce1[] = ";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;";
	char introduce2[] = "; Filename wma_member_arm.h";
	char introduce3[] = ";";
	...
	offset = offsetof(CAudioObjectDecoder, m_LLMdecsts);						//lossless
	fprintf(hinc, "CAudioObjectDecoder_m_LLMdecsts          EQU	%d\n", offset);
	offset = offsetof(CAudioObjectDecoder, m_Colombdecsts);						//lossless
	fprintf(hinc, "CAudioObjectDecoder_m_Colombdecsts       EQU	%d\n", offset);
	offset = offsetof(CAudioObjectDecoder, m_iResQ);							//lossless
	fprintf(hinc, "CAudioObjectDecoder_m_iResQ              EQU	%d\n", offset);
	offset = offsetof(CAudioObjectDecoder, m_iResQBits);						//lossless
	fprintf(hinc, "CAudioObjectDecoder_m_iResQBits          EQU	%d\n", offset);
	offset = offsetof(CAudioObjectDecoder, m_ibstrm);							//lossless
	...
	offset = offsetof(CAudioObject, m_nValidBitsPerSample);						//lossless
	...
	offset = offsetof(CAudioObject, m_bDoInterChDecorr);						//lossless
	fprintf(hinc, "CAudioObject_m_bDoInterChDecorr          EQU	%d\n", offset);	
	offset = offsetof(CAudioObject, m_bSeekable);								//lossless
	fprintf(hinc, "CAudioObject_m_bSeekable                 EQU	%d\n", offset);	
	offset = offsetof(CAudioObject, m_iCurrReconCoef);							//lossless
	fprintf(hinc, "CAudioObject_m_iCurrReconCoef            EQU	%d\n", offset);	
	offset = offsetof(CAudioObject, m_cFrameSampleHalf);						//lossless
	...
	offset = offsetof(CAudioObject, m_iResidueMemScaling);						//lossless
	fprintf(hinc, "CAudioObject_m_iResidueMemScaling        EQU	%d\n", offset);		
	offset = offsetof(CAudioObject, m_cLastCodedIndexV3);
	fprintf(hinc, "CAudioObject_m_cLastCodedIndexV3         EQU	%d\n", offset);
	fprintf(hinc, "cLastCodedIndexV3OffsetPart1             EQU	%d\n", 512);		//CAudioObject_m_cLastCodedIndexV3 is too big, so input it twice.
	fprintf(hinc, "cLastCodedIndexV3OffsetPart2             EQU	%d\n", offset - 512);
	...
	offset = offsetof(PerChannelInfo, m_cLMSPredictors);							//lossless
	fprintf(hinc, "PerChannelInfo_m_cLMSPredictors          EQU	%d\n", offset);
	offset = offsetof(PerChannelInfo, m_iSum);										//lossless
	fprintf(hinc, "PerChannelInfo_m_iSum                    EQU	%d\n", offset);
	offset = offsetof(PerChannelInfo, m_rgsubfrmconfig);							//lossless
	...
	offset = offsetof(PerChannelInfo, m_iUpdSpdUpSamples);							//lossless
	fprintf(hinc, "PerChannelInfo_m_iUpdSpdUpSamples        EQU	%d\n", offset);
	offset = offsetof(PerChannelInfo, m_iTransientPosition);						//lossless
...
*/
	...
	//struct LMSPredictor for lossless
	fprintf(hinc, "\n");
	...
	//struct SubFrameConfigInfo for lossless
	fprintf(hinc, "\n");
