...
@***********************************************************************/
	...
	.globl	_ccClip255	
	.globl	_cc_yuv420_to_argb32_mb_s_180_arm

_cc_yuv420_to_argb32_mb_s_180_arm: @PROC
		stmdb	sp!, {r4-r11, lr}		@ save regs used
		sub	sp, sp, #60					@ sp - 32
			
		ldr	r7, [sp, #108]				@dst_stride	
		ldr	r5, [sp, #100]				@dst				
		ldr	r14, ccClip255_DATA_180
...
ARGB32_LIT_WHILE_D_180:			
		...
		@a7 = ((ccClip255[(a5 + a0)>>20])<<16)|((ccClip255[(a5 - a1)>>20])<<8)|(ccClip255[(a5 + a2)>>20])@
