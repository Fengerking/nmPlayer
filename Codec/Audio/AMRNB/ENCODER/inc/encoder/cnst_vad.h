...
#define TONE_THR 	21299	//(Word16)(0.65*MAX_16) /* Threshold for tone detection   */

/* Constants for background spectrum update */
#define ALPHA_UP1   1638		//(Word16)((1.0 - 0.95)*MAX_16)  /* Normal update, upwards:   */
#define ALPHA_DOWN1 2097	//(Word16)((1.0 - 0.936)*MAX_16) /* Normal update, downwards  */
#define ALPHA_UP2   492	//(Word16)((1.0 - 0.985)*MAX_16) /* Forced update, upwards    */
#define ALPHA_DOWN2 1868	//(Word16)((1.0 - 0.943)*MAX_16) /* Forced update, downwards  */
#define ALPHA3      1638	//(Word16)((1.0 - 0.95)*MAX_16)  /* Update downwards          */
#define ALPHA4      3277	//(Word16)((1.0 - 0.9)*MAX_16)   /* For stationary estimation */
#define ALPHA5      16384	//(Word16)((1.0 - 0.5)*MAX_16)   /* For stationary estimation */
...
#define VAD_SLOPE 	-2809	//(Word16)(MAX_16*(float)(VAD_THR_LOW-VAD_THR_HIGH)/(float)(VAD_P2-VAD_P1))
...
#define CVAD_THRESH_ADAPT_HIGH   19660 /*(Word16)(0.6 * MAX_16) threshold for adapt stopping high    */
#define CVAD_THRESH_ADAPT_LOW  16384	 //(Word16)(0.5 * MAX_16)  /* threshold for adapt stopping low     */
#define CVAD_THRESH_IN_NOISE  21299   /*(Word16)(0.65 * MAX_16) threshold going into speech on
                                                          a short term basis                   */

#define CVAD_THRESH_HANG  22937	//(Word16)(0.70 * MAX_16)      /* threshold                            */
#define CVAD_HANG_LIMIT  (Word16)(100)                 /* 2 second estimation time             */
#define CVAD_HANG_LENGTH  (Word16)(250)                /* 5 second hangover                    */

#define CVAD_LOWPOW_RESET 13107 	//(Word16) (0.40 * MAX_16)     /* init in low power segment            */
#define CVAD_MIN_CORR 	13107	//(Word16) (0.40 * MAX_16)         /* lowest adaptation value              */

#define CVAD_BURST 20                                  /* speech burst length for speech reset */
#define CVAD_ADAPT_SLOW 655	//(Word16)(( 1.0 - 0.98) * MAX_16)        /* threshold for slow adaption */
#define CVAD_ADAPT_FAST 2621	//(Word16)((1.0 - 0.92) * MAX_16)         /* threshold for fast adaption */
#define CVAD_ADAPT_REALLY_FAST 6553	//(Word16)((1.0 - 0.80) * MAX_16)  /* threshold for really fast
                                                                  // adaption                    */
