...
;***********************************************************************/				
	...
	EXPORT	|cc_argb32_mb_16x16_l90_arm|
	IMPORT	|ccClip255|	
	AREA	|.text|, CODE, READONLY

  macro 
  cc_argb32_mb_16x16_l90_arm_num_count $Num
        ...
        orr r8, r12, r9,  lsl #8         ;********r8 = a4 | ((a3 |(a5<<8))<<8) 
		...
		if $Num>0
			...
			str r8,  [r4, #4]
        	str	r10, [r4, #$Num]		;*((VO_S32*)(out_buf+(4*num))) = (VO_S32)a4;		        	
		endif
...
|cc_argb32_mb_16x16_l90_arm| PROC
		...
		mov	r12, #8						;a6 = 8
		str	r12, [sp, #4]	
ARGB32_BIG_WHILE_l90
	cc_argb32_mb_16x16_l90_arm_num_count 0
	cc_argb32_mb_16x16_l90_arm_num_count 1
	cc_argb32_mb_16x16_l90_arm_num_count 2
	cc_argb32_mb_16x16_l90_arm_num_count 3
	cc_argb32_mb_16x16_l90_arm_num_count 4
	cc_argb32_mb_16x16_l90_arm_num_count 5
	cc_argb32_mb_16x16_l90_arm_num_count 6
	cc_argb32_mb_16x16_l90_arm_num_count 7	
