...
;***********************************************************************/
	...
	EXPORT VP6DEC_VO_Armv7IdctA
	EXPORT VP6DEC_VO_Armv7IdctB	
	EXPORT VP6DEC_VO_Armv7IdctC	
	ALIGN 4		
 macro	
 LOAD_IDCT_SRC
	 vld1.64 {d0}, [r3], r12 
...
;	v = SAT((128 + OutD));		
	...
	ALIGN 4	
W_table	
		dcd 0x7D8A18F8			;xC7 = D0.S16[0] xC1 = D0.S16[1]		
		dcd 0x471D6A6D			;xC5 = D0.S16[2] xC3 = D0.S16[3]			
		dcd 0x764130FC			;xC6 = D1.S16[0] xC2 = D1.S16[1]		
		dcd 0x00005A82			;xC4 = D1.S32[1]/D1.S32[2]							
