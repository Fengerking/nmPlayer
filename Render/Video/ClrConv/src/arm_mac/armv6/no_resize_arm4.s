	...
	.globl	 _cc_mb_16x16_r90_arm 
	.globl	 _ccClip63

  .macro cc_mb_16x16_r90_arm_num_count
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
...
@		ldrb	r10, [r10, #0]			@r10 = psrc_y[in_stride+2*num]
	...
	.else
        	str	r8, [r4, #$0]			@*((int32_t*)(out_buf+(4*num))) = (int32_t)a4@	        	
	.endif
        	sub	r10, r10, #16	
...
ccClip63_DATA_r: .word _ccClip63 
