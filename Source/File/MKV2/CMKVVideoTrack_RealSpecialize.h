...
{
public:
	CMKVVideoTrack_RealSpecialize( VO_U8 btStreamNum, VO_U32 dwDuration , TracksTrackEntryStruct * pAudioInfo , VO_MEM_OPERATOR* pMemOp );
	virtual ~CMKVVideoTrack_RealSpecialize();

//	virtual VO_BOOL NewFrameArrived( MKVFrame * pFrame );
	VO_BOOL SampleNotify(VO_PTR pUser, VO_PTR wParam , VO_PTR lParam );
