...
#include "../../voASMPort.h"
	...
	.text
	.align 4
	.globl	VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_Y)
	.globl	VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_UV)
	.globl	VOASMFUNCNAME(ARMV7_rv9_v_loop_filter_Y)
	.globl	VOASMFUNCNAME(ARMV7_rv9_v_loop_filter_UV)
	.globl	VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_2block)

@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	.macro M_rv9_deblock_normal
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
@								)
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_Y):	@PROC

.set OFFSET_SaveRegisters_h,		36	
.set OFFSET_Cl_h,				OFFSET_SaveRegisters_h + 0
.set OFFSET_alpha_h,			OFFSET_SaveRegisters_h + 4
.set OFFSET_betaX_h,			OFFSET_SaveRegisters_h + 8
.set OFFSET_beta2_h,			OFFSET_SaveRegisters_h + 12
.set OFFSET_bStrong_h,		OFFSET_SaveRegisters_h + 20
...
@	} //if((Al+Ar) > 0)	
	...
	.align 8		
Table_ditherLRA:
	.short	64, 80, 32, 96, 48, 80, 64, 48, 80, 64, 80, 48, 96, 32, 80, 64, 64, 48, 96, 32, 80, 48, 48, 64, 64, 64, 80, 48, 32, 96, 48, 64
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@	
VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_UV):	@PROC
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@	
...
@								)
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
VOASMFUNCNAME(ARMV7_rv9_v_loop_filter_Y):	@PROC
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@	
VOASMFUNCNAME(ARMV7_rv9_v_loop_filter_UV):	@PROC
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@	
...
VOASMFUNCNAME(ARMV7_rv9_h_loop_filter_2block):	@PROC

.set OFFSET_SaveRegisters,		36	
.set OFFSET_alpha,		OFFSET_SaveRegisters + 0
.set OFFSET_betaX,		OFFSET_SaveRegisters + 4
.set OFFSET_beta2,		OFFSET_SaveRegisters + 8
.set OFFSET_yuv_h_deblock,		OFFSET_SaveRegisters + 12
