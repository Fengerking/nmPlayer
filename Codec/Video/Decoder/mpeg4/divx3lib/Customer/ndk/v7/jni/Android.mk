...
VOMM:= -DHAVE_NEON=1 -DNEW_SDK -DMPEG4 -DRVDS -DVOARMV7 -DVODIVX3 -DVOANDROID

LOCAL_CFLAGS := -D_VOMODULEID=0x02070000  -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp -fsigned-char
