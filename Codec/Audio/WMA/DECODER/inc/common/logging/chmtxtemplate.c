...
#include <math.h>
static WMARESULT SetMixFromAngles(CAudioObjectDecoder *paudec, I32UP cSrcChannels, I32UP cDstChannels,
...
WMARESULT SetMixFromChannelMask(CAudioObjectDecoder *paudec, I32UP cSrcChannels, I32UP cDstChannels,
...
#define SPEAKER_POS (11)
  ...
  wmar = SetMixFromAngles(paudec, cSrcChannels, cDstChannels,
