...
VOMM:= -D_RM_READER -DVO_FILE_USE_BIG_ENDIAN -D__VO_NDK__ -DLINUX -D_LINUX -D_LINUX_ANDROID -D_SOURCE2 -D_VOLOG_FUNC -D_VOLOG_INFO -D_VOLOG_WARNING -D_VOLOG_ERROR -D_VONAMESPACE=libvoRealFR

# about info option, do not need to care it
LOCAL_CFLAGS := -D_VOMODULEID=0x00040000  -DNDEBUG -march=i686 -mtune=atom -mstackrealign -msse3 -mfpmath=sse -m32
