...
VOMM:= -DHAVE_NEON=1 -DVOARMV7 -DVOANDROID -DANDROID -DASM_OPT -DENABLE_LICENSE_CHECK -DNDEBUG -DHIDDEN_SYMBOL=1

LOCAL_CFLAGS := -D_VOMODULEID=0x020e0000  -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp -mtpcs-frame -mthumb
