  ...
  .if WMV_OPT_MOTIONCOMP_ARM==1
	...
	.globl	_g_AddErrorB_EMB_Overflow
    .globl  _g_AddError_EMB_Overflow	
	.globl	_g_AddErrorB_SSIMD 
	.globl	_g_AddError_SSIMD
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    WMV_LEAF_ENTRY g_AddErrorB_SSIMD
@r0 == ppxlcDst
@r1 == pRef0
@r2 == pRef1
@r3 == pErrorBuf
...
.set AEBS_OffsetRegSaving   ,       0x28
.set AEBS_Offset_iPitch          ,       AEBS_OffsetRegSaving + 0
.set AEBS_Offset_iOffset        ,       AEBS_OffsetRegSaving +  4
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
   WMV_LEAF_ENTRY g_AddError_SSIMD
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
