...
CMKVAudioTrack_RealSpecialize::CMKVAudioTrack_RealSpecialize( VO_U8 btStreamNum, VO_U32 dwDuration , TracksTrackEntryStruct * pAudioInfo , CMKVFileReader * pReader, VO_MEM_OPERATOR* pMemOp )
:CMKVAudioTrack( btStreamNum , dwDuration , pAudioInfo , pReader , pMemOp )
