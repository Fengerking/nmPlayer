...
CMKVVideoTrack_RealSpecialize::CMKVVideoTrack_RealSpecialize( VO_U8 btStreamNum, VO_U32 dwDuration , TracksTrackEntryStruct * pVideoInfo, VO_MEM_OPERATOR* pMemOp )
:CMKVVideoTrack( btStreamNum , dwDuration , pVideoInfo , pMemOp )
...
VO_BOOL CMKVVideoTrack_RealSpecialize::SampleNotify(VO_PTR pUser, VO_PTR wParam , VO_PTR lParam )
{
#if 0
