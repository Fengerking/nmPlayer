...
VOMM:= -D_MKV_READER -DVO_FILE_USE_BIG_ENDIAN -D__arm -D_VOLOG_FUNC -D_SOURCE2 -DLINUX -D_LINUX -D__VO_NDK__ -D_LINUX_ANDROID -D_VOLOG_ERROR -D_VOLOG_WARNING -D_VOLOG_INFO -D_VOSYMOBF

# about info option, do not need to care it
LOCAL_CFLAGS := -D_VOMODULEID=0x01080000  -DNDEBUG -DARM -DARM_ASM -march=armv6j -mtune=arm1136jf-s -mfpu=vfp -mfloat-abi=softfp
LOCAL_LDLIBS := ../../../../../../../Lib/ndk/libvoCheck.a -llog ../../../../../../../Lib/ndk/libvoVideoParser.a -L../../../../../../../Lib/ndk/ -lvodl 
