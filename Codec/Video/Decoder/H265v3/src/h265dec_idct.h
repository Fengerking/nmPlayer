...
#define SCALING_LIST_REM_NUM  6	//  remainder of QP/6
  ...
  VO_VOID IDCT8X8_4X4_ASMV7(const VO_S16 *p_invtransform_buff,
                    VO_U8 *p_prediction_buff,
                    const VO_U32 prediction_stride,
                    VO_S16 * tmp_block_array);
  ...
  VO_VOID IDCT16X16_8X8_ASMV7(const VO_S16 *p_invtransform_buff,
                              VO_U8 *p_perdiction_buff,
                              const VO_U32 prediction_stride,
                              VO_S16 * tmp_block_array);
  ...
  VO_VOID IDCT32X32_8X8_ASMV7(const VO_S16 *p_invtransform_buff,
                              VO_U8 *p_perdiction_buff,
                              const VO_U32 prediction_stride,
                              VO_S16 * tmp_block_array);

  VO_VOID IDCT32X32_16X16_ASMV7(const VO_S16 *p_invtransform_buff,
                              VO_U8 *p_perdiction_buff,
                              const VO_U32 prediction_stride,
                              VO_S16 * tmp_block_array);
