...
VOMM:=-DLINUX -DARM -DARMV6 -DLCHECK -DMSVC_AMRWBPLUS
LOCAL_LDLIBS:= -llog
# about info option, do not need to care it

LOCAL_CFLAGS := -D_VOMODULEID=0x02270000   -DNDEBUG -mfloat-abi=soft -march=armv6j -mtune=arm1136jf-s -mfpu=vfp -fsigned-char
