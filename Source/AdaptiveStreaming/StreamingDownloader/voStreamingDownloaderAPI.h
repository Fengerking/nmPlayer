...
#define EVENTID_ERROR_STREAM_ERR_NOTSUPPORT_LIVE_FAIL			(EVENTID_ERROR_STREAMDOWNLOADER_BASE | 0x0007)				/*!< notify that this link is live.*/
#define EVENTID_ERROR_STREAM_ERR_NOTSUPPORT_LOCAL_FAIL			(EVENTID_ERROR_STREAMDOWNLOADER_BASE | 0x0008)				/*!< notify that this link is local.*/
