...
/*******************************************************************************
	...
	Contains:	CVOMEPlayer2 header file
...
#ifndef __CVOMEPlayer2_H__
#define __CVOMEPlayer2_H__
...
protected:
	...
	OMX_PTR	 						m_hModule;
	//OMX_PTR							m_hPlay;
	COMXMobiTVDataSourcePlayer				m_fAPI;
...
public:
	...
	static OMX_U32			vomeSourceDrmProc (OMX_IN OMX_U32 nDrmType, 
											   OMX_IN OMX_PTR pDrmInfo, 
											   OMX_IN OMX_PTR pUserData, 
	...
	static OMX_U32  vomeWDrmPacketProc(OMX_PTR pPacketData, OMX_U32 dwPacketSize, OMX_PTR pUserData, OMX_U32 nReserved);
#endif
