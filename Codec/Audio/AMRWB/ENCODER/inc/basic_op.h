...
#define vo_L_shl(a,b)		    ((b < 0) ? ( a >> -b ) :  (a << b))
#define vo_shr(a,b)		        ((b < 0) ? ( a << -b ) :  (a >> b))
	...
	else
	{
		...
		else
		{
			...
			for (iteration = 0; iteration < 15; iteration++)
			{
				...
				if (L_num >= L_denom)
				{
					L_num -= L_denom;      // L_sub (L_num, L_denom);
					var_out += 1;          //add (var_out, 1);
				}
			}
		}
	}
