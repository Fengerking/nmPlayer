...
)
{
    ...
    if (nbbits == 20)
    {
        ...
        {
            L_index = index[k];
            voAMRWBPDecDec_1p_N1(L_index, 4, 0, pos);
    ...
    {                                                  
        ...
        {
            L_index = index[k];                                
            voAMRWBPDecDec_2p_2N1(L_index, 4, 0, pos);         
    ...
    } else if (nbbits == 44)
    {
        ...
        {
            L_index = index[k];
            voAMRWBPDecDec_3p_3N1(L_index, 4, 0, pos);
    ...
    } else if (nbbits == 64)
    {
        for (k = 0; k < NB_TRACK; k++)
        {
            ...
            voAMRWBPDecDec_4p_4N(L_index, 4, 0, pos);
    ...
    } else if (nbbits == 72)
    {
        for (k = 0; k < NB_TRACK - 2; k++)
        {
            ...
            voAMRWBPDecDec_5p_5N(L_index, 4, 0, pos);
    ...
    } else if (nbbits == 88)
    {
        for (k = 0; k < NB_TRACK; k++)
        {
            ...
            voAMRWBPDecDec_6p_6N_2(L_index, 4, 0, pos);
