...
;***********************************************************************/
	...
	EXPORT |voyuv444torgb32_8nx2n_armv7_new_BGR255|
...
|voyuv444torgb32_8nx2n_armv7_new_BGR255| PROC
;void voyuv420torgb32_arm(uint8_t *psrc_y, uint8_t *psrc_u, uint8_t *psrc_v, 
;			  int32_t in_stridey, 
...
;line y1  0~7	
		...
		add	r1, r1, r4, lsl #1	;u
		add	r2, r2, r5, lsl #1	;v
