...
void   CAnalyseH265::SetFormat(void *pFmt)
{
...
VO_BOOL	CAnalyseH265::AnalyseData(VO_BYTE *pData , VO_U32 nDataLen)
{
...
VO_BOOL	CAnalyseH265::IsKeyFrame(VO_BYTE *pData , VO_U32 nDataLen)
{
...
//change ST_H265 to ST_AVC4
void	CAnalyseH265::STH265ToAVC(VO_BYTE **ppData , VO_U32 &nDataLen)
{
#if 1
	int nPadLen = 0;
...
void	CAnalyseH265::WriteDataLen(VO_BYTE *pData , VO_U32 nDataLen)
{
...
bool	CAnalyseH265::AllocFrameBuf()
{
	if(mpData == NULL)
	{
...
bool	CAnalyseH265::WriteRawDataToBuf(VO_BYTE *pData , VO_U32 nDataLen)
{
	if(mpData == NULL)
	{
		if(!AllocFrameBuf())
...
void    CAnalyseH265::STRawToAVC(VO_BYTE **ppData , VO_U32 &nDataLen)
{
...
VO_U32 CAnalyseH265::TrimSample(VO_BYTE **ppData , VO_U32 &nDataLen)
{
	return 0;
}

void CAnalyseH265::DetectStreamType(VO_BYTE *pData , VO_U32 nDataLen)
{
	mnNestDeep ++;
	if(pData[0] == 0x0 && pData[1] == 0x0 && (pData[2] == 0x1 || (pData[2] == 0x0 && pData[3] == 0x1)))
	{
		mnStreamType = ST_H265;
		mnNestDeep --;
		return;
	}
...
VO_BOOL		CAnalyseH265::IsKeyFrm(VO_BYTE *pData , VO_U32 nDataLen)
{
