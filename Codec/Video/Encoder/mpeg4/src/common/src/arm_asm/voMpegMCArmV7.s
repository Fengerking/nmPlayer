...
;***********************************************************************/
	...
	EXPORT CopyBlock8x8_ARMV7 
CopyBlock8x8_ARMV7  PROC
	VLD1.64  {d0},[r0],r2  
	VLD1.64  {d1},[r0],r2  
	VLD1.64  {d2},[r0],r2  
	VLD1.64  {d3},[r0],r2  
...
;------------------------------------------
	EXPORT CopyBlock16x16_ARMV7 
CopyBlock16x16_ARMV7  PROC
;	ldr		r12, [sp]
	mov		r12, #16
...
;ArmInter8x8
;------------------------------------------
	EXPORT MCMpegBlock_ARMV7 
MCMpegBlock_ARMV7  PROC
;	ldr		r12, [sp]
;	mov		r12, #8
...
;ArmInter2_8x8 
;------------------------------------------
	EXPORT MCMpegBlockAdd_ARMV7 
MCMpegBlockAdd_ARMV7  PROC
    PUSH     {lr}
;	ldr		r12, [sp, #4]
	mov		r12, #8
...
; ArmInter8x8H
;------------------------------------------
	EXPORT MCMpegBlockHor_ARMV7 
MCMpegBlockHor_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	mov		Count, #8
...
;------------------------------------------
; MCMpegBlockRdHor_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockRdHor_ARMV7 
MCMpegBlockRdHor_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	mov		Count, #8
...
;------------------------------------------
; MCMpegBlockVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockVer_ARMV7 
MCMpegBlockVer_ARMV7  PROC
;	ldr		Count, [sp]
;	mov		Count, #8		
;MPEG4DEC_VO_Armv7Inter8x8V_loop
	VLD1.8 {D0}, [Src], Src_W
	VLD1.8 {D1}, [Src], Src_W
	VLD1.8 {D2}, [Src], Src_W	
	VLD1.8 {D3}, [Src], Src_W
	...
	VST1.64 {D10}, [Dst], Dst_W
;	SUBS Count, Count, #8				
;	BGT MPEG4DEC_VO_Armv7Inter8x8V_loop
	mov	pc, lr
	ENDP	

;------------------------------------------
; MCMpegBlockRdVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockRdVer_ARMV7 
MCMpegBlockRdVer_ARMV7  PROC
;	ldr		Count, [sp]
;	mov		Count, #8		
;MPEG4DEC_VO_Armv7Inter8x8VRD_loop
	VLD1.8 {D0}, [Src], Src_W
	VLD1.8 {D1}, [Src], Src_W
	VLD1.8 {D2}, [Src], Src_W	
	VLD1.8 {D3}, [Src], Src_W
	...
	VST1.64 {D10}, [Dst], Dst_W
;	SUBS Count, Count, #8
;	BGT MPEG4DEC_VO_Armv7Inter8x8VRD_loop		 
	mov	pc, lr
	ENDP			
;------------------------------------------
; MCMpegBlockHorVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockHorVer_ARMV7 
MCMpegBlockHorVer_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	mov		Count, #8
...
;------------------------------------------
; MCMpegBlockRdHorVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockRdHorVer_ARMV7 
MCMpegBlockRdHorVer_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	mov		Count, #8
...
;------------------------------------------
; MCMpegBlockAddHor_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockAddHor_ARMV7 
MCMpegBlockAddHor_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	mov		Count, #8
...
MPEG4DEC_VO_Armv7Inter2_8x8H_loop
	...
	ENDP	
;------------------------------------------
; MCMpegBlockAddVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockAddVer_ARMV7 
MCMpegBlockAddVer_ARMV7  PROC
;	ldr		Count, [sp]
	mov		Count, #8
	VMOV.U8 D13, #1		
	VLD1.8 {D0}, [Src], Src_W	
MPEG4DEC_VO_Armv7Inter2_8x8V_loop
	...
	ENDP		
;------------------------------------------
; MCMpegBlockAddHorVer_ARMV7
;------------------------------------------
	EXPORT MCMpegBlockAddHorVer_ARMV7 
MCMpegBlockAddHorVer_ARMV7  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
;	ldr		Count, [sp, #4]
	VLD1.8 {D0}, [Src], Src_W
