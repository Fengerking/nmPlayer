...
********************************************************************************
*/
int voAMRNBEnc_cl_ltp_init (clLtpState **st, VO_MEM_OPERATOR *pMemOP);
...
int voAMRNBEnc_cl_ltp_reset (clLtpState *st);
/* reset of pre processing state (i.e. set state memory to zero)
   returns 0 on success
 */
void voAMRNBEnc_cl_ltp_exit (clLtpState **st, VO_MEM_OPERATOR *pMemOP);
