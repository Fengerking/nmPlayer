...
#ifndef __cmnAudioMemory_H__
#define __cmnAudioMemory_H__
...
* \return value 0 is succeded.
*/
VO_S32	cmnMemCompare (VO_S32 uID, VO_CPTR pBuffer1, VO_CPTR pBuffer2, VO_U32 uSize);
 ...
 * \return value 0 is succeded.
 */
VO_U32	cmnMemMove (VO_S32 uID, VO_PTR pDest, VO_CPTR pSource, VO_U32 uSize);
