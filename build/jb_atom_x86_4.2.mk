...
TCROOTPATH:=/opt/jb_atom_x86_4.2
GCCVER:=4.6
TCPATH:=$(TCROOTPATH)/prebuilts/gcc/linux-x86/x86/i686-linux-android-$(GCCVER)
...
CCTINC:=-I$(TCROOTPATH)/dalvik/libnativehelper/include/nativehelper \
		...
		-I$(TCROOTPATH)/external/webkit/Source/WebKit/android/JavaVM/ \
...
VOCFLAGS:=-O2 -Ulinux -Wa,--noexecstack -Wstrict-aliasing=2 -fPIC -ffunction-sections -finline-functions -finline-limit=300 -fno-inline-functions-called-once -fno-short-enums -fstrict-aliasing \
		-funswitch-loops -funwind-tables -march=atom -mstackrealign -DUSE_SSSE3 -DUSE_SSE2 -mfpmath=sse -mbionic -D__ANDROID__ -DANDROID -fmessage-length=0 -W -Wall -Wno-unused -Winit-self -Wpointer-arith \
		-O2 -g -fno-strict-aliasing -DNDEBUG -UDEBUG -DANDROID -fmessage-length=0 -W -Wall -Wno-unused -Winit-self -Wpointer-arith -DANDROID_TARGET_BUILD -finline-limit=64 -finline-functions \
		-fno-inline-functions-called-once -D_GNU_SOURCE -D__STDC_LIMIT_MACROS -D__STDC_CONSTANT_MACROS -O2 -fomit-frame-pointer -Wall -W -Wno-unused-parameter -Wwrite-strings  -fno-exceptions \
		-Wno-unused-but-set-variable

CCTCFLAGS:=-fno-rtti -Woverloaded-virtual -Wno-sign-promo -fno-use-cxa-atexit -Wsign-promo -fno-rtti
...
LIBGCCA:=$(TCROOTPATH)/prebuilts/gcc/linux-x86/x86/i686-linux-android-4.6/lib/gcc/i686-linux-android/4.6/libgcc.a
...
VOCFLAGS+=$(VOCFLAGS) $(CCTINC)
VOCPPFLAGS:=$(VOCFLAGS) $(CCTCFLAGS)
ifeq ($(VOMT), lib)
VOLDFLAGS+=-shared
endif
endif
