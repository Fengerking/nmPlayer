...
IDCT8X8ASMV7   
        ...
        ldr   r12, =kg_IDCT_coef_for_t8_asm
       ...
       vmov       q4, q15
        ...
        ldr    r12, [sp, #0]
        vld1.8 {d0}, [r1], r12  			;@pPerdiction[0]
        vld1.8 {d10},[r1], r12  			;@pPerdiction[1]
        vld1.8 {d16},[r1], r12  			;@pPerdiction[2]
        vld1.8 {d22},[r1], r12  			;@pPerdiction[3]
        vld1.8 {d24},[r1], r12  			;@pPerdiction[4]
        vld1.8 {d26},[r1], r12  			;@pPerdiction[5]
        vld1.8 {d28},[r1], r12  			;@pPerdiction[6]
