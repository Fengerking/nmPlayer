...
;result = ( 0*lTemp0 + 6*lTemp1 +      9*lTemp2 + lTemp3 + 128) >> 8;			
 ...
 macro
 	Interpolate_H01_OR_H02_HV $is_H01	;input q1~3,  output q13~15 ;q5~12	
...
;result = (-1*lTemp0 + 6*((lTemp1<<1) + lTemp2) + -1*lTemp3 + 8)>>4
 ...
 macro
; 	Interpolate_V01_OR_V02 $is_V01	;input d0, d10~15, d24~27,  output q8~9,q6,q1~5
...
;8 line input d2, d4, d6, d8	
 ...
 macro  
; 	Interpolate_V01_OR_V02_HV $is_V01, $is_ADD, $round, $shif	;input q8,q9, q6,q1~5, q13, q11, q10,  output q15,q7,q12,q14,q8,q9,q2,q1  
...
;8 line input q12, q13, q14, q15 out q2 
 ...
 macro  
; 	Interpolate_V01_OR_V02_HV_22 $is_ADD, $round, $shif	;input q5~8,q9~12,q13~14  output q6,q7,q10,q12,q8,q9,q14,q15
...
;}	/* H00V00 */
	...
	EXPORT ARMV7_Interpolate_H00V00 
...
;	}
;}
	EXPORT ARMV7_Interpolate_H01V00 
...
;}
	...
	EXPORT ARMV7_Interpolate_H02V00 
...
;	}
;}
	EXPORT ARMV7_Interpolate_H00V01 
...
;
;}
	EXPORT ARMV7_Interpolate_H01V01 
...
;	}	
;}
	EXPORT ARMV7_Interpolate_H02V01 
...
;	}
;}
	EXPORT ARMV7_Interpolate_H00V02 
...
;	}
;}
	EXPORT ARMV7_Interpolate_H01V02 
...
;	}
;}
	EXPORT ARMV7_Interpolate_H02V02 
...
;	}
;}
	EXPORT ARMV7_AddInterpolate_H00V00 
...
;	}
;}
	EXPORT ARMV7_AddInterpolate_H01V00 
...
;}
	...
	EXPORT ARMV7_AddInterpolate_H02V00 
...
;}
	...
	EXPORT ARMV7_AddInterpolate_H00V01 
...
;
;}
	EXPORT ARMV7_AddInterpolate_H01V01 
...
;	}	
;}
	EXPORT ARMV7_AddInterpolate_H02V01 
...
;	}
;}
	EXPORT ARMV7_AddInterpolate_H00V02 
...
;	}
;}
	EXPORT ARMV7_AddInterpolate_H01V02 
...
;	}
;}
	EXPORT ARMV7_AddInterpolate_H02V02 
...
;}
	...
	EXPORT ARMV7_MCCopyChroma_H00V00 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H01V00 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H02V00 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H00V01 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H00V02 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H01V01 
...
;
;}
	EXPORT ARMV7_MCCopyChroma_H02V01 
...
;	}
;}
	EXPORT ARMV7_MCCopyChroma_H01V02 
...
;
;}
	EXPORT ARMV7_MCCopyChroma_H02V02 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H00V00 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H01V00 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H02V00 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H00V01 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H00V02 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H01V01 
...
;
;}
	EXPORT ARMV7_AddMCCopyChroma_H02V01 
...
;	}
;}
	EXPORT ARMV7_AddMCCopyChroma_H01V02 
...
;
;}
	EXPORT ARMV7_AddMCCopyChroma_H02V02 
