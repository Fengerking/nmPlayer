...
public:
	...
	virtual OMX_ERRORTYPE		SetVideoInfo (VO_VIDEO_CODINGTYPE nCoding, VO_IV_COLORTYPE nColorType,
	...
	OMX_ERRORTYPE				GetPortDefinition(OMX_PTR pParam);
...
//	OMX_BUFFERHEADERTYPE *			m_pOutputBuffer;
	...
	VO_VIDEO_DECDIMENSION			m_deminfo;
