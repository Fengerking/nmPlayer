...
int main(int argc, const char **argv_)
{
    ...
    strcat(codec.name, "\0");
    codec.iface = vpx_codec_vp8_cx();
    codec.fourcc = 0x30385056;
    ...
    printf("Address of codec.iface = 0x%x\n", codec.iface);
    printf("Address of vpx_codec_vp8_cx_algo = 0x%x\n", &vpx_codec_vp8_cx_algo);
