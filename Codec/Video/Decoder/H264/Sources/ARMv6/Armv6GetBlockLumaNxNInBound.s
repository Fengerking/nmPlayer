...
;; mark_begin;
       ...
       AREA GetBlockLuma, CODE, READONLY
	MACRO
	b_EXIT_FUNC
	...
	MACRO 
	GetFULL $src,$srcStride,$dest,$destStride,$blockSizeX,$blockSizeY
offset0			RN	2
OutLoopCount 	RN	7
InnerLoopCount 	RN	14
src1			RN	3
src2			RN	8
offset1 		RN	9
...
FULL_OUTER_
	...
	MEND
	MACRO 
	GetDYP1_DXP1 $src,$srcStride,$dest,$destStride,$blockSizeX,$dxp,$clip255,$blockSizeY
OutLoopCount_1		RN 11
InnerLoopCount_1	RN 11
src0_1				RN	7
src1_1				RN	8
src2_1				RN	2
src3_1				RN	3
...
;	add		temp_1,src2_1,src3_1
 ...
 ;   add		temp2_1,temp2_1,temp2_1,lsl #2		;5*(-1+2)
    sub		temp_1,src3_1,temp2_1			;(-2+3) - 5*(-1+2)
    ;smlatb	temp_1,temp3_1,temp2_1,temp_1			;(-2+3) - 5*(-1+2) + 20*(0+1) 
...
;;;;;;out loop control
    ...
    MEND	
	MACRO 
	GetDYP1_DXP0 $src,$srcStride,$dest,$destStride,$blockSizeX,$clip255,$blockSizeY
OutLoopCount_2		RN	11
InnerLoopCount_2	RN	11
src0_2				RN	7
src1_2				RN	8
src2_2				RN	2
src3_2				RN	3
...
;	str    OutLoopCount_2 ,[sp,#52]
	...
	MEND
 	MACRO 
	GetDXP1_DYP1 $src,$srcStride,$dest,$destStride,$blockSizeX,$dyp,$clip255,$blockSizeY
OutLoopCount_3			RN  8
InnerLoopCount_3		RN  8
src0_3				RN  7
src1_3				RN  8
src2_3				RN  2
src3_3				RN  3
...
;	ldrb	result_3,[clip255_3,+temp_3,ASR #5]		;stall
	add		src1_3,src6_3,src1_3
		usat	result_3, #8, temp_3, asr #5

;	pld	[$src,srcStride_3]
;	add		temp_3,src6_3,src1_3
	add		temp_3,src2_3,src5_3
	addeq	result_3,result_3,src2_3
	addne	result_3,result_3,src3_3
	add     result_3,result_3,#1
	add		temp_3,temp_3,temp_3,lsl #2		;5*(-1+2)
...
;	add		temp2_3,temp2_3,temp2_3,lsl #2		;5*(-1+2)
	sub		temp_3,src1_3,temp_3			;(-2+3) - 5*(-1+2)
	;smlatb	temp_3,temp3_3,temp2_3,temp_3			;(-2+3) - 5*(-1+2)	
...
;	add		temp_3,temp_3,#16		   				;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;	ldrb	result_3,[clip255_3,+temp_3,ASR #5]		;stall*/
	add		src2_3,src1_3,src2_3
		usat	result_3, #8, temp_3, asr #5
;	pld	[$src,srcStride_3]
	add		temp_3,src3_3,src6_3
...
;	add		temp2_3,temp_3,temp_3,lsl #2		;5*(-1+2)
	sub		temp_3,src2_3,temp_3			;(-2+3) - 5*(-1+2)
...
;	add		temp_3,temp_3,#16		   							;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;	ldrb	result_3,[clip255_3,+temp_3,ASR #5]		;stall
	add		src3_3,src2_3,src3_3
		usat	result_3, #8, temp_3, asr #5

	;pld	[$src,srcStride_3]
   	add		temp_3,src4_3,src1_3
...
;	add		temp2_3,temp_3,temp_3,lsl #2		;5*(-1+2)
	sub		temp_3,src3_3,temp_3			;(-2+3) - 5*(-1+2)
	;smlatb	temp_3,temp3_3,temp2_3,temp_3			;(-2+3) - 5*(-1+2) + 20*(0+1) 
...
;;;;;;out loop control
	...
	MEND
	MACRO 
	GetDXP1_DYP0 $src,$srcStride,$dest,$destStride,$blockSizeX,$clip255,$blockSizeY
OutLoopCount_4			RN  8
InnerLoopCount_4		RN  8
src0_4				RN  7
src1_4				RN  8
src2_4				RN  2
src3_4				RN  3
...
;	mov     OutLoopCount_4,$blockSizeX
	mov     temp3_4,$blockSizeY
...
;	ldrb	result_4,[clip255_4,+temp_4,ASR #5]		;stall
	add		src1_4,src6_4,src1_4
		usat	result_4, #8, temp_4, asr #5
	add		temp_4,src2_4,src5_4			
;	add		temp_4,src6_4,src1_4

	strb	result_4,[$dest,destStride_4]!
;	add		temp2_4,src2_4,src5_4
	add		temp2_4,temp_4,temp_4,lsl #2		;5*(-1+2)
	sub		temp_4,src1_4,temp2_4			;(-2+3) - 5*(-1+2)
	;smlatb	temp_4,temp3_4,temp2_4,temp_4			;(-2+3) - 5*(-1+2)	
...
;	add		temp_4,temp_4,#16		   				;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;	ldrb	result_4,[clip255_4,+temp_4,ASR #5]		;stall*/
	add		src2_4,src1_4,src2_4
		usat	result_4, #8, temp_4, asr #5	
	add		temp_4,src3_4,src6_4	
;	add		temp_4,src1_4,src2_4
	strb	result_4,[$dest,destStride_4]!
;	add		temp2_4,src3_4,src6_4
	add		temp2_4,temp_4,temp_4,lsl #2		;5*(-1+2)
	sub		temp_4,src2_4,temp2_4			;(-2+3) - 5*(-1+2)
...
;	add		temp_4,temp_4,#16		   							;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;	ldrb	result_4,[clip255_4,+temp_4,ASR #5]		;stall
	add		src3_4,src2_4,src3_4
		usat	result_4, #8, temp_4, asr #5
	add		temp_4,src4_4,src1_4			
;	add		temp_4,src2_4,src3_4
	strb	result_4,[$dest,destStride_4]!
;	add		temp2_4,src4_4,src1_4
	add		temp2_4,temp_4,temp_4,lsl #2		;5*(-1+2)
	sub		temp_4,src3_4,temp2_4			;(-2+3) - 5*(-1+2)
	;smlatb	temp_4,temp3_4,temp2_4,temp_4			;(-2+3) - 5*(-1+2) + 20*(0+1) 
...
;;;;;;out loop control
	...
	MACRO 
	GetDXP3_DYP3 $src,$srcStride,$dest,$destStride,$blockSizeX,$clip255,$blockSizeY
OutLoopCount_9			RN  8
InnerLoopCount_9		RN  8
src0_9				RN  7
src1_9				RN  8
src2_9				RN  2
src3_9				RN  3
...
;		ldrb	result_9,[clip255_9,+temp_9,ASR #5]		;stall
		add		src1_9,src6_9,src1_9
		usat	result_9, #8, temp_9, asr #5
		add		temp_9,src2_9,src5_9
;		add		temp_9,src6_9,src1_9
		strb	result_9,[$dest,destStride_9]!
;		add		temp2_9,src2_9,src5_9
		add		temp2_9,temp_9,temp_9,lsl #2		;5*(-1+2)
		sub		temp_9,src1_9,temp2_9			;(-2+3) - 5*(-1+2)
...
;		add		temp_9,temp_9,#16		   				;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;		ldrb	result_9,[clip255_9,+temp_9,ASR #5]		;stall*/
		add		src2_9,src1_9,src2_9
		usat	result_9, #8, temp_9, asr #5
		add		temp_9,src3_9,src6_9
;		add		temp_9,src1_9,src2_9
		strb	result_9,[$dest,destStride_9]!
;		add		temp2_9,src3_9,src6_9
		add		temp2_9,temp_9,temp_9,lsl #2		;5*(-1+2)
		sub		temp_9,src2_9,temp2_9			;(-2+3) - 5*(-1+2)
...
;		add		temp_9,temp_9,#16		   							;(-2+3) - 5*(-1+2) + 20*(0+1) + 16
;		ldrb	result_9,[clip255_9,+temp_9,ASR #5]		;stall
		add		src3_9,src2_9,src3_9
		usat	result_9, #8, temp_9, asr #5
		add		temp_9,src4_9,src1_9
;		add		temp_9,src2_9,src3_9
		strb	result_9,[$dest,destStride_9]!
;		add		temp2_9,src4_9,src1_9
		add		temp2_9,temp_9,temp_9,lsl #2		;5*(-1+2)
		sub		temp_9,src3_9,temp2_9			;(-2+3) - 5*(-1+2)
		;smlatb	temp_9,temp3_9,temp2_9,temp_9			;(-2+3) - 5*(-1+2) + 20*(0+1) 
...
;;;;;;out loop control
	...
	MACRO 
	GetDYP3_DXP3 $src,$srcStride,$dest,$destStride,$blockSizeX,$clip255,$blockSizeY
OutLoopCount_a		RN  11
InnerLoopCount_a	RN  11
src0_a				RN  7
src1_a				RN  8
src2_a				RN  2
src3_a				RN  3
...
;	ldr     OutLoopCount_a, [sp,#52]
	mov		temp3_a, $blockSizeY
	mov		InnerLoopCount_a, $blockSizeX
...
;	str    OutLoopCount_a ,[sp,#52]
	...
	MEND
	MACRO 
	GetDXP2_J $src,$srcStride,$dest,$blockSizeX,$blockSizeY
OutLoopCount_5		RN  14
InnerLoopCount_5	RN  11
src0_5				RN  7
src1_5				RN  8
src2_5				RN  2
src3_5				RN  3
...
;	add	temp_5, src0_5,src5_5
	...
	sub		result_5,temp_5,temp2_5			;(-2+3) - 5*(-1+2)
...
;	ldrb    src6_5, [$src, #4]
	...
	add		result_5,result_5,temp2_5,lsl #2		;(-2+3) - 5*(-1+2) + 20*(0+1) 				;
...
;	ldrb    src1_5, [$src, #5]
	...
	add		src2_5,src1_5,src2_5
	add		temp2_5,temp2_5,temp2_5,lsl #2		;5*(0+1)					;
	add		result_5,src3_5,src6_5
	add		temp_5,temp_5,temp2_5,lsl #2		;(-2+3) - 5*(-1+2) + 20*(0+1) 
	;smlabb  result_5,temp3_5,temp2_5,temp_5			;(-2+3) - 5*(-1+2) + 20*(0+1) 
	
;	add		temp_5,src1_5,src2_5
;	add		temp2_5,src3_5,src6_5
	str	temp_5,[$dest,#4]
	add		temp2_5,result_5,result_5,lsl #2		;5*(-1+2)
	sub		temp_5,src2_5,temp2_5			;(-2+3) - 5*(-1+2)
	;	smlatb	temp_5,temp3_5,temp2_5,temp_5			;(-2+3) - 5*(-1+2) + 20*(0+1) 
	ldrb    src2_5, [$src, #6]
;	str	temp_5,[$dest,#4]
	add		temp2_5, src4_5,src5_5
	add	src3_5,src2_5,src3_5
	add		temp2_5,temp2_5,temp2_5,lsl #2		;5*(0+1)					;
	add	src2_5,src4_5,src1_5
...
;	add	temp2_5,src4_5,src1_5
	add		temp2_5,src2_5,src2_5,lsl #2		;5*(-1+2)
	sub		temp_5,src3_5,temp2_5			;(-2+3) - 5*(-1+2)
	;smlatb	temp_5,temp3_5,temp2_5,temp_5			;(-2+3) - 5*(-1+2) + 20*(0+1) 
	str	result_5,[$dest,#8]
...
;///////////////////////////////////////////////
	MACRO 
	GetDXP2_DYP $src,$dest,$destStride,$blockSizeX,$dyp,$clip255,$blockSizeY
OutLoopCount_6			RN  8
InnerLoopCount_6		RN  8
src0_6				RN  7
src1_6				RN  8
src2_6				RN  2
src3_6				RN  3
...
;	sub     	$src, $src,  #srcStride_t4
 ...
 ;;;;;;out loop control
	...
	MEND
	MACRO 
	GetDYP2_J $src,$srcStride,$dest,$blockSizeX,$blockSizeY
OutLoopCount_7			RN  14
InnerLoopCount_7		RN  11
src0_7				RN  7
src1_7				RN  8
src2_7				RN  2
src3_7				RN  3
...
destStride_7		RN  11
	LCLA	destStride_t
destStride_t	seta	96
	
	mov     temp3_7,$blockSizeY
	add     OutLoopCount_7, $blockSizeX,#5
	str     OutLoopCount_7 ,[sp,#48]	;OutLoopCount_7
...
DYP2_J_INNER
	...
	add		OutLoopCount_7,src2_7,src5_7
...
;	add		temp2_7,src2_7,src5_7
	...
	add		temp2_7,OutLoopCount_7,OutLoopCount_7,lsl #2		;5*(-1+2)
	sub		temp_7,temp_7,temp2_7			;(-2+3) - 5*(-1+2)
	;smlatb	temp_7,temp3_7,temp2_7,temp_7			;(-2+3) - 5*(-1+2)	
	add		temp2_7, src3_7,src4_7
	add		OutLoopCount_7,src3_7,src6_7
	add		temp2_7,temp2_7,temp2_7,lsl #2		;5*(0+1)					;
	ldrb	src1_7,[$src,srcStride_7]!
	add		temp_7,temp_7,temp2_7,lsl #2		;(-2+3) - 5*(-1+2) + 20*(0+1) 	
	;smlabb	temp_7,temp3_7,temp2_7,temp_7			;(-2+3) - 5*(-1+2) + 20*(0+1) 
...
;	add		temp2_7,src3_7,src6_7
	...
	add		OutLoopCount_7,src4_7,src1_7
	add		temp2_7,temp2_7,temp2_7,lsl #2		;5*(0+1)					;
...
;;;;;;out loop control
	ldr     OutLoopCount_7 ,[sp,#48]	;OutLoopCount_7	
	ldr     	$src,  [sp,#36]
	ldr     	$dest, [sp,#40]
	...
	MEND
	MACRO 
	GetDYP2_DXP $src,$dest,$destStride,$blockSizeX,$dxp,$clip255,$blockSizeY
OutLoopCount_8		RN  10
InnerLoopCount_8	RN  11
src0_8				RN  7
src1_8				RN  8
src2_8				RN  2
src3_8				RN  3
...
m7_offset 	  SETA        108
blockSizeX_offset SETA 	      112      
blockSizeY_offset SETA		  116
srcwidth_offset	  SETA		  120
clip255_offset	  SETA		  124
