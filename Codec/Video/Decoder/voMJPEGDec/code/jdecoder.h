...
extern VO_U32 VO_API Initpicture(Jpeg_DecOBJ * decoder);
extern VO_U32 VO_API UpdateParameter(Jpeg_DecOBJ * decoder, VO_VIDEO_BUFFER *pOutData, VO_VIDEO_OUTPUTINFO *pOutFormat);
#else
