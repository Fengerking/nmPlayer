...
// added by RainAde for composer interface
		pCTX->enc_sps_size = mfc_args.enc_exe.out_sps_size;
		pCTX->enc_pps_size = mfc_args.enc_exe.out_pps_size;
		
		LOGV("HEADER SIZE = %d\n", pCTX->enc_hdr_size);
		LOGV("enc_sps_size  = %d\n", pCTX->enc_sps_size);
		LOGV("enc_pps_size  = %d\n", pCTX->enc_pps_size);
		
		LOGV("mfc_args.enc_exe.out_sps_size  = %d\n", mfc_args.enc_exe.out_sps_size);
		LOGV("mfc_args.enc_exe.out_pps_size  = %d\n", mfc_args.enc_exe.out_pps_size);
