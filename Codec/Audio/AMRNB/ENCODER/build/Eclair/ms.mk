...
ifeq ($(VOTT), v7)
OBJS+= autocorr_neon.o comp_corr.o convolve_opt.o cor_h_asmv6.o syn_filt0_neon.o cor_h_x_v6.o amrnb_vq_subvec_neon.o \
       G_pitch_asm.o Norm_Corr_opt.o Pred_lt_3or6_v6.o  residu_opt.o sum_armv7_xx.o syn_filt0_neon.o \
