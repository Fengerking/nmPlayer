/*___________________________________________________________________________
 ...
 |                                                                           |
 |  voAMRWBPDecIsqrt()              : inverse square root (16 bits precision).          |
 |  voAMRWBPDecPow2()               : 2^x  (16 bits precision).                         |
 ...
 |  precision is not necessary. For example, the function voAMRWBPDecDiv_32() has a     |
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : voAMRWBPDecIsqrt                                                   |
 |                                                                           |
 |       Compute 1/sqrt(L_x).                                                |
 ...
 |   2- call voAMRWBPDecIsqrt_n(L_x, exponant)                                          |
 |   3- L_y = L_x << exponant                                                |
 |___________________________________________________________________________|
*/
Word32 voAMRWBPDecIsqrt(                              /* (o) Q31 : output value (range: 0<=val<1)         */
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : voAMRWBPDecIsqrt_n                                                 |
 |                                                                           |
...
/*___________________________________________________________________________
 ...
 |  Algorithm:                                                               |
 |                                                                           |
 |   The function voAMRWBPDecPow2(L_x) is approximated by a table and linear            |
 |   interpolation.                                                          |
 |                                                                           |
...
Word32 voAMRWBPDecPow2(                               /* (o) Q0  : result       (range: 0<=val<=0x7fffffff) */
...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : voAMRWBPDecDot_product12()                                         |
 |                                                                           |
...
Word32 voAMRWBPDecDot_product12(                      /* (o) Q31: normalized result (1 < val <= -1) */
