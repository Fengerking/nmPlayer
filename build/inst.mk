...
VOPREDEF:=-DLINUX -D_LINUX -DNNJ -D__VOPRJ_INST__
VONJ ?= linux
VOTT ?= v4
...
CCTINC:=-I$(TCROOTPATH)/include -I$(TCROOTPATH)/build/include -I$(TCROOTPATH)/build/include/SDL 
CCTDEPOBJSPATH:=
...
CCTLIBDEEP:=$(CCTLIB)/gcc/arm-none-linux-gnueabi/4.1.1
...
# global link options
VOLDFLAGS:=-Wl,-x -Wl,-X -Wl,--no-define-common -Wl,--as-needed #-Wl,-M 
