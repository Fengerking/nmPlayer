	...
	************************************************************************/
/*******************************************************************************
	File:		voOMXCoreQcomVdec.cpp

	Contains:	API implement file
...
#define LOG_TAG "voOMXCoreQcomVdec"
#include "voLog.h"

OMX_PTR	g_hInst = NULL;
voCOMXCoreQcomVdec* g_pCore = NULL;

#define CHECK_CORE	if(g_pCore == NULL)\
...
OMX_API OMX_ERRORTYPE OMX_APIENTRY OMX_Init()
{
	...
	g_pCore = new voCOMXCoreQcomVdec();
	if(g_pCore == NULL)
												   ...
												   OMX_IN  OMX_U32 nPortInput)
{
	...
	if(hOutput != NULL)
	{
		pComponent = (OMX_COMPONENTTYPE*)hOutput;
