	...
	.globl	_ccClip255	
	.globl	_cc_yuv420_to_rgb32_mb_s_l90_arm

_cc_yuv420_to_rgb32_mb_s_l90_arm: @PROC
...
RGB32_LIT_WHILE_L:								
		...
		mov	r9, r9, lsl #16
		orr	r9, r9, r10, lsl #8
		orr	r1, r9, r11				@a4 = ((ccClip255[(a4 + a0)>>20])<<11)|((ccClip255[(a4 - a1)>>20])<<5)|(ccClip255[(a4 + a2)>>20])@
