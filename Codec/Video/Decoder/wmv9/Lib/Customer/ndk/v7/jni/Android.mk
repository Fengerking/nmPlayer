...
LOCAL_SRC_FILES := \
	...
	$(CSRC_GNU_PATH)/affine_arm.S \
	$(CSRC_GNU_PATH)/effects_arm.S \
	$(CSRC_GNU_PATH)/idct_arm.S \
	$(CSRC_GNU_PATH)/interpolate_arm.S \
	$(CSRC_GNU_PATH)/loopfilter_arm.S \
	$(CSRC_GNU_PATH)/motioncomp_arm3.S \
	$(CSRC_GNU_PATH)/multires_arm.S \
	$(CSRC_GNU_PATH)/spatialpredictor_arm.S \
	$(CSRC_GNU_PATH)/blkdec_arm.S \
	$(CSRC_GNU_PATH)/filter.S \
	$(CSRC_GNU_PATH)/idct_wmv9_arm_2.S \
	$(CSRC_GNU_PATH)/interpolate_wmv9_arm_2.S \
	$(CSRC_GNU_PATH)/macros_arm.S \
	$(CSRC_GNU_PATH)/motioncomp_arm4.S \
	$(CSRC_GNU_PATH)/postfilter_arm.S \
	$(CSRC_GNU_PATH)/vopdec_arm2.S \
	$(CSRC_GNU_PATH)/dynamic_edgepad_arm.S \
	$(CSRC_GNU_PATH)/huffman_arm.S \
	$(CSRC_GNU_PATH)/idct_wmv9_arm.S \
	$(CSRC_GNU_PATH)/interpolate_wmv9_arm.S \
	$(CSRC_GNU_PATH)/motioncomp_arm2.S \
	...
	$(CSRC_GNU_PATH)/idct_wmv9_arm_2_ARMv7.S \
	$(CSRC_GNU_PATH)/idct_wmv9_arm_ARMv7.S \
	$(CSRC_GNU_PATH)/interpolate_wmv9_arm_2_ARMv7.S \
	$(CSRC_GNU_PATH)/interpolate_wmv9_arm_ARMv7.S \
	$(CSRC_GNU_PATH)/loopfilter_arm_ARMv7.S \
	$(CSRC_GNU_PATH)/motioncomp_arm_ARMv7.S 
...
VOMM:= -DVOARMV7 -DHAVE_NEON=1 -DARM -D_ARM_ -D__arm -DLINUX -D_LINUX_ANDROID -D_VOLOG_INFO -D_VOLOG_ERROR -D__VO_NDK__ -DNDEBUG

LOCAL_CFLAGS := -D_VOMODULEID=0x02060000  -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp
