...
*/
#ifndef __EXC_LBC_H__
#define __EXC_LBC_H__
...
void  Fcbk_Unpk( Word16 *Tv, SFSDEF Sfs, Word16 Olp, Word16 Sfc, G723DncState *st);
void  Find_Acbk( Word16 *Tv, Word16 *ImpResp, Word16 *PrevExc, LINEDEF
*Line, Word16 Sfc );
void  Get_Rez( Word16 *Tv, Word16 *PrevExc, Word16 Lag );
void  Decod_Acbk( Word16 *Tv, Word16 *PrevExc, Word16 Olp, Word16 Lid, Word16 Gid, G723DncState *st);
...
PFDEF Comp_Lpf( Word16 *Buff, Word16 Olp, Word16 Sfc, G723DncState *st);
Word16   Find_B( Word16 *Buff, Word16 Olp, Word16 Sfc );
Word16   Find_F( Word16 *Buff, Word16 Olp, Word16 Sfc );
PFDEF Get_Ind( Word16 Ind, Word16 Ten, Word16 Ccr, Word16 Enr, G723DncState *st);
