...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    .globl  _g_FilterHorizontalEdgeV9_ARMV4
    .globl  _g_FilterVerticalEdgeV9_ARMV4
    .globl  _s_iNextPixel
			

	.globl  _g_OverlapBlockVerticalEdge_ARMV4
	.globl  _g_OverlapBlockHorizontalEdge_ARMV4
...
@iNumPixel==r3
  ...
  FRAME_PROFILE_COUNT
  adr   r4,  NextPixelTab         @ r4 address of s_iNextPixel
...
gFVEloopDoneV9:
  ...
  .endif @ WMV_OPT_LOOPFILTER_ARM
    ...
    .globl _end_loopfilter_ARMV4
_end_loopfilter_ARMV4:
