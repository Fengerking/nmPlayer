...
#ifndef __CADecoder_H__
#define __CADecoder_H__

#include "voAudio.h"
#include "CBaseNode.h"
#include "voNPWrap.h"

class CADecoder : public CBaseNode
{
public:
	CADecoder (VO_PTR hInst, VO_U32 nCoding, VO_MEM_OPERATOR * pMemOP);
	virtual ~CADecoder (void);
	...
	virtual VO_U32		GetOutputData (VO_CODECBUFFER * pOutput, VO_AUDIO_FORMAT * pAudioFormat, VO_BOOL& bFormatChanged);
