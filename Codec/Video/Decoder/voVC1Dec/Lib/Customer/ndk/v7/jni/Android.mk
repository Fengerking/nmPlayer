...
LOCAL_SRC_FILES := \
  ...
  $(CSRC_GNU_PATH)/voVC1Interpolate_ARMV7.S\
  $(CSRC_GNU_PATH)/voVC1InterpolateOnly_ARMv7.S\
  $(CSRC_GNU_PATH)/voVC1Trans_ARMV7.S\
  $(CSRC_GNU_PATH)/voVC1Trans_Overlap_ARMV7.S
...
VOMM:= -DVOARMV7 -DHAVE_NEON=1 -DARM -D_ARM_ -D__arm -DLINUX -D_LINUX_ANDROID -D_VOLOG_INFO -D_VOLOG_ERROR -D__VO_NDK__ -DVOANDROID -DMULTI_CORE_DEC -DADJ_NEW -DUSE_FRAME_THREAD -DNDEBUG

LOCAL_CFLAGS := -D_VOMODULEID=0x020c0000  -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp
