...
{
public:
	vo_buffer():m_ptr_buffer_callback(0),m_filesize(0),m_is_initmode(VO_FALSE), m_is_closed(VO_FALSE){}
	virtual ~vo_buffer(){}
	...
	virtual VO_S64 read( VO_S64 physical_pos , VO_PBYTE buffer , VO_S64 toread , VO_BOOL issync = VO_TRUE ) = 0;
	...
	virtual VO_VOID get_buffering_start_info( BUFFER_INFO * ptr_info ) = 0;
