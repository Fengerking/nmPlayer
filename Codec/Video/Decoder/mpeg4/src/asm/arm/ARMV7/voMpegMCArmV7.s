...
;***********************************************************************/
	...
	EXPORT MPEG4DEC_VO_Armv7Copy8x8 
MPEG4DEC_VO_Armv7Copy8x8  PROC
	VLD1.64  {d0},[r0],r2  
	VLD1.64  {d1},[r0],r2  
	VLD1.64  {d2},[r0],r2  
	VLD1.64  {d3},[r0],r2  
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Copy16x16 
MPEG4DEC_VO_Armv7Copy16x16  PROC
;	ldr		r12, [sp]
	mov		r12, #16
...
;ArmInter8x8
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8 
MPEG4DEC_VO_Armv7Inter8x8  PROC
	ldr		r12, [sp]
;	mov		r12, #8
...
;ArmInter2_8x8 
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter2_8x8 
MPEG4DEC_VO_Armv7Inter2_8x8  PROC
    PUSH     {lr}
	ldr		r12, [sp, #4]
;	mov		r12, #8
...
; ArmInter8x8H
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8H 
MPEG4DEC_VO_Armv7Inter8x8H  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
;	mov		Count, #8
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8HRD 
MPEG4DEC_VO_Armv7Inter8x8HRD  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
;	mov		Count, #8
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8V 
MPEG4DEC_VO_Armv7Inter8x8V  PROC
	ldr		Count, [sp]
;	mov		Count, #8		
	VLD1.8 {D0}, [Src], Src_W
	VLD1.8 {D1}, [Src], Src_W
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8VRD 
MPEG4DEC_VO_Armv7Inter8x8VRD  PROC
	ldr		Count, [sp]
;	mov		Count, #8		
	VLD1.8 {D0}, [Src], Src_W
	VLD1.8 {D1}, [Src], Src_W
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8HV 
MPEG4DEC_VO_Armv7Inter8x8HV  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
;	mov		Count, #8
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter8x8HVRD 
MPEG4DEC_VO_Armv7Inter8x8HVRD  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
;	mov		Count, #8
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter2_8x8H 
MPEG4DEC_VO_Armv7Inter2_8x8H  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
;	mov		Count, #8
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter2_8x8V 
MPEG4DEC_VO_Armv7Inter2_8x8V  PROC
	ldr		Count, [sp]
;	mov		Count, #8
	VMOV.U8 D13, #1		
	VLD1.8 {D0}, [Src], Src_W	
...
;------------------------------------------
	EXPORT MPEG4DEC_VO_Armv7Inter2_8x8HV 
MPEG4DEC_VO_Armv7Inter2_8x8HV  PROC
	PUSH   {r14}
	ADD		R14, Src, #8	
	ldr		Count, [sp, #4]
	VLD1.8 {D0}, [Src], Src_W
