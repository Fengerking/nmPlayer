...
public:
	...
	const track_info * get_vorbis_track_info();
...
private:
	...
	VO_BOOL add_track_info( VO_U32 serial_number , const OggPageHead * ptr_ogg_head , const VO_PBYTE ptr_segments );
...
public:
	...
	VO_BOOL seek_to( VO_U64 file_pos );
