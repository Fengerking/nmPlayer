...
********************************************************************************
*/
int voAMRNBEnc_vad1_init (vadState1 **st, VO_MEM_OPERATOR *pMemOP);
...
int voAMRNBEnc_vad1_reset (vadState1 *st);
/* reset of pre processing state (i.e. set state memory to zero)
   returns 0 on success
 */

void voAMRNBEnc_vad1_exit (vadState1 **st, VO_MEM_OPERATOR *pMemOP);
