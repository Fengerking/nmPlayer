...
;
;	GenCodeCpy ArmInter8x8,ArmInter8x8,0,0,1,0
;	GenCodeCpy ArmInter8x8V,ArmInter8x8V,0,0,0,0
;	GenCodeCpy ArmInter8x8H,ArmInter8x8H,0,0,0,0
;	GenCodeCpy ArmInter8x8HV,ArmInter8x8HV,0,0,0,0
;	GenCodeCpy ArmInter8x8VRD,ArmInter8x8V,1,0,0,0
;	GenCodeCpy ArmInter8x8HRD,ArmInter8x8H,1,0,0,0
;	GenCodeCpy ArmInter8x8HVRD,ArmInter8x8HV,1,0,0,0
;
;	GenCodeCpy ArmInter2_8x8 ,ArmInter2_8x8 ,0,1,0,0
;	GenCodeCpy ArmInter2_8x8V,ArmInter8x8V,0,1,0,0
;	GenCodeCpy ArmInter2_8x8H,ArmInter8x8H,0,1,0,0
;	GenCodeCpy ArmInter2_8x8HV,ArmInter8x8HV,0,1,0,0
;
;---------------------------------------------------
; smaller versions with PldA
;
;	GenCodeCpy PldAarm_copyblk,ArmInter8x8,0,0,1,1
;	GenCodeCpy PldAarm_copyblkv,ArmInter8x8V,0,0,0,1
;	GenCodeCpy PldAarm_copyblkh,ArmInter8x8H,0,0,0,1
;	GenCodeCpy PldAarm_copyblkhv,ArmInter8x8HV,0,0,0,1
;	GenCodeCpy PldAarm_copyblkvrd,ArmInter8x8V,1,0,0,1
;	GenCodeCpy PldAarm_copyblkhrd,ArmInter8x8H,1,0,0,1
;	GenCodeCpy PldAarm_copyblkhvrd,ArmInter8x8HV,1,0,0,1
;
;	GenCodeCpy PldAarm_addblk,ArmInter2_8x8 ,0,1,0,1
;	GenCodeCpy PldAarm_addblkv,ArmInter8x8V,0,1,0,1
;	GenCodeCpy PldAarm_addblkh,ArmInter8x8H,0,1,0,1
;	GenCodeCpy PldAarm_addblkhv,ArmInter8x8HV,0,1,0,1
;
;---------------------------------------------------
...
;   GenCodeCpy		$Name,			$Sub,		$Round,	$Add,	$Fast,	$ARM5,	$ARMv6,	$ARM11
;
;	GenCodeCpy ArmCopy8x8,ArmCopy8x8,0,0,0,1,0
;	GenCodeCpy ArmCopy16x16,ArmCopy16x16,0,0,0,1,0
;
;	GenCodeCpy ArmInter8x8,		ArmInter8x8,	0,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8V,	ArmInter8x8V,	0,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8H,	ArmInter8x8H,	0,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8HV,	ArmInter8x8HV,	0,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8VRD,	ArmInter8x8V,	1,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8HRD,	ArmInter8x8H,	1,	0,	1,	1,	1,	0
;	GenCodeCpy ArmInter8x8HVRD,	ArmInter8x8HV,	1,	0,	1,	1,	1,	0
;                                                                  	  	  	  	
;	GenCodeCpy ArmInter2_8x8 ,		ArmInter2_8x8 ,	0,	1,	1,	1,	1,	0
;	GenCodeCpy ArmInter2_8x8V,		ArmInter8x8V,	0,	1,	1,	1,	1,	0
;	GenCodeCpy ArmInter2_8x8H,		ArmInter8x8H,	0,	1,	1,	1,	1,	0
;	GenCodeCpy ArmInter2_8x8HV,	ArmInter8x8HV,	0,	1,	1,	1,	1,	0
;---------------------------------------------------------------------------------------------------------	

	GenCodeCpy __voMPEG2D0061,ArmCopy8x8,		0,	0,	0,	0,	0,	0
	GenCodeCpy __voMPEG2D0060,ArmCopy16x16,		0,	0,	0,	0,	0,	0

	GenCodeCpy __voMPEG2D0049,	ArmInter8x8,	0,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0051,	ArmInter8x8V,	0,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0050,	ArmInter8x8H,	0,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0052,	ArmInter8x8HV,	0,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0054,	ArmInter8x8V,	1,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0053,	ArmInter8x8H,	1,	0,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0055,	ArmInter8x8HV,	1,	0,	1,	1,	0,	0
                                                                  	  	  	  	
	GenCodeCpy __voMPEG2D0056,	ArmInter2_8x8 ,	0,	1,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0058,	ArmInter8x8V,	0,	1,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0057,	ArmInter8x8H,	0,	1,	1,	1,	0,	0
	GenCodeCpy __voMPEG2D0059,	ArmInter8x8HV,	0,	1,	1,	1,	0,	0
