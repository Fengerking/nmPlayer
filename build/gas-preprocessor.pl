...
while (<ASMFILE>) {
    ...
    s/\bADD\b/add/x;
    s/\bPKHBT\b/pkhbt/x;
    s/\bSMULBB\b/smulbb/x;
    s/\bSMLABB\b/smlabb/x;
    s/\bSTRB\b/strb/x;
    s/\bUSAT\b/usat/x;
    s/\bPKHTB\b/pkhtb/x;
    s/\bSMLAD\b/smlad/x;
    ...
    s/\bLDRSH\b/ldrsh/x;
    s/\bSMUAD\b/smuad/x;
    s/\bSMUSDX\b/smusdx/x;
    s/\bMUL\b/mul/x;
    s/\bALIGN\b/align/x;
    s/\bSMUSD\b/smusd/x;
    s/\bLDMIA\b/ldmia/x;
    s/\bUXTB16\b/uxtb16/x;
    s/\bSTMIA\b/stmia/x;
    s/\bSSUB16\b/ssub16/x;
    s/\bSXTH\b/sxth/x;
    s/\bADDS\b/adds/x;
    s/\bRSBMI\b/rsbmi/x;
    s/\bSSUB16\b/ssub16/x;
    ...
    s/\bSUBEQ\b/subeq/x;
    s/\bMLA\b/mla/x;
    s/\bUHADD8\b/uhadd8/x;
    s/\bUHADD16\b/uhadd16/x;
