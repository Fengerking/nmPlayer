...
**************************************************************************
*/ 
int voAMRNBEnc_cod_amr_init (cod_amrState **st, Flag dtx, VO_MEM_OPERATOR *pMemOP);
...
**************************************************************************
*/
void voAMRNBEnc_cod_amr_exit (cod_amrState **st, VO_MEM_OPERATOR *pMemOP);
...
int voAMRNBEnc_cod_amr(cod_amrState *st,         /* i/o : State struct                 */
