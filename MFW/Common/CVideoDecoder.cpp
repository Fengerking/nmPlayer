...
VO_U32 CVideoDecoder::GetOutputData (VO_VIDEO_BUFFER * pOutput, VO_VIDEO_FORMAT * pVideoFormat, VO_BOOL * pbContinuous)
{
	...
	{
		// Per decision, we will cut 1 pixel if the width/height is not 2 pixel alignment, East 20131102
		pVideoFormat->Width = m_OutputInfo.Format.Width & ~1;
		pVideoFormat->Height = m_OutputInfo.Format.Height & ~1;
