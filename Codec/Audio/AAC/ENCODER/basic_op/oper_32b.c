...
//  shift2 = norm_l(y);
//  tmp = Div_32(0x40000000, (y << shift2));
//  tmp2 = L_negate(x);
//  shift = norm_l(tmp2);
//  iPart = round16(fixmul((tmp2 << shift),tmp));
//  iPart = L_shr(iPart, (shift + 14 - shift2)); /* integer part of -x / y */ /* 14 = 30 - 16 because of round() */
//  shift = norm_l(iPart);
//  fPart = tmp2 - L_shr(MULHIGH((iPart << shift), (y << shift2)), (shift + shift2 - 32)); /* fractional part of -x / y */
//  iPart = min(iPart,INT_BITS-1);
//
