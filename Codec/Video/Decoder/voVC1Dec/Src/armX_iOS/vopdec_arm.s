...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    .globl  _Pack32To16_ARMV4
    .globl  _ResetCoefACPred1_ARMV4
    .globl  _ResetCoefACPred2_ARMV4
    .globl  _ResetCoefBuffer8x8_ARMV4
    .globl  _ResetCoefBuffer8x4_ARMV4
    .globl  _ResetCoefBuffer4x8_ARMV4
    .globl  _ResetCoefBuffer4x4_ARMV4

@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

    @AREA    |.embsec_PMainLoopLvl1|, CODE
	WMV_LEAF_ENTRY ResetCoefACPred1_ARMV4
@   r0:     piQuanCoefACPred
@   r1:     pRef
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    @AREA    |.embsec_PMainLoopLvl1|, CODE
	WMV_LEAF_ENTRY ResetCoefACPred2_ARMV4
@   r0:     piQuanCoefACPred
@   r1:     pRef
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
