...
@***********************************************************************/
	...
	.globl	  _cc_rgb32_mb_all_arm
	.globl		_ccClip255

  .macro  cc_mb_rgb32_16x16_arm_num_count
	...
	orr  r9, r8, r9,  lsl #8
	str	 r10, [r4, #($0*8 )]			@*((VO_S32*)(out_buf+(4*num))) = (VO_S32)a4@
	add  r8,  r4, #4                    @out_buf += 4
	str  r9,  [r8, #($0*8 )]		    @*((VO_S32*)(out_buf+(4*num) + 4)) = (VO_S32)a5@
    ...
    str	 r10, [r8, #($0*8)]			@*((VO_S32*)(out_buf+(out_stride+4*num))) = (VO_S32)a4@
    add  r10, r8, #4                    @out_buf += 4
    str  r9,  [r10,#($0*8)]           @*((VO_S32*)(out_buf+(out_stride+4*num))) = (VO_S32)a5@
  .endm  	
						
	
_cc_rgb32_mb_all_arm: @PROC
	...
	str	r12, [sp, #4]	
RGB32_BIG_WHILE_dis:
	cc_mb_rgb32_16x16_arm_num_count 0
	cc_mb_rgb32_16x16_arm_num_count 1
	cc_mb_rgb32_16x16_arm_num_count 2
	cc_mb_rgb32_16x16_arm_num_count 3
	cc_mb_rgb32_16x16_arm_num_count 4
	cc_mb_rgb32_16x16_arm_num_count 5
	cc_mb_rgb32_16x16_arm_num_count 6
	cc_mb_rgb32_16x16_arm_num_count 7
