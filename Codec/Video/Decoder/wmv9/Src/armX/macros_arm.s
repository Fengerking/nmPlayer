...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    EXPORT g_supportStrongARM
    EXPORT g_supportXScale
    EXPORT g_supportARMv5
    EXPORT g_supportWMMX
...
;;define MACROs
    ...
    MACRO
    Copy2AlignedWords   $dr,$sr,$di,$si,$b1,$b0
    ...
    MACRO
    Cpy2Words $dr, $sr, $di, $si, $b2, $b1, $b0, $ls, $rs
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    EXPORT memclr256_arm
    EXPORT memclr128_arm
    EXPORT memcpyOddEven_arm
...
;
    EXPORT prvWMMemCpy16DestAligned
...
;   callable from within ARM assembly code (saves and restores all registers
    EXPORT  |WMVFunctionCountFrameProfileArm|
