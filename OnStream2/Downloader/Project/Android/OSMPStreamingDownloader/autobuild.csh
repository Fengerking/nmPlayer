...
set curDir = `pwd`
set jarName = "voOSStreamingDownloader.jar"
set workDir = $curDir
set doClearup = 1
set comvisualon = "com/visualon"
set classPara = "./$comvisualon/VOOSMPStreamingDownloader/*.class ./$comvisualon/VOOSMPStreamingDownloaderImpl/*.class"
set javaPara = "$curDir/src/$comvisualon/VOOSMPStreamingDownloader/*.java $curDir/src/$comvisualon/VOOSMPStreamingDownloaderImpl/*.java"
...
javac -encoding UTF-8 -target 1.6 -bootclasspath $sdkPath/platforms/$target/android.jar  \
	-classpath ${JarOutDir}/voOSPlayer.jar:${JarOutDir}/voOSUtils.jar:${JarOutDir}/voOSDataSource.jar:${JarOutDir}/voOSEngine.jar:${JarOutDir}/voOSHDMICheck.jar:${JarOutDir}/voOSBasePlayer.jar \
