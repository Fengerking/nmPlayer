...
#else
__inline long long Profiler_getTimer(long long *time64)
{
    long long time;
...
extern long long Profiler_functionTimings[MAX_FUNCTIONS_TO_PROFILE];
extern long long Profiler_functionPlusChildTimings[MAX_FUNCTIONS_TO_PROFILE];
extern long long Profiler_totalTime;
extern long long profileStartTime;
