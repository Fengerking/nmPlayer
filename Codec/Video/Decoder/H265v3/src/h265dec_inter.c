...
static const VO_S16 g_lumaFilter[4][NTAPS_LUMA] =
{
  {  0, 0,   0, 64,  0,   0, 0,  0 },
  { -1, 4, -10, 58, 17,  -5, 1,  0 },
  { -1, 4, -11, 40, 40, -11, 4, -1 },
...
static const VO_S16 g_chromaFilter[8][NTAPS_CHROMA] =
{
  {  0, 64,  0,  0 },
  { -2, 58, 10, -2 },
  { -4, 54, 16, -2 },
...
static void FilterLumaHor8to8(VO_U8* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
...
static void FilterChromaHor8to8(VO_U8* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 shift = IF_FILTER_PREC;
  VO_S32 offset = 1 << (shift - 1);
...
static void FilterLumaHor8to16(VO_U8* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
...
static void FilterChromaHor8to16(VO_U8* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 head_room = IF_INTERNAL_PREC - g_bitDepth;
  VO_S32 shift = IF_FILTER_PREC - head_room;
...
// MODE: 1 src(8-bit) --> dst(8-bit)
static void FilterLumaVer8to8(VO_U8* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 shift = IF_FILTER_PREC;
  VO_S32 offset = 1 << (shift - 1);
...
static void FilterChromaVer8to8(VO_U8* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 shift = IF_FILTER_PREC;
  VO_S32 offset = 1 << (shift - 1);
...
static void FilterLumaVer8to16(VO_U8* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 head_room = IF_INTERNAL_PREC - g_bitDepth;
...
static void FilterChromaVer8to16(VO_U8* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 head_room = IF_INTERNAL_PREC - g_bitDepth;
...
static void FilterLumaVer16to8(VO_S16* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 head_room = IF_INTERNAL_PREC - g_bitDepth;
...
static void FilterChromaVer16to8(VO_S16* src, VO_S32 srcStride, VO_U8* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 head_room = IF_INTERNAL_PREC - g_bitDepth;
...
static void FilterLumaVer16to16(VO_S16* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 shift = IF_FILTER_PREC;
...
static void FilterChromaVer16to16(VO_S16* src, VO_S32 srcStride, VO_S16* dst, VO_S32 dstStride, VO_S32 width, VO_S32 height, const VO_S16* coeff)
{
  VO_S32 row, col;
  VO_S32 sum_val;
  VO_S32 shift = IF_FILTER_PREC;
...
static void FilterLumaHorWeightedBi(
  ...
  VO_U8* dst, VO_S32 dstStride,
  VO_S32 width, VO_S32 height,
  const VO_S16* coeff, /* coeff belongs to ref1 */
  const WP_SCALING_PARAM* wp0, 
  const WP_SCALING_PARAM* wp1
  )
{
...
static void FilterLumaCompleteVerWeightedBi(
  ...
  VO_U8* dst, VO_S32 dstStride,
  VO_S32 width, VO_S32 height,
  const VO_S16* coeff, /* coeff belongs to ref1 yFrac */
  const WP_SCALING_PARAM* wp0, 
  const WP_SCALING_PARAM* wp1
  )
{
