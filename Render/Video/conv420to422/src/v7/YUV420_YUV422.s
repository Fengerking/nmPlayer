	...
	.section .text
	.global	YUV420_YUYV422_32
	.global	YUV420_UYVY422_32	
	.global	YUV420_YUYV422_16
	.global	YUV420_UYVY422_16
...
YUYV422_Height_loop:
	...
	mov	r4, r0			@Des
	mov	r6, r1			@Ybuf	
	add	r5, r0, r7, lsl #1	@Des1 = Dst + 2*OutStride@
...
YUYV422_Width_loop:
	...
	add	r0, r0, r7, lsl #2	@Dst += OutStride * 4
