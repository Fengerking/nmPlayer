...
public:
	list_T()
		: _Size(0)
	{
		_P_allocator = new _Allocator;TRACE_NEW("_List_node_T::_P_allocator ",_P_allocator);//&firstAllocator;//
		_P_head = new _List_node_T(this, NULL, _Type());TRACE_NEW("_List_node_T::_P_head ",_P_head);//&firstNode;//
...
public:
	...
	{
		_List_node_T * newNode=new _List_node_T();TRACE_NEW("_List_node_T::newNode ",newNode);
		return newNode;
	}
...
protected:
	bool preallocate()
	{
		do
		{
			...
			_List_node_T ** _P_new_buffer = new _List_node_T * [_New_buffer_size];TRACE_NEW("_List_node_T::_P_new_buffer ",_P_new_buffer);
			...
			{
				_P_new_buffer[i] = new _List_node_T();TRACE_NEW("_List_node_T::_P_new_buffer[i] ",_P_new_buffer[i]);
