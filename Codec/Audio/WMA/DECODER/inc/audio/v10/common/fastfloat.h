...
__inline static void Norm4FastFloat( FastFloat* pfflt )
    {   // use the faster Norm4FastFloatU when you know the value is positive
        register UInt uiF = abs((int)pfflt->iFraction);
        register Int iFB = 0;
...
__inline static void Norm4FastFloatU( FastFloat* pfflt )
...
__inline static FastFloat ffltMultiply( FastFloat ffltA, FastFloat ffltB )
{
    FastFloat ffltP;
...
__inline static I32 I32FromFFLT(FastFloat fflt, Int bits)
{
...
__inline static FastFloat FFLTFromI32(Int i32, Int bits)
{
    FastFloat ffltP;
    ffltP.iFraction = i32;
...
__inline static FastFloat ffltNegate(FastFloat fflt)
{
    fflt.iFraction = -fflt.iFraction;
    return fflt;
}

__inline static FastFloat ffltAbs(FastFloat fflt)
{
...
__inline static FastFloat ffltSqrt(FastFloat fflt)
{
...
__inline static FastFloat ffltfltMultiply( FastFloat ffltA, Int B , Int bits)
{
...
__inline static FastFloat ffltAdd( FastFloat ffltA, FastFloat ffltB )
{
    FastFloat ffltP;
    Int iShift;
...
__inline static FastFloat ffltSub( FastFloat ffltA, FastFloat ffltB )
{
    FastFloat ffltP;
    Int iShift;
...
__inline static FastFloat ffltDivide( FastFloat ffltA, const FastFloat ffltB )
{
...
__inline static FastFloat ffltfltDivide( FastFloat ffltA, const Int B, const Int bits )
{
    assert( 0 != B );
...
__inline static FastFloat FastFloatFromFloat(Float flt) 
{
        FastFloat fflt;
    ...
    // floor of log2(flt)
__inline static Int Log2FromFloat(Float flt) {
        Int i = 0;
        Float fltScale = 2.0;
        assert(flt >= 0.0);
        while (fltScale <= flt) {
...
__inline static Int Log2FromFastFloat(FastFloat fflt) {
        return LOG2(fflt.iFraction) - fflt.iFracBits;
    }
    
__inline static Float FloatFromFastFloat( FastFloat fflt )
    {
...
__inline static FastFloat FastFloatFromInt( Int flt )
    {
        FastFloat fflt;
...
__inline static FastFloat FastFloatFromU64(U64 u64, Int cExp) 
    {
        FastFloat fflt;
