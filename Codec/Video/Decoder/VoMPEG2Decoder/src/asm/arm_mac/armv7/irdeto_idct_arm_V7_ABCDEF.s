...
@***********************************************************************/
	...
	.globl _Bit16Armv7IdctA
	.globl _Bit16Armv7IdctB
	.globl _Bit16Armv7IdctC
	
	.align 4		
 .macro	IRDETO_LOAD_IDCT4x8_COEF		
	mov	r12, #16
	...
	vld1.64	{d11}, [r0]		@	
 .endmacro
 .macro	IRDETO_LOAD_IDCT8x8_COEF		
 ...
 .macro		IRDETO_STR_IDCT   @is_8line
  	.if $0 > 0						
	vst1.64	{q8}, [r1], r2
	vst1.64	{q9}, [r1], r2		
	vst1.64	{q10},[r1], r2
...
@	Blk[56] = (idct_t)((x7 - x1) >> 8)@
 ...
 .macro 	IRDETO_Row_8x8line @is_8x8
