...
/* get rid of compiler warning "`voAMRNBDecbitno' defined but never used" */
static void* dummy[] = { (void *) voAMRNBDecbitno, (void *) dummy };
...
Word16 voAMRNBDecHomingTest (Word16 input_frame[], enum Mode mode)
{
	/* perform test for COMPLETE parameter frame */
	return dhf_test(input_frame, mode, voAMRNBDecprmno[mode]);
}
...
********************************************************************************
*/
static Word8 prmnofsf[8] = {7, 7, 7, 7, 7, 8, 12, 18};

Word16 voAMRNBDecHomingTestFirst (Word16 input_frame[], enum Mode mode)
{
