...
include $(CLEAR_VARS)
LOCAL_ARM_MODE := arm
LOCAL_MODULE := libvoH264Dec_DebugV7
...
VOMM:=-D__VO_NDK__ -DNDEBUG -DLINUX -D_LINUX -DARM  -DARM_ASM -D_LINUX_ANDROID -DCOMBINE_ALL_PROFILE -DNEON -DHAVE_NEON=1 -DNDK_BUILD -DYOUTUBE_HIGH_PROFILE  -DDEBUG_INFO -DTRACE_INPUT_RAW -DTRACE_MEM
