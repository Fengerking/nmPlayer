...
#define MAKE_HX_FACILITY_RESULT(sev,fac,code) \
    ((HX_RESULT) (((VOUINT32)(sev) << 31) | ((VOUINT32)(fac)<<16) | ((VOUINT32)(code))))
...
#define HX_SUCCEEDED(status) (((VOUINT32) (status) >> 31) == 0)
#define HX_FAILED(status)    (((VOUINT32) (status) >> 31) != 0)
