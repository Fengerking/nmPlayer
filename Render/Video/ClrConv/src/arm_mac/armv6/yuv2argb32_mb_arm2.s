...
@***********************************************************************/
	...
	.globl	_ccClip255	
	.globl	_cc_yuv420_to_argb32_mb_s_r90_arm

_cc_yuv420_to_argb32_mb_s_r90_arm: @PROC
...
ARGB32_LIT_WHILE_R:								
		...
		mov	r11, r11, lsl #16
		orr	r11, r11, r10, lsl #8
		orr	r1, r9, r11			        @a4 = ((ccClip255[(a4 + a0)>>20]))|((ccClip255[(a4 - a1)>>20]))|((ccClip255[(a4 + a2)>>20])<<16)@
