...
#define  SAFE_CODE_vad1  	1                     //for VAD function
...
#define MMS_IO
#define C_OPT   //disable 4.432     mos = 3.984  //enable 1.520000 mos = 3.984
//#define C_OPT_N  //disable 1.52300     mos = 3.902
//#define C_OPT_N1 //disable 2.61000  mos = 4.069
#define NO13BIT  //disable 1.53200  mos = 3.979

//disable C_OPT_N1 and NO13BIT          2.629  mos = 4.070
//disable C_OPT_N C_OPT_N1 and NO13BIT  2.674  mos = 4.076
//disable	all							5.552  mos = 4.076
//*****************************
...
{
#ifdef ARMGCC_OPT  //have some bug, need fix
...
{
#ifdef ARMGCC_OPT
        register Word16 result = 0;
	asm volatile (
                    "MOV  %[result], %[var1], ASR %[var2] \n\t"
