...
Word16 voAMRNBEnc_code_4i40_17bits(
						...
						)
{
	...
	voAMRNBEnc_set_sign(dn, dn_sign, dn2, 4);
	cor_h(h, dn_sign, rr);
#if !SAFE_CODE_search_4i40
	search_4i40(dn, dn2, rr, codvec);
	index = build_code(codvec, dn_sign, code, h, y, sign);
#else
	vo_search_4i40(dn, dn2, rr, codvec);
	index = vo_build_code4i40(codvec, dn_sign, code, h, y, sign);
#endif//SAFE_CODE_search_4i40
