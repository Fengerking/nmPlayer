...
typedef enum {
	...
	MAX_PostProcDrcDataFormat_VALUE = MAX_VOENUM_VALUE
...
//WMARESULT drcCalcMsAndPeak(struct _DRC *p, U8 *buffer, int numSampleBlocks);
//#ifdef __cplusplus
//}
//#endif
...
static I32 drcMinBufSize(DRC *p);

__inline static I32 drcMinBufSize(DRC *p)
{
