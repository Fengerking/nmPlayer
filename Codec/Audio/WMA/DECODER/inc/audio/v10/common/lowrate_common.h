...
#else
INLINE Int iResampleIndex( Int iRecon, const MaskResampleInfo MRI )
#endif
...
#else
INLINE Int iUnResampleIndex( Int iResampled, const MaskResampleInfo MRI )
#endif
...
#else
INLINE FastFloat ffltMaskPower10( Int iMaskQ )
#endif
{	// (10^(1/16)) ^ iMaskQ
	FastFloat fflt;
...
#else
INLINE Int prvScanForNextBarkIndex( const Int iRecon, Int* piBarkResampled, const int iHighLimit, 
										  const Int* const rgiBarkIndexResampled, const MaskResampleInfo MRI )
#endif
