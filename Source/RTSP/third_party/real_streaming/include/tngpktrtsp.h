...
#ifndef _TNGPKTRTSP_H_
#define _TNGPKTRTSP_H_
...
unsigned char* RDTTransportInfoRequestPacket_pack(unsigned char* buf,unsigned int len,struct RDTTransportInfoRequestPacket* pkt);
