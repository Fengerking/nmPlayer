...
;***********************************************************************/	
	...
	EXPORT	|cc_rgb32_mb_16x16_180_arm|
	IMPORT	|ccClip255|
	AREA	|.text|, CODE, READONLY

  macro 
  cc_rgb32_mb_16x16_180_arm_num_count $Num
        ...
        sub	 r8, r4, r5						;r8 = out_buf+out_stride							        	
        str	 r10, [r8, #(56 - $Num*8)]		;*((VO_S32*)(out_buf+(out_stride+4*num))) = (VO_S32)a4;						
  mend  	
						
|ccClip255_DATA_D_180|
	DCD       |ccClip255|
		
|cc_rgb32_mb_16x16_180_arm| PROC
