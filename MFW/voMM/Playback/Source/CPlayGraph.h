...
public:
	static VO_PTR		mmLoadLib (VO_PTR pUserData, VO_PCHAR pLibName, VO_S32 nFlag);
	static VO_PTR		mmGetAddress (VO_PTR pUserData, VO_PTR hLib, VO_PCHAR pFuncName, VO_S32 nFlag);
	static VO_S32		mmFreeLib (VO_PTR pUserData, VO_PTR hLib, VO_S32 nFlag);
...
protected:
	...
	VO_BOOL					m_bVideoRuntimeDropBFrame;
