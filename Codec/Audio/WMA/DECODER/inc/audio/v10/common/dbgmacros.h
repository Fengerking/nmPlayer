...
#define DBG_CX_REFRESH_DECL(TYPE,OP)                      \
    TYPE *g_file_PCM_##OP    = NULL;                      \
    TYPE *g_file_FWDMLT_##OP = NULL;                      \
    TYPE *g_file_RFX_##OP    = NULL;                      \
    TYPE *g_file_CX_##OP     = NULL;
...
#define DBG_CX_OPEN                                    \
    if (g_bReferenceDec)                               \
    {                                                  \
        TRACEWMA_EXIT(wmaResult, DbgRefrOpenRef(paudec, pau)); \
    }                                                  \
    else                                               \
    {                                                  \
        TRACEWMA_EXIT(wmaResult, DbgRefrOpenCan(paudec, pau)); \
    }
