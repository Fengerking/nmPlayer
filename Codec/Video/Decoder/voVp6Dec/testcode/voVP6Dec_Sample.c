...
#else
#define INPUT_FILE_NAME        "E:/MyResource/Video/clips/VP6/10074231_AVI_VP62_PCM_VBR'Pro'Sha3'Noise5_274K'32s500ms'352x240'5f'2c'44KHz'16b.vp6"/*  PHDec.mp4v\\SD Card\\*/
#define OUT_FILE_NAME          "E:/MyResource/Video/clips/VP6/10074231_AVI_VP62_PCM_VBR'Pro'Sha3'Noise5_274K'32s500ms'352x240'5f'2c'44KHz'16b.yuv"
...
int vp6_decoder(char *infilename ,char *outfilename,int times);
...
#endif // _WIN32_WCE
{
	...
	for(i=0;i<1;i++)
	{
		vp6_decoder(inFileName,outFileName,i);
		printf("------%d--------\n",i);
	}
}
