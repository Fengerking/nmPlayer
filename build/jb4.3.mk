...
TCROOTPATH:=/opt/jb4.3
TCPATH:=$(TCROOTPATH)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7
...
LIBGCCA:=$(TCROOTPATH)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/lib/gcc/arm-linux-androideabi/4.7/thumb/libgcc.a

# for target exe
TELDFLAGS:=-nostdlib -Bdynamic -Wl,-T,$(TCROOTPATH)/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/arm-eabi/lib/ldscripts/armelf.x -Wl,-dynamic-linker,/system/bin/linker -Wl,--gc-sections -Wl,-z,nocopyreloc -Wl,--no-undefined -Wl,-rpath-link=$(CCTLIB) -L$(CCTLIB)
