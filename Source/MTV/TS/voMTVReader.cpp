...
_CrtSetReportMode( _CRT_ERROR, _CRTDBG_MODE_DEBUG );
	...
	{
        //only test code for multi audio

        //static    int iAudioSampleCount = 0;
        //static    int iAudioChanged = 0;
...
// 		CDumper::WriteLog("request sample by time stamp = %I64d\r", pSample->Time);
		...
		//	if(iAudioSampleCount == 800 && iAudioChanged == 0)
		//	{
		//		VOLOGE("file parser load fail: 0x%08X!!");
		//		((CTsReader*)pReader)->SetSelectTrack(2, VO_TRUE, pSample->Time);
		//		iAudioChanged = 1;
		//	}

		//	if(iAudioSampleCount >= 800)
		//	{
		//		pTrack = pReader->GetTrackByIndex(2);
		//	}
		//}
