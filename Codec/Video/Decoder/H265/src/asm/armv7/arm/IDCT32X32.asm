...
IDCT32X32ASMV7_4row_loop        
        ...
        ldr   r12, = kg_IDCT_coef_for_t32_asm_EEO
        ...
        ldr  r12,  = kg_IDCT_coef_for_t32_asm_EO   
...
IDCT32X32ASMV7_resi_add_pred     
        ...
        subs   r9, r9, #1
        bge    IDCT32X32ASMV7_resi_add_pred
