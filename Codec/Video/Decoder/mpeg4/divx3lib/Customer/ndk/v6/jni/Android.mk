...
VOMM:= -DHAVE_NEON=1 -DNEW_SDK -DMPEG4 -DRVDS -DVOARMV6 -DVODIVX3 -DVOANDROID

LOCAL_CFLAGS := -D_VOMODULEID=0x02070000  -mfloat-abi=softfp -march=armv6j -mtune=arm1136jf-s -mfpu=vfp -fsigned-char
