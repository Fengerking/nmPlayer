...
public:
	...
	uint32  m_dwTimeScale;
    uint16  m_wAccessUnitDuration;
    uint16  m_wCompositionUnitDuration;


	bit64   m_startDecodingTimeStamp;
	bit64   m_startCompositionTimeStamp;
	//add by qichaoshen @ 2011-11-15
...
//====================================================================
//Tag: 0x1d, 8/4/2006
class DMBDescriptor : public Descriptor
{
public:
	DMBDescriptor();
	virtual ~DMBDescriptor();
