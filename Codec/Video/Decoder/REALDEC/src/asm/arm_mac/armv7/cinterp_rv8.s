...
#include "../../voASMPort.h"
 ...
 .macro	Interpolate_H01_OR_H02 	@input q1~4,  output q5~8,q9~12
	vmov.s16 d1, #6	
...
@result = ( 0*lTemp0 + 6*lTemp1 +      9*lTemp2 + lTemp3 + 128) >> 8@			
 ...
 .macro Interpolate_H01_OR_H02_HV	@input q1~3,  output q13~15 @q5~12	
...
@result = (-1*lTemp0 + 6*((lTemp1<<1) + lTemp2) + -1*lTemp3 + 8)>>4
 ...
 .macro Interpolate_V01_OR_V02 	@input q9,q10,q11,q12,q13~15,q1~4,  output q5~q8,q9~12 		
...
@2 line input q6, q7, q8, q9	out q2
	...
	vqshrun.s32 d6, q3, #($3)
	vqshrun.s32 d7, q5, #($3)
	vqshrun.s32 d10, q4, #($3)
	vqshrun.s32 d11, q6, #($3)	
	.if $1>0	
...
@result = (5*lTemp0 + 3*lTemp1 + 4)>>3@
	...
	vqshrun.s16 d10, q5, #$2
	vmlal.u8 q8, d23, d29		@3*lTemp1
	vqshrun.s16 d11, q6, #$2
	vadd.s16 q7, q7, q0		@+8
	vadd.s16 q8, q8, q0		@+8					
	vqshrun.s16 d12, q7, #$2
	vqshrun.s16 d13, q8, #$2
...
@1 line input d0, d20, d2, d21
	vadd.s16 q5, q5, q0		@+8	
	vmlal.u8 q6, d22, d30		
	vqshrun.s16 d10, q5, #$3
@2 line input d2, d21, d4, d22
	vadd.s16 q6, q6, q0		@+8
	vmlal.u8 q7, d22, d29
	vqshrun.s16 d11, q6, #$3	
	vmlal.u8 q7, d6, d29	
@3 line input d4, d22, d6, d23	
	...
	vadd.s16 q7, q7, q0		@+8
	vmlal.u8 q8, d8, d29
	vqshrun.s16 d12, q7, #$3		
	vmlal.u8 q8, d24, d30	
	
@4 line input d6, d23, d8, d24
	vadd.s16 q8, q8, q0		@+8					
	vqshrun.s16 d13, q8, #$3
...
@4 line input d6, d23, d8, d24		
 ...
 .macro Interpolate_ROUNDS @round, shif	@input q5~12  output d2, d4, d6~d16
	...
	vqshrun.s16 d6, q7, #$1
	vqshrun.s16 d8, q8, #$1
	vqshrun.s16 d10, q9, #$1
	vqshrun.s16 d12, q10, #$1
	vqshrun.s16 d14, q11, #$1
	vqshrun.s16 d16, q12, #$1										
 .endm
...
@}	/* H00V00 */
	...
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H00V00) 
VOASMFUNCNAME(ARMV7_Interpolate_H00V00):  @PROC
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H01V00) 
VOASMFUNCNAME(ARMV7_Interpolate_H01V00):  @PROC
...
@}
	...
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H02V00) 
VOASMFUNCNAME(ARMV7_Interpolate_H02V00):  @PROC
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H00V01) 
VOASMFUNCNAME(ARMV7_Interpolate_H00V01):  @PROC
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H01V01) 
VOASMFUNCNAME(ARMV7_Interpolate_H01V01):  @PROC
@Horizontal					
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}	
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H02V01) 
VOASMFUNCNAME(ARMV7_Interpolate_H02V01):  @PROC
@Horizontal					  
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H00V02) 
VOASMFUNCNAME(ARMV7_Interpolate_H00V02):  @PROC
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H01V02) 
VOASMFUNCNAME(ARMV7_Interpolate_H01V02):  @PROC
@Horizontal												              	 		
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_Interpolate_H02V02) 
VOASMFUNCNAME(ARMV7_Interpolate_H02V02):  @PROC
@Horizontal					
@	sub	r0, r0, #1
@	sub	r0, r0, r2			
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H00V00) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H00V00):  @PROC
	mov	r12, r1	  
	vld1.8  {d0},[r0],r2
	vld1.8  {d1},[r0],r2
	vld1.8  {d2},[r0],r2
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H01V00) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H01V00):  @PROC
...
@}
	...
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H02V00) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H02V00):  @PROC
...
@}
	...
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H00V01) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H00V01):  @PROC
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H01V01) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H01V01):  @PROC
@Horizontal	
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}	
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H02V01) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H02V01):  @PROC
@Horizontal
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H00V02) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H00V02):  @PROC
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H01V02) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H01V02):  @PROC
@Horizontal					
	sub	r0, r0, #1
	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02 $is_H01	@input q1~4,  output q5~8,q9~12
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddInterpolate_H02V02) 
VOASMFUNCNAME(ARMV7_AddInterpolate_H02V02):  @PROC
@Horizontal					
@	sub	r0, r0, #1
@	sub	r0, r0, r2			
@ 	Interpolate_H01_OR_H02_22	@output q5~8,q9~12,q13~14
...
@}
	...
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V00) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V00):  @PROC
	vld1.8  {d0},[r0],r2  
	vld1.8  {d1},[r0],r2  
	vld1.8  {d2},[r0],r2  
	vld1.8  {d3},[r0]  
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V00) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V00):  @PROC
	vmov.s8 d28, #5	
	vmov.s8 d29, #3	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V00) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V00):  @PROC
	vmov.s8 d28, #3	
	vmov.s8 d29, #5
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V01) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V01):  @PROC
	vmov.s8 d28, #5	
	vmov.s8 d29, #3	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V02) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H00V02):  @PROC
	vmov.s8 d28, #3	
	vmov.s8 d29, #5	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V01) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V01):  @PROC
	vmov.s8 d28, #25	
	vmov.s8 d29, #15
	vmov.s8 d30, #9		
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V01) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V01):  @PROC
	vmov.s8 d28, #25	
	vmov.s8 d29, #15
	vmov.s8 d30, #9		
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V02) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H01V02):  @PROC
	vmov.s8 d28, #9	
	vmov.s8 d29, #15
	vmov.s8 d30, #25		
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V02) 
VOASMFUNCNAME(ARMV7_MCCopyChroma_H02V02):  @PROC
	vmov.s8 d28, #9	
	vmov.s8 d29, #15
	vmov.s8 d30, #25		
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V00) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V00):  @PROC
	mov	r12, r1	  
	vld1.8  {d0},[r0],r2
	vld1.8  {d1},[r0],r2
	vld1.8  {d2},[r0],r2
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V00) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V00):  @PROC
	vmov.s8 d28, #5	
	vmov.s8 d29, #3	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V00) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V00):  @PROC
	vmov.s8 d28, #3	
	vmov.s8 d29, #5	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V01) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V01):  @PROC
	vmov.s8 d28, #5	
	vmov.s8 d29, #3	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V02) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H00V02):  @PROC
	vmov.s8 d28, #3	
	vmov.s8 d29, #5	
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V01) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V01):  @PROC
	vmov.s8 d28, #25	
	vmov.s8 d29, #15
	vmov.s8 d30, #9		
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V01) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V01):  @PROC
	vmov.s8 d28, #25	
	vmov.s8 d29, #15
	vmov.s8 d30, #9			
...
@	}
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V02) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H01V02):  @PROC
	vmov.s8 d28, #9	
	vmov.s8 d29, #15
	vmov.s8 d30, #25	
...
@
@}
	.globl VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V02) 
VOASMFUNCNAME(ARMV7_AddMCCopyChroma_H02V02):  @PROC
	vmov.s8 d28, #9	
	vmov.s8 d29, #15
	vmov.s8 d30, #25		
