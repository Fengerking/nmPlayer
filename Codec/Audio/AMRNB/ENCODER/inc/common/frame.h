...
enum RXFrameType { RX_SPEECH_GOOD = 0,
                   ...
                   RX_NO_DATA,
                   RX_N_FRAMETYPES,
				   RX_N_MAX = VO_MAX_ENUM_VALUE      /* number of frame types */
};
...
enum TXFrameType { TX_SPEECH_GOOD = 0,
                   ...
                   TX_ONSET,
                   TX_N_FRAMETYPES,     
				   TX_N_MAX = VO_MAX_ENUM_VALUE      /* number of frame types */
};
...
enum CHDECFrameType { CHDEC_SID_FIRST = 0,
                      ...
                      CHDEC_ESCAPE_DATA,
                      CHDEC_NO_DATA,
					  CHDEC_TYPE_MAX = VO_MAX_ENUM_VALUE
};
...
enum CHDECFrameQuality { CHDEC_GOOD = 0,
                         ...
                         CHDEC_PROBABLY_BAD,
                         CHDEC_BAD,
						 CHDEC_QUALITY = VO_MAX_ENUM_VALUE
};
