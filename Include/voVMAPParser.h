...
#ifndef __voVMAPParser_H__
#define __voVMAPParser_H__
...
* Parameter ID
*/
#define	VO_PID_VMAP_BASE						0x44000000
#define	VO_PID_VMAP_CONTENT_URI					(VO_PID_VMAP_BASE | 0x0001)/*!< <G>Get content URI,VO_PCAHR */
...
typedef struct
{
	...
	* \retval VO_RET_SOURCE2_OK Succeeded.
	*/
	VO_U32 (VO_API * GetData) (VO_PTR pHandle,  VOAdInfo** ppData);
...
* \retval VO_RET_SOURCE2_OK Succeeded.
*/
VO_S32 VO_API voGetVMAPParserAPI(VO_VMAP_PARSER_API * pParser);

typedef VO_S32 (* VOGETVMAPPARSERAPI) (VO_VMAP_PARSER_API * pParser);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif // __voVMAPParser_H__
