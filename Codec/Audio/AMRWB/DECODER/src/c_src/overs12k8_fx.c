...
//
//    default:
//      AMRWBPLUS_PRINT("wrong frame size in oversamp_12k8! (Unsupported rate)\n");
//      exit(0);
//  }      
//
//  
//  if (sub(lg,L_FRAME24k) <= 0) 
//  {
...
//  
//  
//  voAMRWBDecInterpol(signal+ncoef, sig_fs, lg, filter, ncoef, 
