...
#if MIXHUFFTABLES
extern const U32	g_rgiHuffDecTblRunLevel16smOb[];
extern const U32	g_rgiHuffDecTblRunLevel16ssOb[];
extern const U32	g_rgunHuffDecTbl_LevelRunMaskRLCV3[];
#else
...
//for all other rates
#if MIXHUFFTABLES
extern const U32	g_rgihufftable_LevelRun44smOb[];
extern const U32	g_rgihufftable_LevelRun44ssOb[];
extern const U32	g_rgihufftable_LevelRun44smQb[];
extern const U32	g_rgihufftable_LevelRun44ssQb[];
#else
...
//Witten add.begin
extern const U32 g_wmaHuffTbls_0_0_Sym2VEC4[240];
extern const U32 g_wmaHuffTbls_1_0_Sym2VEC2[272];
extern const U32 g_wmaHuffDecTbls_runlevel_3_SS[474];
extern const U32 g_wmaHuffDecTbls_runlevel_3_SM[532];
//end
