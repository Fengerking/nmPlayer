...
#define	TIFFTAG_WINTITLE			40091
#define	TIFFTAG_WINCOMMENT			40092
#define	TIFFTAG_WINAUTHOR			40093
#define	TIFFTAG_WINKEYWORDS			40094		
#define	TIFFTAG_WINSUBJECT			40095	
...
typedef	struct {
	UINT8	CameraMake[32];				/*	0x00000001	*/
...
typedef	struct {
	...
	UINT32	Filesource;					/*	0x02000000	*/
	UINT32	SceneType;					/*	0x04000000	*/
	UINT8*	CFAPattern;					/*	0x08000000	*/
	UINT32	SensingMethod;				/*	0x10000000	*/	
} EXIFDirectory;
...
typedef	struct {
	...
	UINT8	GPSMapDatum[40];			/*	0x00040000	*/
...
extern INT32 init_exif(EXIFLibrary* exiflib);
