	...
	.section .rdata
	.global	 cc_mb_16x16_l90_arm 
	.extern	 ccClip63 	
	@AREA	 .text , CODE, READONLY
	.section .text

  .macro cc_mb_16x16_l90_arm_num_count Num
@	a0 = psrc_u[num] - 128@
@	a1 = psrc_v[num] - 128@
...
@		ldrb	r10, [r10, #0]			@r10 = psrc_y[in_stride+2*num]
 ...
 cc_mb_16x16_l90_arm  : @PROC
@void cc_mb_16x16_l90_c(uint8_t *psrc_y, uint8_t *psrc_u, uint8_t *psrc_v, const int32_t in_stride,
...
@	a4  = (a7 << 21)@
@
@	*((int32_t*)(out_buf)) = (int32_t)a4@			num = 0

@	*((int32_t*)(out_buf+(-out_stride))) = (int32_t)a4@	num != 0
@	out_buf+=-out_stride@					num != 0
...
@		int32_t a0, a1, a2, a3, a4, a5, a7@
	...
	cc_mb_16x16_l90_arm_num_count 0
	cc_mb_16x16_l90_arm_num_count 1
	cc_mb_16x16_l90_arm_num_count 2
	cc_mb_16x16_l90_arm_num_count 3
	cc_mb_16x16_l90_arm_num_count 4
	cc_mb_16x16_l90_arm_num_count 5
	cc_mb_16x16_l90_arm_num_count 6
	cc_mb_16x16_l90_arm_num_count 7	
