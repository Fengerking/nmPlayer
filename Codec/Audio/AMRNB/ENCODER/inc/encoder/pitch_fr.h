...
********************************************************************************
*/
int voAMRNBEnc_Pitch_fr_init (Pitch_frState **st, VO_MEM_OPERATOR *pMemOP);
...
int voAMRNBEnc_Pitch_fr_reset (Pitch_frState *st);
/* reset of pre processing state (i.e. set state memory to zero)
   returns 0 on success
 */

void voAMRNBEnc_Pitch_fr_exit (Pitch_frState **st, VO_MEM_OPERATOR *pMemOP);
