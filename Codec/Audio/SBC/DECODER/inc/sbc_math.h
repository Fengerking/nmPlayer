...
#define SCALE4_STAGE1(src)  ASR_64(src, SCALE4_STAGE1_BITS)//10
#define SCALE4_STAGE2(src)  ASR_64(src, SCALE4_STAGE2_BITS)//21
#define SCALE4_STAGED1(src) ASR_64(src, SCALE4_STAGED1_BITS)//18
#define SCALE4_STAGED2(src) ASR_64(src, SCALE4_STAGED2_BITS)//23
#define SCALE8_STAGE1(src)  ASR_64(src, SCALE8_STAGE1_BITS)//8
#define SCALE8_STAGE2(src)  ASR_64(src, SCALE8_STAGE2_BITS)//24
#define SCALE8_STAGED1(src) ASR_64(src, SCALE8_STAGED1_BITS)//18
#define SCALE8_STAGED2(src) ASR_64(src, SCALE8_STAGED2_BITS)//23

#define FIXED_0(val) { val = 0; }
...
#define DIV2(dst, src)   { dst = voASR(src, 1); }
