...
*******************************************************************************/
#ifndef __CLiveSrcISS_H__
#define __CLiveSrcISS_H__
...
class CLiveSrcISS: public CvoSDK_PushSrcBase
#else
typedef VO_U32 _vosdk_int;
typedef VO_U64 _vosdk_int64;
#include "CLiveSrcBase.h"
class CLiveSrcISS : public CLiveSrcBase
#endif
{
public:
	CLiveSrcISS(void);
	virtual ~CLiveSrcISS(void);
#ifdef __USE_VOSDK
