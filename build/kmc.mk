...
VOPREDEF:=-DLINUX -D_LINUX -DNNJ -DUCLINUX
VONJ ?= linux
VOTT ?= v7
...
TCVENDOR=KMC
TCROOTPATH:=/opt/$(TCVENDOR)/kzmca9/staging/usr
CCTPRE:=$(TCROOTPATH)/bin/arm-linux-
AS:=$(CCTPRE)as
AR:=$(CCTPRE)ar
NM:=$(CCTPRE)nm
CC:=$(CCTPRE)gcc
...
CCTINC:=-I$(TCROOTPATH)/include #-I$(TCROOTPATH)/arm-linux/include/c++/4.3.4/tr1
CCTDEPOBJSPATH:=

CCTCFLAGS:=-finline-functions -finline-limit=600 -fno-inline-functions-called-once -frename-registers -fstrict-aliasing -funswitch-loops -fno-short-enums #-elf2flt=-s32768
...
CCTLIBDEEP:=$(CCTLIB)
VOTLDEPS:=#$(CCTLIBDEEP)/crtbegin.o $(CCTLIBDEEP)/crtend.o -lm -lc
...
ifeq ($(VOTT), v7)
VOCFLAGS+=-march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp -mabi=aapcs
