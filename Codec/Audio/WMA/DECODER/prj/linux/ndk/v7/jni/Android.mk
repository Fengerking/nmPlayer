...
LOCAL_SRC_FILES := \
	...
	$(ASM_SRC7)/fft_arm_v7.S \
	$(ASM_SRC7)/msaudio_arm_v7.S \
	$(ASM_SRC7)/msaudiopro_arm_v7.S \
	$(ASM_SRC7)/msaudiostdpro_arm_v7.S 
...
LOCAL_CFLAGS := -D_VOMODULEID=0x02230000   -DNDEBUG -mfloat-abi=softfp -march=armv7-a -mtune=cortex-a8 -mfpu=neon -fsigned-char
