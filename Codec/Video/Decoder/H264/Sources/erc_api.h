...
void ercReset( ercVariables_t *errorVar, int nOfMBs, int numOfSegments, avdInt32 picSizeX );
void ercClose( ercVariables_t *errorVar );
void ercSetErrorConcealment( ercVariables_t *errorVar, int value );

void ercStartSegment( int currMBNum, int segment, avdUInt32 bitPos, ercVariables_t *errorVar );
void ercStopSegment( int currMBNum, int segment, avdUInt32 bitPos, ercVariables_t *errorVar );
void ercMarkCurrSegmentLost(avdInt32 picSizeX, ercVariables_t *errorVar );
void ercMarkCurrSegmentOK(avdInt32 picSizeX, ercVariables_t *errorVar );
void ercMarkCurrMBConcealed( int currMBNum, int comp, avdInt32 picSizeX, ercVariables_t *errorVar );

int ercConcealIntraFrame( frame *recfr, avdInt32 picSizeX, avdInt32 picSizeY, ercVariables_t *errorVar );
int ercConcealInterFrame( frame *recfr, objectBuffer_t *object_list, 
                         avdInt32 picSizeX, avdInt32 picSizeY, ercVariables_t *errorVar );
