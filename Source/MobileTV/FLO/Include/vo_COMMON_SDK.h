...
//};
//#if !RTSPENGINE_CROSS_PLATFORM

//#define WIN32_LEAN_AND_MEAN 1
//#include <Windows.h>

//struct StreamInitParam {
//	int nMinUdpPort;
//	int nMaxUdpPort;
//	int nBufferTime;
//	int nRTSPTimeOut;
...
//	tFrmmLinkChart LnkChart; // for 3GPP-Link-CHAR.
//
//	BOOL bEnablePlaylistSupport; // for PlaylistSupport
//    BOOL bDisableAVSyncNotification;//For quality control
//	BOOL bOpenOriginalUDPPorts;//Some proxies would change the UDP ports which client sends to server in SETUP
//	BOOL bOpenUAProEachRequest;//Some Customer hope that UAProfile can be included in each request
//	BOOL bUseRTSPProxy;
//	TCHAR szProxyIP[MAX_PATH];
//	DWORD dwSupportTCP;
//	BOOL  bWaitForTeardown;
//	BOOL  bEnableNullAudFrameWhenPacketloss;
//	TCHAR szExtendNPTRegistry[MAX_PATH];
//	INT   nQLateThreshold;
//	BOOL  bLiveInitFromKeyFrm;
//};
//
//#endif//RTSPENGINE_CROSS_PLATFORM
