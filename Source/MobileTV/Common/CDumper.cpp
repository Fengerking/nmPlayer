...
#else
		fileSource.pSource = (VO_PTR)"/sdcard/dumper_stream_file.ts";
#endif
...
#elif defined (Linux)
		fileSource.pSource = (VO_PTR)"/data/local/voOMXPlayer/dumper_audio_file.aac";
#else
...
#else
		fileSource.pSource = (VO_PTR)_T("/data/local/voOMXPlayer/dumper_video_log.txt");
#endif
...
#else
		fileSource.pSource = (VO_PTR)_T("/data/local/voOMXPlayer/dumper_audio_log.txt");
#endif
