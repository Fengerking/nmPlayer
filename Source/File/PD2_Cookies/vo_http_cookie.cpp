...
VO_VOID vo_http_cookie::destroy_cookie_info()
{
	...
	vo_singlelink_list< vo_http_cookie_attrib_map * >::iterator iter = m_list_attrenv_map.begin();
	vo_singlelink_list< vo_http_cookie_attrib_map * >::iterator itere = m_list_attrenv_map.end();
...
VO_VOID vo_http_cookie::add_attribute_namevalue( VO_CHAR * str_name , VO_CHAR * str_value )
{
	...
	m_list_attrenv_map.push_back( ptr_namevalue );
}
...
VO_BOOL vo_http_cookie::process_namevalue_create_acesstime()
{
	vo_singlelink_list< vo_http_cookie_namevalue_map * >::iterator iter = m_list_cookienv_map.begin();
	vo_singlelink_list< vo_http_cookie_namevalue_map * >::iterator itere = m_list_cookienv_map.end();
	...
	{
		//no cookies name and value; waiting to be completed......
		return VO_FALSE;
	}
}
...
{
	vo_singlelink_list< vo_http_cookie_attrib_map * >::iterator aviter = m_list_attrenv_map.begin();
	vo_singlelink_list< vo_http_cookie_attrib_map * >::iterator avitere = m_list_attrenv_map.end();
...
VO_BOOL vo_http_cookie::process_cookie2storage()
{
	...
	m_http_cookie_node.invalid = VO_FALSE;
	ret = process_namevalue_create_acesstime();
	if( !ret )
	{
		return VO_FALSE;
	}
