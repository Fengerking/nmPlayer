...
{
  *hi  = extract_h(L_32);
  *lo  = (Word16)( L_msu((L_32 >> 1), *hi, 16384));  /* lo = L_32>>1   */
  return;
}
...
Word32 Div_32(Word32 L_num, Word16 denom_hi, Word16 denom_lo)
{
	...
	L_32 = (denom_hi * approx)<<1;
	L_32 += ((denom_lo * approx)>>15)<<1;

	L_32 = L_sub( (Word32)0x7fffffffL, L_32);      /* result in Q30 */

	hi = (Word16)(L_32 >>16);
	lo = (Word16)((L_32 - (hi <<16))>>1);
	...
	n_lo = (Word16)((L_num - (n_hi <<16))>>1);

	L_32 = (n_hi * hi)<<1;
	L_32 +=(((n_hi*lo)>>15)<<1);
	L_32 +=(((n_lo * hi)>>15)<<1);
	L_32 = L_shl2(L_32, 2);                        /* From Q29 to Q31 */
	return( L_32 );
}
