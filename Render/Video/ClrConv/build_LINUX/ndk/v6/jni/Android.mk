...
VOMM:=-DVOARMV6  -DLINUX -DARCH_IS_GENERIC -DARCH_IS_32BIT -DARCH_IS_LITTLE_ENDIAN -DCOLCONVENABLE

# about info option, do not need to care it
LOCAL_CFLAGS := -D_VOMODULEID=0x05040000   -DNDEBUG -mfloat-abi=softfp -march=armv6j -mtune=arm1136jf-s -mfpu=vfp -fsigned-char -msoft-float
