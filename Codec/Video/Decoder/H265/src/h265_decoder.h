...
typedef struct TComPic
{
  ...
  VO_BOOL	m_bRefenced;
  VO_BOOL	m_bNeededForOutput;      // True: ready for output. 
...
typedef struct H265_DEC
{
  ...
  VO_S32 nThdNum;
#if USE_FRAME_THREAD
  h265FrameThdPool *pFrameThdPool;
  VO_S32 nextThdIdx;
  H265_DEC_SLICE *p_avalable_slice;
...
#else
extern VO_S32 DecodeRawVideo(H265_DEC* p_dec, VO_U8* p_inbuf, VO_S32 buf_len, VO_S32* used_inbuf_len);
#endif
