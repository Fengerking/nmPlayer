...
*
*************************************************************************/
Word16 voAMRNBEnc_code_2i40_11bits(
						...
						)
{
	...
	cor_h(h, dn_sign, rr);
	search_2i40(dn, rr, codvec); /* function result */
...
)
{
	...
	for (k = 0; k < NB_PULSE; k++)
	{
		...
		{          
			...
			{
				track = 1;                                 
				index = add(shl2(index, 6), 16);              
			}
		}
		else if (track == 2)
		{      
			track = 1;                                   
			index = add(shl2(index, 6), 32);           
		}
		else if (track == 3)
		{
			track = 0;                                       
			index = add(shl2(index, 1), 1);           
		}
		else if (track == 4)
		{      
			track = 1;                                   
			index = add(shl2(index, 6), 48);
		}
		if (j > 0)
		{
			cod[i] = 8191;                               
