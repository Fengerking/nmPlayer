...
@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    .globl  _g_IDCTDec_WMV3_Pass1_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass2_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass3_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass4_ARMV4
			
    .globl  _SignPatch_ARMV4
    .globl  _SignPatch32_ARMV4
    .globl  _g_SubBlkIDCTClear_EMB_ARMV4			
    .globl  _g_IDCTDec16_WMV3_SSIMD_ARMV4

    .globl  _g_IDCTDec_WMV3_Pass1_Naked_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass2_Naked_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass3_Naked_ARMV4
    .globl  _g_IDCTDec_WMV3_Pass4_Naked_ARMV4		
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    bl   _g_IDCTDec_WMV3_Pass3_Naked_ARMV4
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    bl   _g_IDCTDec_WMV3_Pass4_Naked_ARMV4
