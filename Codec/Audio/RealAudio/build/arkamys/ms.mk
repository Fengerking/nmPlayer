...
OBJS:=ra_decode.o voRABUFDec.o voRADecSDK.o voRARawDec.o voRARMDec.o ra8lbr_decode.o \
			...
			bitstream.o bsac_dec_spectra.o decframe.o decode_bsac.o decoder.o downMatrix.o Header.o \
...
ifeq ($(VOTT), v6)
OBJS+= DecWindowNoAttacks_v6.o PostMultiply_V6.o PreMultiply_V6.o R4_Core_v6.o R8FirstPass_v6.o
...
ifeq ($(VOTT), v7)
OBJS+= DecWindowNoAttacks_v7.o PostMultiply_V7.o PreMultiply_V7.o R4_Core_V7.o R8FirstPass_v7.o
