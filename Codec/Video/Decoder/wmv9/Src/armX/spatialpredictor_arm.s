...
;//*@@@---@@@@******************************************************************
    ...
    EXPORT FilterHorzEdgeX8
    EXPORT FilterVertEdgeX8
...
|$M25445|
    ...
    ENDP  ; |?FilterHorzEdgeX8@CSpatialPredictor@@CAXPAEHH@Z|, CSpatialPredictor::FilterHorzEdgeX8
...
; extern "C" Void_WMV FilterVertEdgeX8 (PixelC* ppxlcCenter, I32_WMV iPixelIncrement, I32_WMV iStepSize);
    ...
    ENDP  ; |?FilterVertEdgeX8@CSpatialPredictor@@CAXPAEHH@Z|, CSpatialPredictor::FilterVertEdgeX8
...
; void aligned32_memset_u32( void* pDst, unsigned int u32C, unsigned int cbSiz )
    ...
    export  _aligned32_memset_u32x4
...
;       mov     pc, lr                  ; 2
    ...
    EXPORT  _aligned32_memset_u32x8
...
;       ldmia     sp!, {r4, r5, pc}     ; 3
    ...
    EXPORT  _aligned32_memset_u32x32
