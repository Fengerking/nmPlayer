...
LOCAL_SRC_FILES := \
	...
	$(CSRC_PATH)/armasm/ARMV6/gnu/voFilterVP6ArmV6.S \
	$(CSRC_PATH)/armasm/ARMV6/gnu/voIdctVP6ArmV6.S \
	$(CSRC_PATH)/armasm/ARMV6/gnu/voMcVP6ArmV6.S
...
VOMM:= -D__VO_NDK__ -D_VOLOG_INFO -DLINUX -D_LINUX -D_LINUX_ANDROID -DRVDS -DVOARMV6 -DSTABILITY -DLICENSEFILE

LOCAL_CFLAGS := -D_VOMODULEID=0x020a0000  -DNDEBUG -mfloat-abi=softfp -march=armv6j -mtune=arm1136jf-s -mfpu=vfp
