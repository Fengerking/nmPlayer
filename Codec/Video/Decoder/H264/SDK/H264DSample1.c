...
#if defined (_IOS) || defined(_MAC_OS) || defined(_LINUX) || defined(_WIN32)
#include "voOSFunc.h"
#endif
...
#ifdef JAVA_TEST
int votest_main(int argc, char **argv) 
#else
...
#endif
{
	...
	if(fconfig==NULL)
	{
		printf("Test  The config file does not exist1!!!\n");
		if(argc < 2)
		   return 0;
	}
