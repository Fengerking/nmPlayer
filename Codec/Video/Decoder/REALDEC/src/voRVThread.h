...
#define pthread_create(thhandle,attr,thfunc,tharg)   (int)((*thhandle=(HANDLE)CreateThread(attr,0,thfunc,tharg,0,0))? 0:1)
...
#if 0
int __inline vosleep(int n)
{
	int i;
	for(i = 0; i < 5000; i++) 
		return (int)sqrt(rand());
	return 0;
}
#endif
#endif
