...
@@4				r1~r8, r10,can't use, r0, r9, r11, r12, r14 can use
  ...
  .endmacro	
	...
	.globl _Arm11InterQ2
_Arm11InterQ2  : @PROC
@Arm11InterQ2(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		@rd
...
@	ldrd		r6, [r1], r3	
	...
	.globl _Arm11InterQ1
_Arm11InterQ1  : @PROC
@qpel_ha_8x8(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		@rd
...
W_20_19:				
	...
	.globl _Arm11InterQ3
_Arm11InterQ3  : @PROC
@qpel_ha_up_8x8(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		@rd
...
@	ldrd		r6, [r1], r3	
    ...
    .macro v_loop_code @Va_up, Up, CONST
...
@@4				r1~r8, r10,can't use, r0, r9, r11, r12, r14 can use
  ...
  .endmacro	
	...
	.globl _Arm11InterQ8
_Arm11InterQ8  : @PROC
@qpel_v_8x8(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
...
@5,6@7,8	
	...
	.globl _Arm11InterQ4
_Arm11InterQ4  : @PROC
@qpel_va_8x8(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
	ldr         r9, [sp, #192]		@height	
...
@	uhadd8		r7, r7, r9	
	...
	.globl _Arm11InterQ12
_Arm11InterQ12  : @PROC
@qpel_va_up_8x8(uint8_t *Src, uint8_t *Dst, int32_t SrcStride, int32_t DstStride, int32_t height, int32_t rd)
@ 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
	ldr         r9, [sp, #192]		@height	
