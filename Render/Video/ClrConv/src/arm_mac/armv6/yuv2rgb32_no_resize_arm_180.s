...
@***********************************************************************/	
	...
	.globl		_cc_rgb32_mb_16x16_180_arm 
	.globl 	_ccClip255

  .macro   cc_rgb32_mb_16x16_180_arm_num_count
        ...
        str	 r10, [r4, #(60 - ($0)*8)]		@*((VO_S32*)(out_buf+(4*num))) = (VO_S32)a4@
        sub	 r9, r9, #16
    	...
    	str	 r8, [r4, #(56 - ($0)*8)]		@*((VO_S32*)(out_buf+(4*num))) = (VO_S32)a4@
    	sub	 r10, r10, #16	
        ...
        str	 r10, [r8, #(60 - ($0)*8)]		@*((VO_S32*)(out_buf+(out_stride+4*num))) = (VO_S32)a4@	
        sub	 r9, r9, #16
		mul	 r9, r12, r9					@r9 = a3 = (psrc_y[(2*nu + 1)] - 16)*ConstY@
        ...
        sub	 r8, r4, r5						@r8 = out_buf+out_stride							        	
        str	 r10, [r8, #(56 - ($0)*8)]		@*((VO_S32*)(out_buf+(out_stride+4*num))) = (VO_S32)a4@						
  .endm  	
		
_cc_rgb32_mb_16x16_180_arm: @PROC
	stmdb	sp!, {r4-r11, lr}		@ save regs used
	sub	    sp, sp, #32				@ sp - 32
	ldr    	r4, [sp, #68]			@r4 = out_buf
	ldr	    r5, [sp, #72]			@r5 = out_stride				
	ldr  	r14,ccClip255_DATA_D_180
	...
	str	    r12, [sp, #4]	
RGB32_BIG_WHILE_dis:
	cc_rgb32_mb_16x16_180_arm_num_count 0
	cc_rgb32_mb_16x16_180_arm_num_count 1
	cc_rgb32_mb_16x16_180_arm_num_count 2
	cc_rgb32_mb_16x16_180_arm_num_count 3
	cc_rgb32_mb_16x16_180_arm_num_count 4
	cc_rgb32_mb_16x16_180_arm_num_count 5
	cc_rgb32_mb_16x16_180_arm_num_count 6
	cc_rgb32_mb_16x16_180_arm_num_count 7
...
ccClip255_DATA_D_180:	.word       _ccClip255		
