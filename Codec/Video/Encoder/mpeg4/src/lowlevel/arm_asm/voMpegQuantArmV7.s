...
;	************************************************************************/
	...
	EXPORT	QuantInter_ARMV7	
	EXPORT	QuantIntraH263_ARMV7	
	EXPORT	ExpandByteToShort_ARMV7	
	
	IMPORT	__voMPEG4E0220	;quant_multi_table     ;extern const unsigned int quant_multi_table[32]
...
ExpandByteToShort_ARMV7	PROC
	...
	mov			pc, lr
	ENDP	;ExpandByteToShort_ARMV7

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;QuantIntraH263_C(int16_t * coeff,
;				   const int16_t * data,
...
QuantIntraH263_ARMV7	PROC
	stmdb	sp!, {r4-r5, lr}
	
	;row 0-3
	
	ldr			r5, =__voMPEG4E0220		;quant_multi_table
	ldrh		lr, [r1]
	mov			r4, r2, lsl #1			;quant_m_2 = quant << 1;
	mov			r12, r0
	cmp			lr, #0
	ldr			r5, [r5, r2, lsl #2]	;mult = quant_multi_table[quant];	
	...
	ldmia	sp!, {r4-r5, pc}
	ENDP	;quant_h263_intra_armv7
	

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;QuantInterH263Mpeg4_C(signed short * coeff,
...
QuantInter_ARMV7	PROC
	stmdb	sp!, {r4-r5, lr}
	
	;row 0-3
	
	ldr			r3, =__voMPEG4E0220		;quant_multi_table
	vld1.32		{q0}, [r1]!
	mov			r4, r2, lsl #1			;quant_m_2 = quant << 1;
	vld1.32		{q1}, [r1]!
