    .text
    .align 4
    .globl  _voInterpolateBlockBicubic_ARMV7
    .globl  _voInterpolateBlockBilinear_ARMV7
    .globl  _voInterpolateBlockBilinear_11_ARMV7
    .globl  _voInterpolateBlockBilinear_10_ARMV7
    .globl  _voInterpolateBlockBilinear_01_ARMV7
    
_voInterpolateBlockBilinear_01_ARMV7:
@r0 = pSrc
@r1 = iSrcStride
@r2 = pDst
@r3 = iDstStride
...
_voInterpolateBlockBilinear_10_ARMV7:
@r0 = pSrc
@r1 = iSrcStride
@r2 = pDst
@r3 = iDstStride
...
_voInterpolateBlockBilinear_11_ARMV7:
@r0 = pSrc
@r1 = iSrcStride
@r2 = pDst
@r3 = iDstStride
...
_voInterpolateBlockBilinear_ARMV7:
@r0 = pSrc
@r1 = iSrcStride
@r2 = pDst
@r3 = iDstStride
...
_voInterpolateBlockBicubic_ARMV7:
@pSrc,  iSrcStride,
@pDst, iDstStride,
@r4: ishiftV,
