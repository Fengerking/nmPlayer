...
;;4				r1~r8, r10,can't use, r0, r9, r11, r12, r14 can use
  ...
  mend
	...
	EXPORT Arm11InterBQ2
Arm11InterBQ2 PROC
;qpel_h_8x8_b(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		;rd
...
;	uhadd8	r5, r5, r7
	...
	EXPORT Arm11InterBQ1
Arm11InterBQ1 PROC
;qpel_ha_8x8_b(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		;rd
...
W_add_3_7		dcd 0x00030007		;W_add_3_6
W_add_23_14		dcd	0x0017000e
W_add_20_19		dcd	0x00140013		;W_add_20_02	W_add_20_06

	ENDP  ;


	EXPORT Arm11InterBQ3
Arm11InterBQ3 PROC
;qpel_ha_up_8x8_b(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r11, lr}
	sub         sp, sp, #28
	ldr         r10, [sp, #68]		;rd
...
;	uhadd8	r5, r5, r7
  ...
  macro 
  v_loop_code_add $Va_up, $Up, $CONST
...
;;4				r1~r8, r10,can't use, r0, r9, r11, r12, r14 can use
  ...
  mend	
	...
	EXPORT Arm11InterBQ8
Arm11InterBQ8 PROC
;qpel_v_8x8_b_(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
...
W_add1_3_7		dcd 0x00030007		;W_add_3_6
W_add1_23_14		dcd	0x0017000e
W_add1_20_19		dcd	0x00140013		;W_add_20_02	W_add_20_06
	
	EXPORT Arm11InterBQ4
Arm11InterBQ4 PROC
;qpel_va_8x8_b(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
	ldr         r9, [sp, #192]		;nHeight	
...
;	uhadd8		r3, r3, r7
	...
	EXPORT Arm11InterBQ12
Arm11InterBQ12 PROC
;qpel_va_up_8x8_b(VO_U8 *Src, VO_U8 *Dst, VO_S32 SrcStride, VO_S32 DstStride, VO_S32 nHeight, VO_S32 rd)
; 53   : {
	stmdb       sp!, {r4 - r12, lr}
	sub			sp, sp,	#152
	ldr         r9, [sp, #192]		;nHeight	
