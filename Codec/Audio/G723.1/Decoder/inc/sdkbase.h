...
enum
{
	...
	_MAKEBASE(0x00170000, G711)
	_MAKEBASE(0x00180000, G722)
	_MAKEBASE(0x00190000, G723)
	_MAKEBASE(0x001A0000, iLBC)
};
...
typedef enum
{
	...
	AC_G711                                 = 0x80000002,   /*!< G711 speech codec*/
	AC_G722                                 = 0x80000004,   /*!< G722 speech codec*/
	AC_G723                                 = 0x80000008,   /*!< G723 speech codec*/
	AC_iLBC                                 = 0x80000010,    /*!< iLBC speech codec*/
}VOAVCODEC;
