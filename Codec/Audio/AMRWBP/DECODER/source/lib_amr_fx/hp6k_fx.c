...
void voAMRWBPDecInit_Filt_6k_7k(Word16 mem[])         /* mem[30] */
{
...
)
{
...
#if (!FUNC_FILE_6K_7K_OPT)
    voAMRWBPDecCopy(mem, x, L_FIR - 1);
    ...
    voAMRWBPDecCopy(x + lg, mem, L_FIR - 1);
