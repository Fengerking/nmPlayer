...
typedef enum
{
	...
	VOID_FILEREAD_INDEX_NORMAL2FP		= VOID_FILEREAD_BASE | 0x0026, /*!< convert index, normal mode to fast play mode */
	VOID_FILEREAD_INDEX_FP2NORMAL		= VOID_FILEREAD_BASE | 0x0027, /*!< convert index, fast play mode to normal mode */
}
