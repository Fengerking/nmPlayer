...
public:
	...
	virtual void			SetFlush(OMX_BOOL bFlushing) {m_bFlushing = bFlushing;}
	virtual OMX_BOOL		IsFlush() {return m_bFlushing;}

	virtual void			SettingsChanging() {m_bSettingsChanging = OMX_TRUE;}
	virtual OMX_BOOL		IsSettingsChanging() {return m_bSettingsChanging;}
...
protected:
	...
	// OMX_EventPortSettingsChanged sent and waiting for IL client process
	// if OMX_TRUE, we need cease transferring data
	OMX_BOOL						m_bSettingsChanging;
