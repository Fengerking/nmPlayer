...
long long Profiler_functionTimings[MAX_FUNCTIONS_TO_PROFILE];
long long Profiler_functionPlusChildTimings[MAX_FUNCTIONS_TO_PROFILE];
long long Profiler_totalTime;
long long profileStartTime;
HANDLE hProfile;
...
void Profiler_initEX(LPCTSTR szProfilerName, int fAppend )
{
	...
	memset( Profiler_functionTimings, 0, sizeof(long long)*MAX_FUNCTIONS_TO_PROFILE );
	memset( Profiler_functionPlusChildTimings, 0, sizeof(long long)*MAX_FUNCTIONS_TO_PROFILE );
