...
;for V4
	GenCodeCpy		CopyBlock8x8_ARMV4,		ArmCopy8x8,	0,	0,	0,	1,	0,	0;	ok
	GenCodeCpy		CopyBlock16x16_ARMV4,		ArmCopy16x16,	0,	0,	0,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlock_ARMV4,		ArmInter8x8,	0,	0,	1,	1,	0,	0;	ok
	
	GenCodeCpy		MCMpegBlockVer_ARMV4,		ArmInter8x8V,	0,	0,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockHor_ARMV4,		ArmInter8x8H,	0,	0,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockHorVer_ARMV4,		ArmInter8x8HV,	0,	0,	1,	1,	0,	0;	ok
	
	GenCodeCpy		MCMpegBlockRdVer_ARMV4,		ArmInter8x8V,	1,	0,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockRdHor_ARMV4,		ArmInter8x8H,	1,	0,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockRdHorVer_ARMV4,	ArmInter8x8HV,	1,	0,	1,	1,	0,	0;	ok
                                                                  	  	  	  	
	GenCodeCpy		MCMpegBlockAddVer_ARMV4,		ArmInter8x8V,	0,	1,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockAddHor_ARMV4,		ArmInter8x8H,	0,	1,	1,	1,	0,	0;	ok
	GenCodeCpy		MCMpegBlockAddHorVer_ARMV4,	ArmInter8x8HV,	0,	1,	1,	1,	0,	0;	ok
	
	GenCodeCpy		MCMpegBlockAdd_ARMV4,		ArmInter2_8x8,	0,	1,	1,	1,	0,	0;	ok	
	
;for V6
	GenCodeCpy		CopyBlock8x8_ARMV6,		ArmCopy8x8,	0,	0,	0,	1,	1,	0;	ok
	GenCodeCpy		CopyBlock16x16_ARMV6,		ArmCopy16x16,	0,	0,	0,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlock_ARMV6,		ArmInter8x8,	0,	0,	1,	1,	1,	0;	ok
	
	GenCodeCpy		MCMpegBlockVer_ARMV6,		ArmInter8x8V,	0,	0,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockHor_ARMV6,		ArmInter8x8H,	0,	0,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockHorVer_ARMV6,	ArmInter8x8HV,	0,	0,	1,	1,	0,	0;	ok
	
	GenCodeCpy		MCMpegBlockRdVer_ARMV6,	ArmInter8x8V,	1,	0,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockRdHor_ARMV6,	ArmInter8x8H,	1,	0,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockRdHorVer_ARMV6,	ArmInter8x8HV,	1,	0,	1,	1,	0,	0;	ok
                                                                  	  	  	  	
	GenCodeCpy		MCMpegBlockAddVer_ARMV6,	ArmInter8x8V,	0,	1,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockAddHor_ARMV6,	ArmInter8x8H,	0,	1,	1,	1,	1,	0;	ok
	GenCodeCpy		MCMpegBlockAddHorVer_ARMV6,	ArmInter8x8HV,	0,	1,	1,	1,	0,	0;	ok
	
	GenCodeCpy		MCMpegBlockAdd_ARMV6,	ArmInter2_8x8,	0,	1,	1,	1,	1,	0;	ok	
