...
void  Comp_Lpc( Word16 *UnqLpc, G723EncState *st)
{
	...
	Word16   *DataBuff = (Word16 *)st->input_buffer;
	Word16   *PrevDat = (Word16 *)CodStat->PrevDat;
    ...
    Update_Acf(Acf_sf, ShAcf_sf, CodCng);
...
{
    int   i,j,k ;
    Word16 *Dpnt = (Word16*)st->input_buffer;
	CODSTATDEF *CodStat = (CODSTATDEF*)st->cod_state;
    Word32   Acc0  ;
/*
 * Do for all subframes
...
{
    int   i,j;
	Word16 *PrevErr = (Word16 *)CodStat->PrevErr;
    Word32   Acc0,Acc1 ;
