#ifndef LIBDRA_GLOBAL_H
#define LIBDRA_GLOBAL_H
...
//#define Q31(A) (((1.00 - (A))<0.00000001)? ((int)0x7FFFFFFF) : (((A) >= 0) ? ((int)((A)*(1<<31)+0.5)) : ((int)((A)*(1<<31)-0.5))))
#define Q31(A) (((1.00 - (A))<0.00000001) ? ((int)0x7FFFFFFF) : (((A) >= 0) ? ((int)((A)*((unsigned int)(1<<31))+0.5)) : ((int)((A)*((unsigned int)(1<<31))-0.5))))

#define MUL_14(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<13)) >> 14)
#define MUL_15(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<14)) >> 15)
#define MUL_16(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<15)) >> 16)
#define MUL_17(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<16)) >> 17)
#define MUL_18(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<17)) >> 18)
#define MUL_19(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1<<18)) >> 19)
#define MUL_20(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 19)) >> 20)
#define MUL_21(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 20)) >> 21)
#define MUL_22(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 21)) >> 22)
#define MUL_23(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 22)) >> 23)
#define MUL_24(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 23)) >> 24)
#define MUL_25(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 24)) >> 25)
#define MUL_26(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 25)) >> 26)
#define MUL_27(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 26)) >> 27)
#define MUL_28(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 27)) >> 28)
#define MUL_29(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 28)) >> 29)
#define MUL_30(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 29)) >> 30)
#define MUL_31(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)+(1 << 30)) >> 31)
#define MUL_32(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)) >> 32)
#define MUL_33(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)) >> 33)
#define MUL_34(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)) >> 34)
#define MUL_35(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)) >> 35)
#define MUL_36(A,B) (int)(((VO_S64)(A)*(VO_S64)(B)) >> 36) 
