...
const unsigned char RTCP_PACKET_RFC3611     = 207;
// SDES:
...
/**
\brief the parser of RTCP

It handles the rtcp report from server and  send the relative report to server.
*/
class CRTCPParser
{
public:
...
public:
	...
	VORTCPReceiverReport m_sRReport;
	VORTCPSenderReport 	   m_sSReport;
	unsigned int		   m_latency;
	unsigned int		   m_latencyAvg;
