...
)
{
  ...
  *------------------------------------------------------------*/
	...
	cor >>= 12;
	k = extract_h((voEVRCCodecInv_sqrt(cor) << 8));
  ...
  *-------------------------------------------------------------------*/
	...
	ps2 = ((dn[codvec[0]] + dn[codvec[2]]) - dn[codvec[1]]);
	...
	for (k = 0; k < NB_PULSE; k++)
	{
		...
		pos = (i * Q15_1_7)>>15;	/* pos = position/7 */
		index = ((index << 3) + pos);
