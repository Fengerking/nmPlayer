...
export CC="${DevPath}/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc -arch i386"
...
# add -isysroot to CC=
sed -ie "s!^CFLAG=!CFLAG=-isysroot ${DevPath}/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator${SDKVERSION}.sdk !" "Makefile"
...
export CC="${DevPath}/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc -arch armv6"
...
sed -ie "s!^CFLAG=!CFLAG=-isysroot ${DevPath}/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS${SDKVERSION}.sdk !" "Makefile"
...
export CC="${DevPath}/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc -arch armv7"
