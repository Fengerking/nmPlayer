...
TCVENDOR=openwrt
TCROOTPATH:=/opt/$(TCVENDOR)
CCTPRE:=$(TCROOTPATH)/bin/arm-openwrt-linux-uclibcgnueabi-
AS:=$(CCTPRE)as
AR:=$(CCTPRE)ar
NM:=$(CCTPRE)nm
CC:=$(CCTPRE)gcc
...
CCTINC:=-I$(TCROOTPATH)/include -I$(TCROOTPATH)/build/include
CCTDEPOBJSPATH:=
...
VOTEDEPS:=#$(TCROOTPATH)/initial/libgcc.a
VOSYSSTCS:=$(TCROOTPATH)/initial/libgcc.a

# for target lib
TLLDFLAGS:=-nostdlib -Wl,-shared,-Bsymbolic
CCTLIBDEEP:=$(CCTLIB)/gcc/arm-openwrt-linux-uclibcgnueabi/4.5.2
...
VOCFLAGS+=$(VOPREDEF) $(VOMM) -Wall -fpic -fPIC -pipe -fsigned-char -fno-leading-underscore -ftracer -fforce-addr -fomit-frame-pointer -fno-bounds-check -fno-stack-protector
