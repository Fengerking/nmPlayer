    ...
    if (sub(fscale,FSCALE_DENOM) >= 0)
    {
      for(i = 0; i < lg; i++)
      {
         ...
         x0 = signal[i];    move16();
          ...
          L_tmp = L_mac(L_tmp, y1_lo, a1);
          L_tmp = L_mac(L_tmp, y2_lo, a2);
          L_tmp = L_shr(L_tmp, 15);
          L_tmp = L_mac(L_tmp, y1_hi, a1);
          L_tmp = L_mac(L_tmp, y2_hi, a2);
          L_tmp = L_mac(L_tmp, x0, b2);
          L_tmp = L_mac(L_tmp, x1, b1);
          L_tmp = L_mac(L_tmp, x2, b2);
