...
{
	CMP3Writer *p = new CMP3Writer((VO_MEM_OPERATOR*)pParam->pMemOP, (VO_FILE_OPERATOR*)pParam->pSinkOP);
...
static VO_U32 VO_API AddSample(VO_PTR p, VO_SINK_SAMPLE * pSample)
{
	...
	return ((CMP3Writer *)p)->AddSample(pSample);
}
...
static VO_U32 VO_API  SetParam(VO_PTR p, VO_U32 uID, VO_PTR pParam)
{
	...
	return ((CMP3Writer *)p)->SetParam(uID , pParam);
}
...
static VO_U32 VO_API GetParam(VO_PTR p, VO_U32 uID, VO_PTR pParam)
{
	...
	return ((CMP3Writer *)p)->GetParam(uID , pParam);
}

VO_S32 VO_API voGetMP3WriterAPI(VO_SINK_WRITEAPI* pReadHandle, VO_U32 uFlag)
{
