	...
	.globl _ccClip63 	
	.globl _cc_yuv420_mb_s_arm 

 _cc_yuv420_mb_s_arm:  @PROC
@void cc_yuv420_mb_s_c(int width, int height, uint8_t *src_y, uint8_t *src_u, uint8_t *src_v, 
...
@		i = width@		
@		do{
@			int32_t a0, a1, a2, a3, a4, a5, a6, a7, a8, a4_temp, a7_temp@
@			int32_t aa, bb@
@			// u, v
@			a0 = x_scale_par0[0]@	
@			a6 = x_scale_par0[3]@
