...
@//************************************************************************
    ...
    .globl  _memcpy
    .globl  _gaSubsampleBicubic
    .globl  _gaSubsampleBilinear
    .globl  _g_InterpolateBlockBilinear_Overflow_C
    .globl  _g_InterpolateBicubic_Overflow_C
    .globl  _g_InterpolateBicubic_Overflow_zeroXFrac_C
    .globl  _g_InterpolateBicubic_Overflow_zeroYFrac_C
    .globl  _g_InterpolateBlockBicubic_00_C
    .globl  _g_InterpolateBlockBicubic_01_C
    .globl  _g_InterpolateBlockBicubic_10_C
    .globl  _g_InterpolateBlockBicubic_11_C
    .globl  _g_InterpolateBlockBilinear_C

    @ The following routines are moved from interpolate_wmv9_arm.s
    .globl  _g_InterpolateBlockBicubic_EMB
    .globl  _g_VertFilterStepTbl
    .globl  _gaSubsampleBicubic
    .globl  _g_InterpolateBlockBicubic_xx_EMB
			
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

@g_InterpolateBlockBilinear_C PROC
    WMV_LEAF_ENTRY g_InterpolateBlockBilinear_C
...
@ 318  :         g_InterpolateBlockBilinear_Overflow_C (pSrc, iSrcStride, pDst, iDstStride, iRndCtrl, pH, pV, pFilter)@
    ...
    str       r0, [sp]
    mov       r0, r4
    bl        _g_InterpolateBlockBilinear_Overflow_C  @ 0000020C
L37447:
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    WMV_LEAF_ENTRY g_InterpolateBlockBicubic_00_C
...
M37805:
      ...
      @ g_InterpolateBlockBicubic_00_C

@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

    WMV_LEAF_ENTRY g_InterpolateBlockBicubic_01_C
...
@ 426  :         g_InterpolateBicubic_Overflow_zeroXFrac_C (pSrc, iSrcStride, pDst, iDstStride, pV, iRound, iShift)@
    ...
    mov       r1, r12
    mov       r0, r4
    bl        _g_InterpolateBicubic_Overflow_zeroXFrac_C  @ 00000248
L37505:
...
M37849:
      ...
      @ g_InterpolateBlockBicubic_01_C

@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

    WMV_LEAF_ENTRY g_InterpolateBlockBicubic_10_C
...
M37888:
      ...
      @ g_InterpolateBlockBicubic_10_C

@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

    WMV_LEAF_ENTRY g_InterpolateBlockBicubic_11_C
...
@ 634  :         g_InterpolateBicubic_Overflow_C (pSrc, iSrcStride, pDst, iDstStride, pFilter, pV, pH, iRound1, iRound2, iShift)@
    ...
    str       r0, [sp]
    mov       r0, r4
    bl        _g_InterpolateBicubic_Overflow_C  @ 00000394
L37607:
...
M37955:
      ...
      @ g_InterpolateBlockBicubic_11_C

    WMV_LEAF_ENTRY g_InterpolateBlockBicubic_xx_EMB
...
L39272:
    ...
    sub       r0, r5, r0
    add       r0, r0, #1
    bl        _g_InterpolateBlockBicubic_EMB
L38102:
...
M39328:
      ...
      @ g_InterpolateBlockBicubic_xx_EMB
