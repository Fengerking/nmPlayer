...
********************************************************************************
*/
int voAMRNBEnc_lpc_init (lpcState **st, VO_MEM_OPERATOR *pMemOP);
...
int voAMRNBEnc_lpc_reset (lpcState *st);
/* reset of pre processing state (i.e. set state memory to zero)
   returns 0 on success
 */
void voAMRNBEnc_lpc_exit (lpcState **st, VO_MEM_OPERATOR *pMemOP);
