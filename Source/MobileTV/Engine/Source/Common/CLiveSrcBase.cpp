...
int CLiveSrcBase::Open (void * pUserData, VOSRCSTATUS fStatus, VOSRCSENDDATA fSendData)
{
...
int	CLiveSrcBase::Cancel (int nID)
{
...
int CLiveSrcBase::FindChannel(VO_LIVESRC_FORMATTYPE type)
{
