...
int CVOMEPlayer::BuildGraph (void)
{
	...
	Source.pDrmCB = NULL;//&m_drmCallback;
...
int CVOMEPlayer::Invoke (android::Parcel * request, android::Parcel *reply)
{
	...
	CVOParcelConverter::gVOParcelConverter.ReadParcel  (request, &nID, &nParam1, &lParam2, szParam3);


	nID = 81;
	nParam1 = 381;
	lParam2 = 3811979;
	strcpy(szParam3, "Avatar");

	CVOParcelConverter::gVOParcelConverter.WriteParcel (reply, nID, nParam1, lParam2, szParam3);


	return 0;
}

int CVOMEPlayer::GetMetadata (const android::media::Metadata::Filter& ids, android::Parcel *records)
{
