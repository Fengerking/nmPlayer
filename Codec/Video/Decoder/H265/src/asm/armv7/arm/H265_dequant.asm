...
;@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        import kg_dequant_scales
        
        export DoDequantASMV7
...
DoDequantASMV7   
        ...
        bne  DoDequantASMV7_scalingListEnabledFlag_True
        ldr    r12, = kg_dequant_scales
        ;and   r11, r11, #0xff 				;@ uiLog2Width
        ldr    r7, [r12, r9, lsl #2] 		;@ kg_dequant_scales[pDequant->iRem]
        mov    r4, r7, lsl r8 						 	;@ scale = kg_dequant_scales[pDequant->iRem] << pDequant->iPer;
...
DoDequantASMV7_For_n_1        
        ...
        bgt    DoDequantASMV7_For_n_1
        ldmfd sp!, {r4-r11, pc}
        
DoDequantASMV7_scalingListEnabledFlag_True        
        ;and   r11, r11, #0xff				;@ uiLog2Width
        add    r5, r6, r11 							;@ uiBitDepth + uiLog2Width
