...
VOMM:= -D__VO_NDK__ -D_VOLOG_INFO -DLINUX -D_LINUX -D_LINUX_ANDROID -DARM  -DRVDS -DLINUX  -DVOARMV7  -DSTABILITY

LOCAL_CFLAGS := -D_VOMODULEID=0x03410000   -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp
