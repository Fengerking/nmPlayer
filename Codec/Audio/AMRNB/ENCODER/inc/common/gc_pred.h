...
********************************************************************************
*/
int voAMRNBEnc_gc_pred_init(gc_predState **st, VO_MEM_OPERATOR *pMemOP);
