...
WMARESULT auSubframeRecon ( CAudioObjectDecoder *paudec, CAudioObject* pau )
{
    WMARESULT hr = WMA_OK;
    I16 iCh, iChSrc;
    I16 iSizePrev=0, iSizeCurr, iSizePrev2;
    PerChannelInfo *ppcinfo = NULL, *ppcinfo2 = NULL;
    Int     i, iOverlapSize;
...
#endif	//#if !(defined(WMA_OPT_SUBFRAMERECON_ARM) && WMA_OPT_SUBFRAMERECON_ARM)
...
{
	{0x00000024, 0x66e30000},	{0x00000024, 0x7370e000},	{0x00000023, 0x40c37000},	{0x00000023, 0x48aa7000},
	{0x00000023, 0x51884800},	{0x00000023, 0x5b7b1000},	{0x00000023, 0x66a4a000},	{0x00000023, 0x732ae000},
	{0x00000022, 0x409c2800},	{0x00000022, 0x487e6000},	{0x00000022, 0x5156d400},	{0x00000022, 0x5b439800},
	{0x00000022, 0x66666400},	{0x00000022, 0x72e50800},	{0x00000021, 0x4074fc00},	{0x00000021, 0x48526800},
	{0x00000021, 0x51258200},	{0x00000021, 0x5b0c4200},	{0x00000021, 0x66284c00},	{0x00000021, 0x729f5c00},
	{0x00000020, 0x404de600},	{0x00000020, 0x48268e00},	{0x00000020, 0x50f44d00},	{0x00000020, 0x5ad50c00},
	{0x00000020, 0x65ea5a00},	{0x00000020, 0x7259db00},	{0x0000001f, 0x4026e700},	{0x0000001f, 0x47facd00},
	{0x0000001f, 0x50c33600},	{0x0000001f, 0x5a9df780},	{0x0000001f, 0x65ac8c00},	{0x0000001f, 0x72148280},
	{0x0000001e, 0x40000000},	{0x0000001e, 0x47cf2680},	{0x0000001e, 0x50923c00},	{0x0000001e, 0x5a670400},
	{0x0000001e, 0x656ee400},	{0x0000001e, 0x71cf5480},	{0x0000001e, 0x7fb26100},	{0x0000001d, 0x47a39a80},
	{0x0000001d, 0x50615f80},	{0x0000001d, 0x5a303180},	{0x0000001d, 0x65316100},	{0x0000001d, 0x718a5080},
	{0x0000001d, 0x7f64f100},	{0x0000001c, 0x47782980},	{0x0000001c, 0x5030a100},	{0x0000001c, 0x59f98000},
	{0x0000001c, 0x64f40380},	{0x0000001c, 0x71457600},	{0x0000001c, 0x7f17b000},	{0x0000001b, 0x474cd180},
	{0x0000001b, 0x50000000},	{0x0000001b, 0x59c2f100},	{0x0000001b, 0x64b6cb00},	{0x0000001b, 0x7100c480},
	{0x0000001b, 0x7eca9d80},	{0x0000001a, 0x47219500},	{0x0000001a, 0x4fcf7d80},	{0x0000001a, 0x598c8180},
	{0x0000001a, 0x6479b700},	{0x0000001a, 0x70bc3e80},	{0x0000001a, 0x7e7db900},	{0x00000019, 0x46f67300},
	{0x00000019, 0x4f9f1680},	{0x00000019, 0x59563300},	{0x00000019, 0x643cca00},	{0x00000019, 0x7077e000},
	{0x0000000b, 0x7a120000},	{0x0000000a, 0x447b8c00},	{0x0000000a, 0x4cd6b480},	{0x0000000a, 0x5636e780},
	{0x0000000a, 0x60bbf900},	{0x0000000a, 0x6c899d80},	{0x0000000a, 0x79c7fd00},	{0x00000009, 0x44520180},
	{0x00000009, 0x4ca81e00},	{0x00000009, 0x5602a180},	{0x00000009, 0x60814b80},	{0x00000009, 0x6c47cf00},
	{0x00000009, 0x797e1d80},	{0x00000008, 0x44289500},	{0x00000008, 0x4c79a380},	{0x00000008, 0x55ce7580},
	{0x00000008, 0x6046c800},	{0x00000008, 0x6c062080},	{0x00000008, 0x79347400},	{0x00000007, 0x43ff4180},
	{0x00000007, 0x4c4b4000},	{0x00000007, 0x559a6e80},	{0x00000007, 0x600c6180},	{0x00000007, 0x6bc4a180},
	{0x00000007, 0x78eaf700},	{0x00000006, 0x43d60280},	{0x00000006, 0x4c1cfe00},	{0x00000006, 0x55668180},
	{0x00000006, 0x5fd22580},	{0x00000006, 0x6b834a00},	{0x00000006, 0x78a19e00},	{0x00000005, 0x43ace180},
	{0x00000005, 0x4beed280},	{0x00000005, 0x5532ba00},	{0x00000005, 0x5f980c80},	{0x00000005, 0x6b421280},
	{0x00000005, 0x78587a80},	{0x00000004, 0x4383d400},	{0x00000004, 0x4bc0c880},	{0x00000004, 0x54ff1200},
	{0x00000004, 0x5f5e1000},	{0x00000004, 0x6b010a80},	{0x00000004, 0x780f8280},	{0x00000003, 0x435ae980},
	{0x00000003, 0x4b92d500},	{0x00000003, 0x54cb8300},	{0x00000003, 0x5f243d80},	{0x00000003, 0x6ac02980},
	{0x00000003, 0x77c6b780},	{0x00000002, 0x43320980},	{0x00000002, 0x4b650300},	{0x00000002, 0x54981980},
	{0x00000002, 0x5eea8e00},	{0x00000002, 0x6a7f7080},	{0x00000002, 0x777e0700},	{0x00000001, 0x43094b80},
	{0x00000001, 0x4b374c80},	{0x00000001, 0x5464cf80},	{0x00000001, 0x5eb10180},	{0x00000001, 0x6a3ecf00},
	{0x00000001, 0x77359400},	{0x00000000, 0x42e0a680},	{0x00000000, 0x4b09b180},	{0x00000000, 0x5431a400},
	{0x00000000, 0x5e778a80},	{0x00000000, 0x69fe6400},	{0x00000000, 0x76ed4d00},	{0xffffffff, 0x42b81a00},
	{0xffffffff, 0x4adc3280},	{0xffffffff, 0x53fe8b80},	{0xffffffff, 0x5e3e4380},	{0xffffffff, 0x69be2000},
	{0xffffffff, 0x76a53180},	{0xfffffffe, 0x428fa600},	{0xfffffffe, 0x4aaec480},	{0xfffffffe, 0x53cb9e80},
	{0xfffffffe, 0x5e051f80},	{0xfffffffe, 0x697e0300},	{0xfffffffe, 0x765d4200},	{0xfffffffd, 0x42674180},
	{0xfffffffd, 0x4a817c80},	{0xfffffffd, 0x5398d000},	{0xfffffffd, 0x5dcc1e00},	{0xfffffffd, 0x693e0d00},
	{0xfffffffd, 0x76156d00},	{0xfffffffc, 0x423efe80},	{0xfffffffc, 0x4a545000},	{0xfffffffc, 0x53662080},
	{0xfffffffc, 0x5d933f80},	{0xfffffffc, 0x68fe2e80},	{0xfffffffc, 0x75cdd480},	{0xfffffffb, 0x4216d400},
	{0xfffffffb, 0x4a273f00},	{0xfffffffb, 0x53339000},	{0xfffffffb, 0x5d5a7580},	{0xfffffffb, 0x68be8600},
	{0xfffffffb, 0x75866780},	{0xfffffffa, 0x41eec200},	{0xfffffffa, 0x49fa4900},	{0xfffffffa, 0x53011180},
	{0xfffffffa, 0x5d21db80},	{0xfffffffa, 0x687f0400},	{0xfffffffa, 0x753f2580},	{0xfffffff9, 0x41c6c800},
	{0xfffffff9, 0x49cd6400},	{0xfffffff9, 0x52cebe00},	{0xfffffff9, 0x5ce96400},	{0xfffffff9, 0x683fa880},
	{0xfffffff9, 0x74f80f00},	{0xfffffff8, 0x419edd00},	{0xfffffff8, 0x49a0a500},	{0xfffffff8, 0x529c8900},
	{0xfffffff8, 0x5cb10e80},	{0xfffffff8, 0x68007380},	{0xfffffff8, 0x74b11300},	{0xfffffff7, 0x41771400},
	{0xfffffff7, 0x49740080},	{0xfffffff7, 0x526a7280},	{0xfffffff7, 0x5c78db80},	{0xfffffff7, 0x67c15600},
	{0xfffffff7, 0x746a5280},	{0xfffffff6, 0x414f6280},	{0xfffffff6, 0x49477780},	{0xfffffff6, 0x52387a00},
	{0xfffffff6, 0x5c40bd00},	{0xfffffff6, 0x67826d80},	{0xfffffff6, 0x7423bd00},	{0xfffffff5, 0x4127c980},
	{0xfffffff5, 0x491b0980},	{0xfffffff5, 0x52069480},	{0xfffffff5, 0x5c08ce00},	{0xfffffff5, 0x6743ab80},
	{0xfffffff5, 0x73dd5280},	{0xfffffff4, 0x41004880},	{0xfffffff4, 0x48eeac00},	{0xfffffff4, 0x51d4d900},
	{0xfffffff4, 0x5bd10100},	{0xfffffff4, 0x67050f00},
};
...
//		g_qstQStepLUT[ iQSS-QSTEP_LUT_MIN ] = FASTFLOAT_FROM_FLOAT( (Float)voWMAPow2((Int)(42.5 * iQSS)) );//42.5=0.05*850
...
QuantStepType qstCalcQuantStep( const Int iQSS, const Int cLeftShiftBits )
{
 ...
 //       catchFP();
        ...
        fflt = FASTFLOAT_FROM_FLOAT( (Float)voWMAPow2((Int)(42.5 * iQSS)) );//42.5=0.05*850
                             ...
                             Bool fInvertSuperGroupXform)
{
    ...
    {
        iChSrc = pau->m_rgiChInTile [iCh];
		if(!((pau->m_rgpcinfo + iChSrc)->m_iPower == 0))fAllSkip = WMAB_FALSE;
