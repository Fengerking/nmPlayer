...
CCTCFLAGS:=-fno-exceptions -Wno-multichar -msoft-float -fpic -ffunction-sections -fdata-sections -funwind-tables -fstack-protector -Wa,--noexecstack -Werror=format-security -fno-short-enums -Wno-unused-but-set-variable -fno-builtin-sin -fno-strict-volatile-bitfields -Wno-psabi -mthumb-interwork -Wstrict-aliasing=2 -fgcse-after-reload -frerun-cse-after-loop -frename-registers -fvisibility-inlines-hidden -DANDROID -fmessage-length=0 -W -Wall -Wno-unused -Winit-self -Wpointer-arith -Wsign-promo -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -mthumb -fomit-frame-pointer -fno-strict-aliasing

LIBGCCA:=$(TCROOTPATH)/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.6/lib/gcc/arm-linux-androideabi/4.6.x-google/armv7-a/libgcc.a
...
VOCFLAGS+=-DNDEBUG -UDEBUG -O3 -D_LINUX_ANDROID 
endif

VOCFLAGS+=$(VOPREDEF) $(VOMM) -fsigned-char -fno-leading-underscore -fpic -fPIC -pipe -ftracer -fforce-addr -fno-bounds-check 
