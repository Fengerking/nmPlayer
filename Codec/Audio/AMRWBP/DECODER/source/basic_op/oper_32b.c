...
/*****************************************************************************
 *                                                                           *
 *   Function Name : voAMRWBPDecDiv_32                                                  *
 *                                                                           *
 *   Purpose :                                                               *
...
Word32 voAMRWBPDecDiv_32 (Word32 L_num, Word16 denom_hi, Word16 denom_lo)
{
    ...
    voAMRWBPDecL_Extract (L_32, &hi, &lo);
    ...
    voAMRWBPDecL_Extract (L_32, &hi, &lo);
    voAMRWBPDecL_Extract (L_num, &n_hi, &n_lo);
