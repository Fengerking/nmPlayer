...
void init( LOG_HANDLE * ptr_handle );
void uninit( LOG_HANDLE handle );
void print_log( LOG_HANDLE handle , LOG_LEVEL level , int line , const char * str_filename , const char * str_funcname , char * fmt , va_list args );
void set_param( LOG_HANDLE handle , int id , void * param );
...
void voGetLogClientAPI( LOG_API * ptr_api )
{
	...
	ptr_api->print_log = print_log;
	ptr_api->set_param = set_param;
}
