...
VOPREDEF+=-D__VOTT_ARM__ -D__VONJ_GINGERBREAD__ -DHAVE_PTHREADS
TCROOTPATH:=/opt/gingerbread
GCCVER:=4.4.0
...
# for target lib
CCTCRTBEGIN:=$(TCROOTPATH)/prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/android/crtbegin.o
