...
LOOPFOR	
	...
	VLD1.S16       {Q6, Q7}, [r12]!                 ; load 16 x[]
        VQDMULL.S16    Q10, D0, D0                      ;L_tmp1 += excf[] * excf[]
        VQDMULL.S16    Q11, D0, D8                      ;L_tmp  += x[] * excf[]                   
        VQDMLAL.S16    Q10, D1, D1
        VQDMLAL.S16    Q11, D1, D9
        VQDMLAL.S16    Q10, D2, D2
        VQDMLAL.S16    Q11, D2, D10        
        VQDMLAL.S16    Q10, D3, D3
        VQDMLAL.S16    Q11, D3, D11
        VQDMLAL.S16    Q10, D4, D4
        VQDMLAL.S16    Q11, D4, D12
        VQDMLAL.S16    Q10, D5, D5
        VQDMLAL.S16    Q11, D5, D13
        VQDMLAL.S16    Q10, D6, D6
        VQDMLAL.S16    Q11, D6, D14
        VQDMLAL.S16    Q10, D7, D7
        VQDMLAL.S16    Q11, D7, D15
	...
	;r5 --- L_tmp, r6 --- L_tmp1
	MOV            r10, #1
	ADD            r5, r10, r5                     ;L_tmp = (L_tmp << 1) + 1
	ADD            r6, r10, r6                     ;L_tmp1 = (L_tmp1 << 1) + 1
