...
#ifdef _WMV_TARGET_X86_
extern Void_WMV  g_InterpolateFieldMB_MMX (tWMVDecInternalMember *pWMVDec, U8_WMV *pSrc, I32_WMV iSrcStride, 
    U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iXFrac, I32_WMV iYFrac,
    I32_WMV iFilterType, I32_WMV iRndCtrl, I32_WMV iNumRows);
extern Void_WMV g_Interpolate4ByteRow_MMX (tWMVDecInternalMember *pWMVDec, U8_WMV *pSrc, I32_WMV iSrcStride, 
    U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iXFrac, I32_WMV iYFrac,
    I32_WMV iFilterType, I32_WMV iRndCtrl, I32_WMV iNumRows);
extern Void_WMV  g_Interpolate4ByteRowBilinear_MMX(tWMVDecInternalMember *pWMVDec, U8_WMV *pSrc, I32_WMV iSrcStride,
    U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iXFrac, I32_WMV iYFrac,
    I32_WMV iFilterType, I32_WMV iRndCtrl, I32_WMV iNumRows);
extern Void_WMV g_CopyMBRow_MMX (U8_WMV *pSrc, I32_WMV iSrcStride, 
    U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iNumRows);
extern Void_WMV g_FieldBlockSub128_MMX (I16_WMV *pBlock, I32_WMV iNumCoef);
extern Void_WMV g_FieldBlockAdd128_MMX (I16_WMV *pBlock, I32_WMV iNumCoef);
extern Void_WMV g_FieldAddError4x8_MMX (I16_WMV *pSrc, U8_WMV *pDst, I32_WMV iDstOffset);
extern Void_WMV g_Copy4ByteRow_MMX (U8_WMV *pSrc, I32_WMV iSrcStride,  U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iNumRows) ;
extern Void_WMV g_FieldAddError8x8_MMX (I16_WMV *pSrc, U8_WMV *pDst, I32_WMV iDstOffset);
extern Void_WMV  g_inverseIntraBlockQuantizeInterlaceV2_SSE1(I16_WMV *piCoefRecon, I32_WMV iNumCoef, DQuantDecParam *pDQ);
extern Void_WMV g_InvOverlapVerticalEdge_SSE1(I16_WMV *pOverlapBuffer, I32_WMV iOverlapBufferStride, I32_WMV iNumPixels);
#endif
#endif 

#ifndef WMV9_SIMPLE_ONLY
/*static I32_WMV medianof3 (I32_WMV a0, I32_WMV a1, I32_WMV a2)
{
	if (a0 > a1) {
		if (a1 > a2)
			return a1;
    ...
    I32_WMV* iPredX, I32_WMV* iPredY, I16_WMV* pFieldMvX, I16_WMV* pFieldMvY, Bool_WMV bTopBndry)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(PredictFieldBotMV);
    ...
    I32_WMV* iPredX, I32_WMV* iPredY, I16_WMV* pFieldMvX, I16_WMV* pFieldMvY, Bool_WMV bTopBndry)
{
    ...
    I32_WMV iMaxX = pWMVDec->m_uintNumMBX * 2 * 8 * 4 - 4;  // x8 for block x4 for qpel
    I32_WMV iMaxY = pWMVDec->m_uintNumMBY * 2 * 8 * 4 - 4;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(PredictFieldTopMV);
    ...
    I32_WMV* iPredX, I32_WMV* iPredY, I16_WMV* pFieldMvX, I16_WMV* pFieldMvY, Bool_WMV bTopBndry)
{
    ...
    I32_WMV iMaxX = pWMVDec->m_uintNumMBX * 2 * 8 * 4 - 4;  // x8 for block x4 for qpel
    I32_WMV iMaxY = pWMVDec->m_uintNumMBY * 2 * 8 * 4 - 4;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(PredictFieldOneMV);
    ...
    I32_WMV imbX, I32_WMV imbY, I32_WMV iMvX, I32_WMV iMvY, I32_WMV *iChromaMvX, I32_WMV *iChromaMvY)
{
    ...
    I32_WMV iX0, iY0;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ChromaMVInterlace411);
...
{
    I32_WMV i, j;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyPixelCToPixelIBlock);
    for (i = 0; i < iNumY; i++) {
        for (j = 0; j < iNumX; j++) {
...
{
    I32_WMV y, x;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyPixelIToPixelCBlock);
    for (y = 0; y < iNumY; y++) {
        for (x = 0; x < iNumX; x++) {    
...
{
    I32_WMV y, x;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyPixelIToPixelIBlock);
    for (y = 0; y < iNumY; y++) {
        for (x = 0; x < iNumX; x++) {    
            pDst [x] = pSrc [x];            
        }
...
{
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ClearFieldMBInterlace411);
    if (iField == 2) {
...
{
    // Y0
    U8_WMV *pSrc = ppxliFrameMBY;
    I16_WMV *pDst = ppxliFieldMB;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyTopFieldToIntraFieldMBInterlace411);

    CopyPixelCToPixelIBlock (pSrc, pDst, 2*16, 8, 8, 8);

    // Y1
    pSrc = ppxliFrameMBY + 8;
    pDst = ppxliFieldMB + 64;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*16, 8, 8, 8);

    // U0
    pSrc = ppxliFrameMBU;
    pDst = ppxliFieldMB + 4 * 64;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*4, 4, 8, 4);

    // V0
    pSrc = ppxliFrameMBV;
    pDst = ppxliFieldMB + 5 * 64;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*4, 4, 8, 4);
}
...
{
    // Y1
    U8_WMV *pSrc = ppxliFrameMBY + 16;
    I16_WMV *pDst = ppxliFieldMB + 2 * 64;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyBotFieldToIntraFieldMBInterlace411);

    CopyPixelCToPixelIBlock (pSrc, pDst, 2*16, 8, 8, 8);

    // Y2 
    pSrc = ppxliFrameMBY + 16 + 8;
    pDst = ppxliFieldMB + 3 * 64;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*16, 8, 8, 8);

    // U1
    pSrc = ppxliFrameMBU + 4;
    pDst = ppxliFieldMB + 4 * 64 + 4 * 8;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*4, 4, 8, 4);

    // V1
    pSrc = ppxliFrameMBV + 4;
    pDst = ppxliFieldMB + 5 * 64 + 4 * 8;
    CopyPixelCToPixelIBlock (pSrc, pDst, 2*4, 4, 8, 4);
}
...
Void_WMV CopyFrameMBtoIntraFieldMBInterlace411 (
    ...
    U8_WMV *ppxliFrameMBU, U8_WMV *ppxliFrameMBV)
{     
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyFrameMBtoIntraFieldMBInterlace411);

    CopyPixelCToPixelIBlock (ppxliFrameMBY, ppxliFieldMB, 16, 8, 8, 8);
    CopyPixelCToPixelIBlock (ppxliFrameMBY + 8, ppxliFieldMB + 64, 16, 8, 8, 8);
    CopyPixelCToPixelIBlock (ppxliFrameMBY + 8*16, ppxliFieldMB + 2 * 64, 16, 8, 8, 8);
    CopyPixelCToPixelIBlock (ppxliFrameMBY + 8*16 + 8, ppxliFieldMB + 3 * 64, 16, 8, 8, 8);
    CopyPixelCToPixelIBlock (ppxliFrameMBU, ppxliFieldMB + 4 * 64, 8, 8, 8, 8);
    CopyPixelCToPixelIBlock (ppxliFrameMBV, ppxliFieldMB + 5 * 64, 8, 8, 8, 8);
}
    ...
    U8_WMV *ppxliFrameMBV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyIntraFieldMBtoTopFieldInterlace411);
    ...
    U8_WMV *ppxliFrameMBV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyIntraFieldMBtoBotFieldInterlace411);
...
{
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyIntraFieldMBtoFrameMBInterlace411);
...
{
    I32_WMV y, x;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyPixelIToPixelIBlock_8x8);
    for (y = 0; y < 8; y++) {
        for (x = 0; x < 4; x++) {    
...
Void_WMV CopyFrameMBtoInterFieldMBInterlace411 (
    I16_WMV *ppxliFieldMB, I16_WMV *ppxliFrameMBY, I16_WMV *ppxliFrameMBU, 
    I16_WMV *ppxliFrameMBV)
{        
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyFrameMBtoInterFieldMBInterlace411);
...
{        
    I16_WMV *pSrc;
    I16_WMV *pDst;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyTopFieldMBtoInterFieldMBInterlace411);

    pSrc = ppxliFrameMBY;
    pDst = ppxliFieldMB;
	CopyPixelIToPixelIBlock_8x8 (pSrc, pDst, 2*16, 8);
	    CopyPixelIToPixelIBlock_8x8 (ppxliFrameMBY + 8, ppxliFieldMB + 64, 2*16, 8);

  //  CopyPixelIToPixelIBlock (ppxliFrameMBY + 8, ppxliFieldMB + 64, 2*16, 8, 8, 8);

    // U0
    pSrc = ppxliFrameMBU;
    pDst = ppxliFieldMB + 4 * 64;
    CopyPixelIToPixelIBlock (pSrc, pDst, 2*4, 4, 8, 4 );
...
{        
    I16_WMV *pSrc;
    I16_WMV *pDst;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyBotFieldMBtoInterFieldMBInterlace411);
    ...
    I16_WMV *ppxliFrameMBV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyInterFieldMBtoTopFieldMBInterlace411);
    ...
    I16_WMV *ppxliFrameMBV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(CopyInterFieldMBtoBotFieldMBInterlace411);
    ...
    U8_WMV *ppxlcCurrV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    U8_WMV *pDst;
    I16_WMV *pSrc;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(AddErrorFrameInterlace411);
    ...
    U8_WMV *ppxlcCurrV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    U8_WMV *pDst;
    I16_WMV *pSrc;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(AddErrorTopFieldInterlace411);
    // Y0
    pDst = ppxlcCurrY;
    pSrc = ppxliFieldMB;
    ...
    U8_WMV *ppxlcCurrV, I32_WMV iOffsetY, I32_WMV iOffsetUV)
{
    U8_WMV *pDst;
    I16_WMV *pSrc;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(AddErrorBotFieldInterlace411);
    ...
    U8_WMV* ppxliReconY, U8_WMV* ppxliReconU, U8_WMV* ppxliReconV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompFrameInterlace411);
    ...
    U8_WMV* ppxliReconY, U8_WMV* ppxliReconU, U8_WMV* ppxliReconV, MBType mbType)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompFrameInterlace411_BFrame);
...

{
	...
	I32_WMV iMvYinterp = pWMVDec->m_pB411InterpY [iMvIndex];
	I32_WMV iChromaMvXinterp, iChromaMvYinterp;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompTopFieldInterlace411_BFrame);
...
{ 
	...
	I32_WMV iMvYinterp = pWMVDec->m_pB411InterpY [iMvIndex];
	I32_WMV iChromaMvXinterp, iChromaMvYinterp;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompBotFieldInterlace411_BFrame);
    ...
    U8_WMV* ppxliReconY, U8_WMV* ppxliReconU, U8_WMV* ppxliReconV)
{
    ...
    I32_WMV iMvY = pWMVDec->m_pYMotion [iMvIndex];
    I32_WMV iChromaMvX, iChromaMvY;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompTopFieldInterlace411);
...
{ 
    ...
    I32_WMV iMvY = pWMVDec->m_pYMotion [iMvIndex];
    I32_WMV iChromaMvX, iChromaMvY;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(MotionCompBotFieldInterlace411);
...
{
    I32_WMV i, j;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_FieldAddError8x8);
    for (i = 0; i < 8; i++) {
        for (j = 0; j < 8; j++) {
...
{
    I32_WMV i, j;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_FieldAddError4x8);
    for (i = 0; i < 8; i++) {
        for (j = 0; j < 4; j++) {
            I16_WMV iTmp = pSrc [j] + pDst [j];
            iTmp = CLIP (iTmp);
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_FieldBlockSub128);
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_FieldBlockAdd128);
    for (i = 0; i < iNumCoef; i++) {
        pBlock [i] += 128;
    }
}
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_CopyMBRow);
...
#endif // !(defined(WMV9_SIMPLE_ONLY) || defined(WMV789_ONLY))

Void_WMV g_Copy4ByteRow (U8_WMV *pSrc, I32_WMV iSrcStride, 
    U8_WMV *pDst, I32_WMV iDstStride, I32_WMV iNumRows)
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_Copy4ByteRow);
    for (i = 0; i < iNumRows; i++) {
        memcpy (pDst, pSrc, 4);
        pDst += iDstStride;
        pSrc += iSrcStride;
...
{     
    ...
    const I16_WMV *pH;
    const I16_WMV *pV;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_InterpolateFieldMB);
    ...
    if (iXFrac == 0 && iYFrac == 0) {
        ...
        I16_WMV* pF = (I16_WMV*) (((DWORD_PTR)pFilter + 31) & ~31); // reset
        ...
        pF = (I16_WMV*) (((DWORD_PTR)pFilter + 31) & ~31); // reset        
        for (i = 0; i < iNumRows; i++) {
            for (j = 0; j < 16; j++) {
...
{     
    ...
    const I16_WMV *pH;
    const I16_WMV *pV;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(g_Interpolate4ByteRow);
...
{
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(InitFieldInterpolation);
    ...
    {
        pWMVDec->m_pInterpolateMBRow = g_InterpolateFieldMB_MMX;
        pWMVDec->m_pInterpolate4ByteRow = g_Interpolate4ByteRow_MMX;
        pWMVDec->m_pInterpolate4ByteRowBilinear = g_Interpolate4ByteRowBilinear_MMX;
        pWMVDec->m_pCopyMBRow = g_CopyMBRow_MMX;
        pWMVDec->m_pFieldBlockSub128 = g_FieldBlockSub128_MMX;
        pWMVDec->m_pFieldBlockAdd128 = g_FieldBlockAdd128_MMX;
        pWMVDec->m_pFieldAddError8x8 = g_FieldAddError8x8_MMX;
        pWMVDec->m_pFieldAddError4x8 = g_FieldAddError4x8_MMX;
	}
/*
    if (g_SupportSSE2 ())
    {
        pWMVDec->m_pInterpolateMBRow = g_InterpolateFieldMB_SSE2;       
    }
*/
#endif
#endif
    ...
    U8_WMV* ppxliY, U8_WMV* ppxliU, U8_WMV* ppxliV)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(LoopFilterIFrameInterlace411);
