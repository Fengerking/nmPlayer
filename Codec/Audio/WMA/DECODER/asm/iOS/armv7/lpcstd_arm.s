...
@ This optimization does not seem like much, but improves overall performance 2.2% (16_16m8) to 3.7% (22_32s4) 
    ...
    .globl  _InverseQuadRootOfSumSquares
    .globl  _prvDoLpc4

    .globl  _g_InvQuadRootFraction
    .globl  _g_InvQuadRootExponent
    .globl  _gLZLTable
...
pg_InvQuadRootExponent:  .word       _g_InvQuadRootExponent
pg_InvQuadRootFraction:  .word       _g_InvQuadRootFraction
pgLZLTable:              .word       _gLZLTable
...
@ 818  :     pWF[k]           = InverseQuadRootOfSumSquares(D, E)@              // F[j]
    ...
    bl        _InverseQuadRootOfSumSquares           @ InverseQuadRootOfSumSquares(D, E)
    ldr       r6k, [sp, #offk]
    ldr       r1, [sp, #offT4]                      @ T4
    @@;1 cycle for armv6
