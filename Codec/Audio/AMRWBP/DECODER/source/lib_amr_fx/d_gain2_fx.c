...
static const Word16 pdown_unusable[7] = {32767, 31130, 29491, 24576, 7537, 1638, 328};
static const Word16 cdown_unusable[7] = {32767, 16384, 8192, 8192, 8192, 4915, 3277};

static const Word16 pdown_usable[7] = {32767, 32113, 31457, 24576, 7537, 1638, 328};
static const Word16 cdown_usable[7] = {32767, 32113, 32113, 32113, 32113, 32113, 22938};
...
)
{
    ...
    L_tmp = voAMRWBPDecDot_product12(code, code, L_subfr, &exp);
    ...
    gcode0 = extract_l(voAMRWBPDecPow2(14, frac));    /* Put 14 as exponant so that  */
    ...
    *prev_gc = *past_gain_code;            
    ...
    /* adjust gain according to energy of code */
    voAMRWBPDecL_Extract(*gain_cod, &exp, &frac);
    ...
    *gain_cod = L_shl(L_tmp, 3);           move32();  /* gcode_inov in Q12 */
    ...
    voAMRWBPDecLog2(L_tmp, &exp, &frac);
    exp = sub(exp, 11);
