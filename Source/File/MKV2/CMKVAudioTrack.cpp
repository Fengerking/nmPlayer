...
CMKVAudioTrack::CMKVAudioTrack( VO_U8 btStreamNum, VO_U32 dwDuration , TracksTrackEntryStruct * pAudioInfo , VO_MEM_OPERATOR* pMemOp )
:CMKVTrack( VOTT_AUDIO , btStreamNum , dwDuration , pAudioInfo , pMemOp )
...
*/
	result = CMKVTrack::GetSampleN( pSample );
