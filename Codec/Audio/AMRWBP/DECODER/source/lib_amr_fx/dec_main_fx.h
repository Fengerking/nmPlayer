...
#include "cnst_wb_fx.h"                          /* coder constant parameters */
#include "dtx_fx.h"
typedef struct
{
    ...
    Word16 padding1;                     //shanrong added for alignment
    ...
    Word16 mem_oversamp_hf_plus[2 * L_FILT];
    Word16 mem_syn_hf_plus[8];
    Word16 lpc_hf_plus[9];
    Word16 gain_hf_plus;
    Word32 threshold_hf;
    Word32 lp_amp_hf;
    Word16 ramp_state;
