    ...
    .globl  _ARMV7_g_NewVertFilterX
    .globl  _ARMV7_g_NewHorzFilterX
	.globl  _ARMV7_g_NewVertFilter0LongNoGlblTbl
    .globl  _ARMV7_g_InterpolateBlock_00_SSIMD
    .globl  _ARMV7_g_AddNull_SSIMD
    .globl  _ARMV7_g_InterpolateBlockBilinear_SSIMD 
    .globl  _ARMV7_g_InterpolateBlockBilinear_SSIMD_11
    .globl  _ARMV7_g_InterpolateBlockBilinear_SSIMD_01
    .globl  _ARMV7_g_InterpolateBlockBilinear_SSIMD_10
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	WMV_LEAF_ENTRY VFX_extra_data_for_HFX
...
@r14 == i
    ...
    bl		_ARMV7_g_InterpolateBlock_00_SSIMD		@@@@@@@
    add		sp, sp, #12
