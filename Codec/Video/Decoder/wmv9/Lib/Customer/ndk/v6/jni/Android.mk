...
VOMM:= -DVOARMV6 -DARM -D_ARM_ -D__arm -DLINUX -D_LINUX_ANDROID -D_VOLOG_INFO -D_VOLOG_ERROR -D__VO_NDK__ -DNDEBUG

LOCAL_CFLAGS := -D_VOMODULEID=0x02060000   -DNDEBUG -march=armv6j -mtune=arm1136jf-s -mfpu=vfp -fsigned-char -mfloat-abi=soft
