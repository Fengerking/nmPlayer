...
;***********************************************************************/
	...
	EXPORT |voyuv420torgb32_8nx2n_armv7|
	EXPORT |voyuv420toargb32_8nx2n_armv7|
	EXPORT |voyuv420torgb32_8nx2n_armv7_new|
	EXPORT |voyuv420toargb32_8nx2n_armv7_new|
...
RGB32_Width_loop_new
  ...
  vqrshrun.s16    d24, q9,  #6 ;r
  vqrshrun.s16    d28, q10, #6 ;g
  vqrshrun.s16    d25, q11, #6 ;b
  pld             [r0]	
  vzip.u8         d25, d29   ;
  vzip.u8         d24, d28   ;
...
;Y TOP ROW odd
  ...
  vqrshrun.s16    d26, q9,  #6 ;r
  vqrshrun.s16    d27, q11, #6 ;b
  vqrshrun.s16    d30, q10, #6 ;g
...
ARGB32_Width_loop		
	...
	ENDP  
		...
		ALIGN 4
coefficients
    DCW   -14240  ;/* bias_r = 74 * (-16)+ (102 * -128) */                    
    DCW     8672  ;/* bias_g = 74 * (-16) -  25 * (-128) - ( 52 * -128) */
    DCW   -17696  ;/* bias_b = 74 * (-16) + 129 * (-128)*/
    DCW   0
