...
@//************************************************************************
    ...
    .globl  _g_NewVertFilterX
    .globl  _g_NewHorzFilterX
    @.globl _g_NewVertFilter0Long
	.globl  _g_NewVertFilter0LongNoGlblTbl
    .globl  _g_InterpolateBlock_00_SSIMD
    .globl  _g_AddNull_SSIMD
    .globl  _g_AddNullB_SSIMD
    .globl  _g_InterpolateBlockBilinear_SSIMD 
    .globl  _g_InterpolateBlockBilinear_SSIMD_11
    .globl  _g_InterpolateBlockBilinear_SSIMD_01
    .globl  _g_InterpolateBlockBilinear_SSIMD_10
    .globl  _g_Prefetch
    .globl  _IntensityComp

    .if _WMMX_==1
    
    .globl  _g_InterpolateBlockBicubic_WMMX_Copyy       @ not turn on yet
    .globl  _g_InterpolateBlockBicubic_WMMX_vertical
    .globl  _g_InterpolateBlockBicubic_WMMX_horizontal
    .globl  _g_InterpolateBlockBicubic_WMMX_VerHor
    .globl  _g_AddError_WMMX
...
iAlign                      .req  r9
temp                        .req  r12
.set VHsaveRegistersOffset       , 36
@pHOffset                    , VHsaveRegistersOffset + 0
.set VHpVOffset                    , VHsaveRegistersOffset + 4
.set VHiShiftOffset                , VHsaveRegistersOffset + 8
.set iRound1Offset               , VHsaveRegistersOffset + 12
.set iRound2Offset               , VHsaveRegistersOffset + 16
...
temp                        .req  r12
@saveRegistersOffset         equ 36
pVOffset                    equ sarveRegistersOffset + 0
@iShiftOffset                equ sraveRegistersOffset + 4
@iRoundOffset                equ saveRegistersOffset + 8
@ wR0, wR15             :   dst
...
@@ stack usage
.set IBB_StackSize              , 0x24
.set IBB_OffsetRegSaving        , 0x24

.set IBB_Offset_iYFrac          , IBB_StackSize + IBB_OffsetRegSaving + 0
.set IBB_Offset_iRndCtrl        , IBB_StackSize + IBB_OffsetRegSaving + 4
.set IBB_Offset_b1MV            , IBB_StackSize + IBB_OffsetRegSaving + 8
...
@ stack usage:
.set IBB_11_OffsetRegSaving        , 36
.set IBB_11_Offset_iYFrac          , IBB_11_OffsetRegSaving + 0
.set IBB_11_Offset_iRndCtrl        , IBB_11_OffsetRegSaving + 4
.set IBB_11_Offset_b1MV            , IBB_11_OffsetRegSaving + 8
...
@ stack usage:
.set IBB_10_OffsetRegSaving        , 32
.set IBB_10_Offset_iYFrac          ,IBB_10_OffsetRegSaving + 0
.set IBB_10_Offset_iRndCtrl        ,IBB_10_OffsetRegSaving + 4
.set IBB_10_Offset_b1MV            ,IBB_10_OffsetRegSaving + 8
...
@ stack usage:
.set IBB_01_OffsetRegSaving        ,	36
.set IBB_01_Offset_iYFrac          ,	IBB_01_OffsetRegSaving + 0
.set IBB_01_Offset_iRndCtrl        ,	IBB_01_OffsetRegSaving + 4
.set IBB_01_Offset_b1MV            ,	IBB_01_OffsetRegSaving + 8
...
@@ stack usage:
.set VFX_StackSize              , 0xc
.set VFX_OffsetRegSaving        , 0x24
.set VFX_Stack_iNumHorzLoop   , 0
.set VFX_Stack_iNumInnerLoop  , 4
.set VFX_Stack_v2             , 0x8
@VFX_Stack_pDstUpdate     equ 0xc
@VFX_Stack_pSrcUpdate     equ 0x10


.set VFX_Offset_iRound32        , VFX_StackSize + VFX_OffsetRegSaving + 0
.set VFX_Offset_pV              , VFX_StackSize + VFX_OffsetRegSaving + 4
.set VFX_Offset_iNumHorzLoop    , VFX_StackSize + VFX_OffsetRegSaving + 8
.set VFX_Offset_uiMask          , VFX_StackSize + VFX_OffsetRegSaving + 0xc
.set VFX_Offset_b1MV            , VFX_StackSize + VFX_OffsetRegSaving + 0x10
.set VFX_Offset_pTbl	             , VFX_StackSize + VFX_OffsetRegSaving + 0x14
...
@@ stack usage:
.set HFX_StackSize         , 0x10
.set HFX_OffsetRegSaving   , 0x24

.set HFX_Offset_b1MV       , HFX_StackSize + HFX_OffsetRegSaving + 0

.set HFX_Stack_iNumLoops   , 0
.set HFX_Stack_j           , 4
.set HFX_Stack_pFUpdate    , 8
.set HFX_Stack_iRound2_32  , 12
...
.set ANBE_OffsetRegSaving   ,0x24
.set ANBE_Offset_iPitch          ,ANBE_OffsetRegSaving + 0
