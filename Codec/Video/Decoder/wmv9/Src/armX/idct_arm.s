...
;//*************************************************************************
    ...
    EXPORT  g_IDCTDec_WMV2_Intra            ; intr8x8
    EXPORT  g_IDCTDec16_WMV2                ; intra8x8X8    
    EXPORT  g_IDCTPass1_WMV2                ; interHor
    EXPORT  g_IDCTPass2_WMV2                ; interVer
    EXPORT  g_IDCTDec_WMV2_16bit            ; inter8x8
    EXPORT  g_8x4IDCTDec_WMV2_16bit         ; inter8x4
    EXPORT  g_4x8IDCTDec_WMV2_16bit         ; inter4x8
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    IF ARCH_V3 = 1
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        MACRO             
        STORETWO16bits $dstRN, $offset, $srcRN1, $srcRN2 ; Hi: RN2; Lo: RN1
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        MACRO
        STORETOne16bits $dstRN, $srcRN, $offsetLo, $offsetHi 
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        MACRO             
        LOADTWO16bits $srcRN, $offset, $dstRN1, $dstRN2 ; Hi: RN2; Lo: RN1
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO                   
    Hor8x1IDCT32BitLoad $srcRN ; result: r0 - r7       
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    LDR     r0, [$srcRN]
    LDR     r4, [$srcRN, #4]
    LDR     r3, [$srcRN, #8]
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO                   
    Hor8x1IDCT16BitLoad $srcRN ; result: r0 - r7       
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    IF ARCH_V3 = 1
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO                   
    Hor8x1IDCT_stage1234            ;Input: r0 - r7; Ouput: r5 - r12
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;;;;;;;;;; first stage
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO                   
    Ver1x8IDCT16BitLoad $srcRN ; result: r0 - r7       
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    IF ARCH_V3 = 1
        AND     r0, $srcRN, #3
        CMP     r0, #0
...
OutOfVerLoad
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO                   
    Ver1x8IDCT32BitLoad $srcRN, $iOffsetToNextRowForDCT ;result: r0 - r7       
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO
    Ver1x8IDCT_stage4_Store $destRN ;
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;;;;;;;;;;; fourth stage
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MACRO
    HorVer4x1IDCT     ; input: r4 - r7; output: r0 - r3; r10 - r12L: coefs
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ADD     r0, r4, r6              ; x4 + x6
