...
/* local function */
static Word16 Chebps2(Word16 x, Word16 f[], Word32 n);
...
static Word16 Chebps2(Word16 x, Word16 f[], Word32 n)
{
	...
	t0 = L_add(t0, t0);                     /* Q24 to Q30 with saturation */
	t0 = L_add(t0, t0);
	t0 = L_add(t0, t0);
	t0 = L_add(t0, t0);
	t0 = L_add(t0, t0);
