...
tWMVDecodeStatus decodeIInterlace411 (tWMVDecInternalMember *pWMVDec)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeIInterlace411);
    ...
    CWMVMBMode* pmbmd, I32_WMV imbX, I32_WMV imbY, I32_WMV iCBPCY) 
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ComputePredCBPCY);
    ...
    CWMVMBMode* pmbmd, I32_WMV imbX, I32_WMV imbY)
{
    I32_WMV iCBPCY; 
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeFrameIMBOverheadInterlace411);
    ...
    for (iBlk = 4; iBlk < 6; iBlk++) {
        if (pmbmd->m_rgbCodedBlockPattern2 [iBlk]) {
            if (BS_getBit(pWMVDec->m_pbitstrmIn) == 0) {
                ...
                COVERAGE_SUBBLKPATUV (pWMVDec, iBlk, CV_SUBBLKPATUV_RIGHT);
            } else if (BS_getBit(pWMVDec->m_pbitstrmIn) == 1) {
                pmbmd->m_rgbCodedBlockPattern2 [iBlk] = 2; // Left
                COVERAGE_SUBBLKPATUV (pWMVDec, iBlk, CV_SUBBLKPATUV_LEFT);
            } else {
                pmbmd->m_rgbCodedBlockPattern2 [iBlk] = 1; // Both
                COVERAGE_SUBBLKPATUV (pWMVDec, iBlk, CV_SUBBLKPATUV_BOTH);
            }
        }
    }
    ...
    CWMVMBMode* pmbmd, I32_WMV imbX, I32_WMV imbY)
{
    I32_WMV iCBPCY; 
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeFieldIMBOverheadInterlace411);
    ...
    Bool_WMV bAcPredOn)
{
    ...
    I16_WMV *ppxliDst;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeIntraBlockYInterlace411);
    ...
    Bool_WMV bAcPredOn)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeIntraBlockUVInterlace411);
    ...
    U8_WMV *ppxliTextureQMBU, U8_WMV *ppxliTextureQMBV)
{
    ...
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeFrameIMBInterlace411);
    ...
    U8_WMV *ppxliTextureQMBU, U8_WMV *ppxliTextureQMBV)
{
    ...
    //I32_WMV *rgiCoefRecon = pWMVDec->m_rgiCoefRecon;          
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeTopFieldIMBInterlace411);
    ...
    {
        if (!pWMVDec->m_iDXVAOn)
            dxvaDumpFieldIMB(pWMVDec->m_ppxliFieldMB, 0);
    }
#endif
    ...
    U8_WMV *ppxliTextureQMBU, U8_WMV *ppxliTextureQMBV)
{
    ...
    //I32_WMV *rgiCoefRecon = pWMVDec->m_rgiCoefRecon;          
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeBotFieldIMBInterlace411);
    ...
    {
        if (!pWMVDec->m_iDXVAOn)
            dxvaDumpFieldIMB(pWMVDec->m_ppxliFieldMB, 1);
    }
#endif
...
{    
    ...
    I32_WMV i ;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(inverseIntraBlockQuantizeInterlace411);
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleTopPredYForDQuantInterlace411);
    if (iBlk == 0 || iBlk == 1) {
        I32_WMV iTmp;
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleLeftPredYForDQuantInterlace411);
    if (iBlk == 0 || iBlk == 2) {
        I32_WMV iTmp;
    ...
    I32_WMV iBlk, CWMVMBMode* pmbmd, I32_WMV *piTopDC, I32_WMV *piLeftDC, I32_WMV *piTopLeftDC)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleDCPredYForDQuantInterlace411);
    if (iBlk == 0) {
        I32_WMV iTmp;
...
{
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleTopPredUVForDQuantInterlace411);
    if (iSubblock == 0) {
        I32_WMV iTmp;
        iTmp = pPred [0] * pWMVDec->m_prgDQuantParam[(pmbmd - pWMVDec->m_uintNumMBX)->m_iQP].iDCStepSize;
        pPredScaled [0] = 
...
{    
    I32_WMV iTmp, i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleLeftPredUVForDQuantInterlace411);
    iTmp = pPred [0] * pWMVDec->m_prgDQuantParam[(pmbmd - 1)->m_iQP].iDCStepSize;
    pPredScaled [0] = 
        (I16_WMV)divroundnearest (iTmp, pWMVDec->m_prgDQuantParam[pmbmd->m_iQP].iDCStepSize);
    for (i = 1; i < 8; i++) {
    ...
    I32_WMV iSubblock, CWMVMBMode* pmbmd, I32_WMV *piTopDC, I32_WMV *piLeftDC, I32_WMV *piTopLeftDC)
{
   I32_WMV iTopDC = *piTopDC; 
    I32_WMV iLeftDC = *piLeftDC;
    I32_WMV iTopLeftDC =*piTopLeftDC;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ScaleDCPredUVForDQuantInterlace411);
    if (iSubblock == 0) {
        I32_WMV iTmp;
        I32_WMV iTopLeftDCStepSize = pWMVDec->m_prgDQuantParam[(pmbmd - pWMVDec->m_uintNumMBX - 1)->m_iQP].iDCStepSize;
        I32_WMV iTopDCStepSize = pWMVDec->m_prgDQuantParam[(pmbmd - pWMVDec->m_uintNumMBX)->m_iQP].iDCStepSize;
    ...
    Bool_WMV bAcPredOn, I16_WMV* piLevelBlk)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeDCACPredUVInterlace411);
    ...
    I32_WMV imbY, I32_WMV imbX, I32_WMV iBlk, CWMVMBMode* pmbmd, Bool_WMV bAcPredOn, I16_WMV* piLevelBlk)
{
    ...
    I32_WMV i;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeDCACPredYInterlace411);
    ...
    I32_WMV imbY, I32_WMV imbX, I32_WMV iBlk, I16_WMV *piLevelBlk)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(StoreDCACPredCoefYInterlace411);
    ...
    I32_WMV imbY, I32_WMV imbX, I32_WMV iBlk, I32_WMV iSubblock, I16_WMV *piLevelBlk)                                                   
{
    ...
    I32_WMV i;
    I16_WMV *pIntra;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(StoreDCACPredCoefUVInterlace411);
...
{
    I32_WMV iDC;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeIntraDCInterlace411);
    ...
    CDCTTableInfo_Dec** ppIntraDCTTableInfo_Dec, U8_WMV* piZigzagInv, U32_WMV uiNumCoef)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeInverseIntraBlockQuantizeInterlace411);
...
tWMVDecodeStatus decodePInterlace411 (tWMVDecInternalMember *pWMVDec)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodePInterlace411);
        ...
        for (imbX = 0; imbX < pWMVDec->m_uintNumMBX; imbX++) {  
            ...
            if (pmbmd->m_chMBMode == MB_1MV) {
                ...
                if (pWMVDec->m_pDiffMV->iIntra) {
                    ...
                    if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
                    {
                        dxvaSet4MVComponents(IBLOCKMV, 0, 0);
                    }
#endif
                ...
                if ((pWMVDec->m_pDiffMV + 2)->iIntra) {
                    ...
                    if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
                    {
                        dxvaSet4MVComponents(IBLOCKMV, 0, 1);
                    }
#endif
    ...
    CWMVMBMode* pmbmd, I32_WMV imbX, I32_WMV imbY)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeFramePMBOverheadInterlace411);
    ...
    CWMVMBMode* pmbmd, I32_WMV imbX, I32_WMV imbY)
{
    ...
    Bool_WMV bSendXformswitchMode = FALSE;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(decodeFieldPMBOverheadInterlace411);
    ...
    CDCTTableInfo_Dec** ppInterDCTTableInfo_Dec, U8_WMV *pZigzagInv, DQuantDecParam *pDQ)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeInverseInterSubblockQuantizeInterlace411);
    ...
    CDCTTableInfo_Dec** ppInterDCTTableInfo_Dec, U8_WMV *pZigzagInv, DQuantDecParam *pDQ)
{
    ...
    I16_WMV *rgiCoefRecon = (I16_WMV*)pWMVDec->m_rgiCoefRecon;
    I32_WMV iDCTHorzFlags = 0;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeInverseInter8x8BlockQuantizeInterlace411);
...
{    
    I32_WMV result;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(Decode8x8Interlace411);
...
{    
    tWMVDecodeStatus result;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(Decode4x8Interlace411);
    ALIGNED32_FASTMEMCLR (pWMVDec->m_rgiCoefRecon, 0, 64*sizeof(I16_WMV));
...
{
    I32_WMV result; 
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(Decode8x4Interlace411);
    ALIGNED32_FASTMEMCLR (pWMVDec->m_rgiCoefRecon, 0, 64*sizeof(I16_WMV));
    result = DecodeInverseInterSubblockQuantizeInterlace411  (pWMVDec,
    ...
    CDCTTableInfo_Dec **ppInterDCTTableInfo_Dec, DQuantDecParam *pDQ)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeInterBlockYInterlace411);
    ...
    U8_WMV *ppxlcRefQYMB, U8_WMV *ppxlcRefQUMB, U8_WMV *ppxlcRefQVMB)
{
    ...
    tWMVDecodeStatus result;
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeTopFieldPMBInterlace411);
...
#ifdef _GENERATE_DXVA_DATA_
    if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
        dxvaDumpFieldResiduals(pWMVDec->m_ppxliFieldMB, 0);
#endif
    ...
    U8_WMV *ppxlcRefQYMB, U8_WMV *ppxlcRefQUMB, U8_WMV *ppxlcRefQVMB)
{
    ...
    tWMVDecodeStatus result;
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeBotFieldPMBInterlace411);
...
#ifdef _GENERATE_DXVA_DATA_
    if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
        dxvaDumpFieldResiduals(pWMVDec->m_ppxliFieldMB, 1);
#endif
    ...
    U8_WMV *ppxlcRefQYMB, U8_WMV *ppxlcRefQUMB, U8_WMV *ppxlcRefQVMB)
{
    ...
    tWMVDecodeStatus result;
    U32_WMV iBlk;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(DecodeFramePMBInterlace411);
...
#ifdef _GENERATE_DXVA_DATA_
    if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
        dxvaDumpFieldResiduals(pWMVDec->m_ppxliFieldMB, 2);
#endif
    ...
    I32_WMV imbX, I32_WMV imbY, CDiffMV *pInDiffMV)
{
    ...
    I32_WMV iIBlock = 0;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ComputeFrameMVFromDiffMVInterlace411);
    ...
    I32_WMV imbX, I32_WMV imbY, CDiffMV *pInDiffMV)
{
    ...
    I32_WMV k = 2 * imbY * iXBlocks + 2 * imbX ;
    I32_WMV iIBlock = 0;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ComputeTopFieldMVFromDiffMVInterlace411);
...
#ifdef _GENERATE_DXVA_DATA_
        if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
            dxvaSet4MVComponents(pWMVDec->m_pXMotion [k], pWMVDec->m_pYMotion [k], 0);
#endif
    ...
    I32_WMV imbX, I32_WMV imbY, CDiffMV *pInDiffMV)
{
    ...
    I32_WMV iIBlock = 0;
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(ComputeBotFieldMVFromDiffMVInterlace411);
...
#ifdef _GENERATE_DXVA_DATA_
        if (pWMVDec->m_pDMO || pWMVDec->m_bDxvaOffLine)
            dxvaSet4MVComponents(pWMVDec->m_pXMotion [k], pWMVDec->m_pYMotion [k], 1);
#endif
    ...
    CWMVMBMode *pmbmd)
{
    ...
    DEBUG_PROFILE_FRAME_FUNCTION_COUNT(LoopFilterPFrameDecInterlace411);
