...
#if !defined __VOPRJ_MTV__ && !defined _VOFLOPLAYER1
...
#else//USA_MOBITV
#include "COMXDataSourcePlayer.h"
#define CVOMEPlayer COMXDataSourcePlayer
#endif//USA_MOBITV
#else // VOPRJ_MTV
#include "CSourcePlayer.h"
#define CVOMEPlayer CSourcePlayer
#endif // VOPRJ_MTV

#endif//defined __VOPRJ_MTV__
...
public:
    ...
    ~vomeplayer();
	    ...
	    //void *	    mkplayer();
			status_t		setWorkingPath(const char* path);
