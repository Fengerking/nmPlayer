...
|vp8_short_inv_walsh4x4_v6| PROC
    ...
    ;asr         r12, r2, #3          ; [1  |  x]
    mov         r12,r2,asr #3          ; [1  |  x]
    pkhtb       r12, r12, r3, asr #19; [1  |  0]
    ;lsl         lr, r3, #16          ; [~3 |  x]
    ;lsl         r2, r2, #16          ; [~2 |  x]
    ;asr         lr, lr, #3           ; [3  |  x]
    
    mov        lr, r3,lsl #16          ;  [~3 |  x]
    mov         r2, r2,lsl #16          ; [~2 |  x]
    mov          lr, lr,asr #3          ; [3  |  x]
    ...
    mov		r3, r5,lsl #16          ; [~7 |  x]
    mov		r4, r4,lsl #16          ; [~6 |  x]
    mov		r3, r3,asr #3           ; [7  |  x]
    ...
    mov	r3, r7,lsl #16          ; [~11|  x]
    mov	r4, r6,lsl #16          ; [~10|  x]
    mov	r3, r3,asr #3           ; [11 |  x]
    
    pkhtb       r3, r3, r4, asr #19  ; [11 | 10]

    ;asr         r4, r8, #3           ; [13 |  x]
    mov	r4, r8,asr #3           ; [13 |  x]
    pkhtb       r4, r4, r9, asr #19  ; [13 | 12]
    ;lsl         r5, r9, #16          ; [~15|  x]
    ;lsl         r6, r8, #16          ; [~14|  x]
    ;asr         r5, r5, #3           ; [15 |  x]
    
    mov	r5, r9,lsl #16          ; [~15|  x]
    mov	r6, r8,lsl #16          ; [~14|  x]
    mov	r5, r5,asr #3           ; [15 |  x]
...
|vp8_short_inv_walsh4x4_1_v6| PROC
    ...
    mov	r2, r2,asr #3           ; a1 ([0]+3) >> 3
    mov	r2, r2,lsl #16          ; [a1 |  x]
