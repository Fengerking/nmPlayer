...
void WMOPS_output (Word16 notPrintWorstWorstCase, float fscale);
/*
...
//following functions have input parameters, so...
#define getCounterId 
#define setCounter 
#define WMOPS_output
//following functions have no input parameters, so...
#define Init_WMOPS_counter() 
#define Reset_WMOPS_counter()
#define fwc()
#define move16()
#define move32()
#define logic16()
