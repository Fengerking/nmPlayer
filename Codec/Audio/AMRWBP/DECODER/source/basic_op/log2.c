 ...
 *
 *   DESCRIPTION:
 *        normalizes L_x and then calls voAMRWBPDecLog2_norm().
 *
 *************************************************************************/
void voAMRWBPDecLog2 (
...
)
{
    ...
    exp = norm_l (L_x);
    voAMRWBPDecLog2_norm (L_shl (L_x, exp), exp, exponent, fraction);
}
