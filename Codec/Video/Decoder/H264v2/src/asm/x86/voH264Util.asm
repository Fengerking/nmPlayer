...
%ifdef VO_NDK_X86
%define private_prefix vo
%else
%define private_prefix _vo
%endif

%define public_prefix  avpriv
%define cpuflags_mmxext cpuflags_mmx2

%include "voH264Inc.asm"
...
;---------------------------rewrite---------------------------
%define VO_RE_WRITE_SUFFIX

%ifdef  VO_NDK_X86
%define vo_prefix vo
%else
%define vo_prefix _vo
%endif

%ifdef VO_RE_WRITE_SUFFIX
%xdefine	vo_suffix	rewrite
%else
%xdefine	vo_suffix
%endif
...
%macro vo_sse_put_half 3
	movq	%2,	%1
%endmacro

%macro vo_sse_avg_half 3
	movq	%3,	%2
	pavgb	%1,	%3
	movq	%2,	%1
%endmacro