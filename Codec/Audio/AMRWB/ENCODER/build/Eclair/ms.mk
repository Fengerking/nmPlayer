...
OBJS:= autocorr.o az_isp.o bits.o c2t64fx.o c4t64fx.o convolve.o cor_h_x.o decim54.o \
       ...
       qisf_ns.o qpisf_2s.o random.o residu.o scale.o syn_filt.o updt_tar.o util.o \
       voAMRWBEnc.o voicefac.o wb_vad.o weight_a.o cmnMemory.o 
...
ifeq ($(VOTT), v6)
OBJS+= cor_h_vec_opt.o Deemph_32_opt.o Dot_p_opt.o Filt_6k_7k_opt.o residu_asm_opt.o \
       scale_sig_opt.o sub_vq_opt.o Syn_filt_32_opt.o syn_filt_opt.o pred_lt4_1_opt.o \
       convolve_opt.o Norm_Corr_opt.o
VOSRCDIR+= ../../../src/linux_asm/ARMv6
endif				

ifeq ($(VOTT), v7)
OBJS+= cor_h_vec_neon.o Deemph_32_neon.o Dot_p_neon.o Filt_6k_7k_neon.o residu_asm_neon.o \
       scale_sig_neon.o sub_vq_opt.o Syn_filt_32_neon.o syn_filt_neon.o pred_lt4_1_neon.o \
       convolve_neon.o Norm_Corr_neon.o
