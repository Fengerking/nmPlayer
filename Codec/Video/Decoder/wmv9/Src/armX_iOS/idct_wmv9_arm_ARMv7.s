...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    .globl  _ARMV7_g_DecodeInterError8x8_SSIMD
    .globl  _ARMV7_g_DecodeInterError8x4_SSIMD
    .globl  _ARMV7_g_DecodeInterError4x8_SSIMD
    .globl  _ARMV7_g_DecodeInterError4x4_SSIMD 

    .globl  _ARMV7_g_IDCTDec_WMV3_Pass1_Naked
    .globl  _ARMV7_g_IDCTDec_WMV3_Pass2_Naked
    .globl  _ARMV7_g_IDCTDec_WMV3_Pass3_Naked
    .globl  _ARMV7_g_IDCTDec_WMV3_Pass4_Naked
