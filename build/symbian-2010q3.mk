...
TCVENDOR=symbian-2010q3.54
TCROOTPATH:=/opt/$(TCVENDOR)
CCTPRE:=$(TCROOTPATH)/bin/arm-none-symbianelf-
AS:=$(CCTPRE)as
AR:=$(CCTPRE)ar
NM:=$(CCTPRE)nm
CC:=$(CCTPRE)gcc
...
CCTCFLAGS:=-finline-functions -finline-limit=600 -fno-inline-functions-called-once -frename-registers -fstrict-aliasing -funswitch-loops -fno-short-enums
...
CCTLIBDEEP:=$(CCTLIB)/gcc/arm-none-symbianelf/4.5.1
...
ifeq ($(VOTT), v7)
VOCFLAGS+=-march=armv7-a -mtune=cortex-a8 -mfpu=neon -mabi=aapcs -mfloat-abi=soft -ftree-vectorize 
