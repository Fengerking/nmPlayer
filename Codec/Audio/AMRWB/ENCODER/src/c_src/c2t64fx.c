...
#define	sign		(cn + L_SUBFR)
#define	vec			(sign + L_SUBFR)
#define	dn2			(vec + L_SUBFR)
#define	h_buf		(dn2 + L_SUBFR)
#define	rrixix_1	(h_buf + (4*L_SUBFR))
#define	rrixiy		(rrixix_1 + (NB_TRACK*NB_POS))
