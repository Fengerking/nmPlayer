...
@R4,R5,R12 = Tmp
	...
	.text
	.align 4
	.globl	VOASMFUNCNAME(Interpolate4_H00V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H01V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H02V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H03V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H00V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H01V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H02V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H03V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H00V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H01V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H02V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H03V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H00V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H01V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H02V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4_H03V03_CtxA8)
	
	.globl	VOASMFUNCNAME(Interpolate4Add_H00V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H01V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H02V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H03V00_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H00V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H01V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H02V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H03V01_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H00V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H01V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H02V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H03V02_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H00V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H01V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H02V03_CtxA8)
	.globl	VOASMFUNCNAME(Interpolate4Add_H03V03_CtxA8)
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	.if $0 > 0
		...
		vext.8		d8, d8, d22, #$0
		vext.8		d9, d9, d23, #$0
		vext.8		d10, d10, d24, #$0
		vext.8		d11, d11, d25, #$0
		vext.8		d12, d12, d26, #$0
	.endif
...
_Interpolate4_Vert_8x13:	@PROC
    M_pushLR
	M_Interpolate_Core	0
    M_popLR
	@ENDP

_Interpolate4_Vert_8x13_MV2:	@PROC
    M_pushLR
...
_Interpolate4_Horiz_13x8_MV2:	@PROC
    M_pushLR
...
_Interpolate4_Horiz_13x5_MV2:		@PROC
    M_pushLR
...
VOASMFUNCNAME(Interpolate4_H00V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H00V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H01V00_CtxA8):	@PROC
	M_pushRegisters

	@Load 13x8 src data and transpose them to d0~d12
	sub			r0, r0, #2
	bl			_getSrc_13x8_transpose
	
	@Do H 13x8 interpolate and the result is in d0~d7
	vmov.i8		d30, #52
	vmov.i8		d31, #20
	bl			_Interpolate4_Horiz_13x8	
...
VOASMFUNCNAME(Interpolate4Add_H01V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H02V00_CtxA8):	@PROC
	M_pushRegisters
	...
	@Do H 13x8 interpolate and the result is in d0~d7
	vmov.i8		q15, #20
	bl			_Interpolate4_Horiz_13x8_MV2	
...
VOASMFUNCNAME(Interpolate4Add_H02V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H03V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H03V00_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H00V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H00V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H01V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H01V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H02V01_CtxA8):	@PROC
	M_pushRegisters
	...
	@Do H 13x5 interpolate and the result is in d8~d12
	bl			_Interpolate4_Horiz_13x5_MV2	
...
VOASMFUNCNAME(Interpolate4Add_H02V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H03V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H03V01_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H00V02_CtxA8):	@PROC
	M_pushRegisters
	...
	@Do V 8x13 interpolate and the result is in d0~d7
	vmov.i8		q15, #20
	bl			_Interpolate4_Vert_8x13_MV2
	M_StoreData_8x8 r1, r3
...
VOASMFUNCNAME(Interpolate4Add_H00V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H01V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H01V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H02V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H02V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H03V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H03V02_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H00V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H00V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H01V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H01V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H02V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H02V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4_H03V03_CtxA8):	@PROC
	M_pushRegisters
...
VOASMFUNCNAME(Interpolate4Add_H03V03_CtxA8):	@PROC
	M_pushRegisters
