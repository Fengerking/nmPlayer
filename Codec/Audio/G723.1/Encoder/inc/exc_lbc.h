...
void  	Find_Acbk( Word16 *Tv, Word16 *ImpResp, G723EncState *st, LINEDEF *Line, Word16 Sfc );
void  	Get_Rez( Word16 *Tv, Word16 *PrevExc, Word16 Lag );
void 	Decod_Acbk( Word16 *Tv, Word16 *PrevExc, Word16 Olp, Word16 Lid, Word16 Gid, G723EncState *st);
