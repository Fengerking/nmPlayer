...
int Speech_Decode_Frame_init (Speech_Decode_FrameState **st,VO_MEM_OPERATOR *pMemOP);
...
void Speech_Decode_Frame_exit (Speech_Decode_FrameState **st,VO_MEM_OPERATOR *pMemOP);
...
int Speech_Decode_Frame (
    ...
    unsigned short *synth                 /* o : synthesis speech (postfiltered    */
                                  /*     output)                           */
);
/*    return 0 on success
 */
