...
# about info option
LOCAL_CFLAGS := -D_VOMODULEID=0x09060000  -DNDEBUG -march=i686 -mtune=atom -mstackrealign -msse3 -mfpmath=sse -m32
...
LOCAL_SRC_FILES := 	../../jni/com_visualon_OSMPPlayerImpl_voOSMPDRM.cpp \
