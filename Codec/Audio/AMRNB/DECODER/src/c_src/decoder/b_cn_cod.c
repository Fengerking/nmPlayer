...
void build_CN_param (
					 ...
					 const Word8 n_param,           /* i  : number of params */  
					 const Word8 param_size_table[],/* i : size of params */   
					 Word16 parm[]             /* o : CN Generated params */
)
{
	int i;
	const Word16 *p;
	*seed = extract_l(L_add((L_mult(*seed, 31821)>>1), 13849L));
