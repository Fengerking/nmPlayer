...
typedef VO_U32 (*rv_backend_init_fp) (void *prv10Init,
                                         void **global);
typedef HX_RESULT (*rv_backend_decode_fp) (UCHAR *pRV10Packets,
                                           ...
                                           void *pOutputParams,
                                           void *global);
typedef VO_U32 (*rv_backend_custom_message_fp) (VOUINT32 *msg_id,
                                                   void *global);
typedef HX_RESULT (*rv_backend_hive_message_fp) (VOUINT32 *msg,
                                                 void *global);
