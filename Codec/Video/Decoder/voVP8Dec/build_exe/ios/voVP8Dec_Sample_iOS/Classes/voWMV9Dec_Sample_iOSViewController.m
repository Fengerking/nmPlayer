...
- (void)viewDidLoad 
{
	...
	NSString* inFilePath	= [NSString stringWithFormat:@"%@/vp80-04-partitions-1406.ivf", documentsDir];
	char* inFile	= [inFilePath UTF8String];
	
	NSString* outFilePath	= [NSString stringWithFormat:@"%@/vp80-04-partitions-1406.yuv", documentsDir];
	...
	beginTest_vp8(inFile, outFile,1);
}
